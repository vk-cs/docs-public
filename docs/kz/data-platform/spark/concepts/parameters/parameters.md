...
|`S3 VK Cloud`
|`s3_int`
|{linkto(#parameters_s3_int)[text=Қосылым]} сол жобадағы VK Object Storage бұлттық қоймасына
...
|`name`
|Жеке кабинетте көрсетілетін VK Object Storage қосылымының атауы
...
|`s3_bucket`
|VK Object Storage бакетінің бірегей атауы. Бұл бакет тек қосымшалардың ішкі деректерін сақтау үшін пайдаланылады
