# {heading(Жеке кабинетте кластер ресурстарын басқару)[id=mk8s-manage-resources]}

{include(/kz/_includes/_translated_by_ai.md)}

Сіз Managed Containers сервисінде Kubernetes кластерінің ресурстарын VK Cloud жеке кабинетінің веб-интерфейсі арқылы басқара аласыз. Бұл функция сол әрекеттерді `kubectl` және Headlamp арқылы орындауға балама болып табылады. `kubectl` арқылы ресурсты құру, өзгерту және жою командаларының мысалдары жеке кабинетте қолжетімді.

## {heading(Ресурстар туралы ақпаратты қарау)[id=mk8s-manage-resources-view-resources]}
...
## {heading(Ресурсты құру)[id=mk8s-manage-resources-create-resources]}
...
## {heading(Ресурс манифестін жүктеп алу)[id=mk8s-manage-resources-download-yaml]}
...
1. Қажетті ресурс үшін ![](../../../../assets/more-icon.svg "inline") белгішесін басып, **Скачать yaml** тармағын таңдаңыз. Ресурс манифестінің YAML файлы жүктеледі.

## {heading(Ресурс туралы ақпаратты өңдеу)[id=mk8s-manage-resources-edit-resources]}
...
1. Қажетті ресурс үшін ![](../../../../assets/more-icon.svg "inline") белгішесін басып, **Изменить** тармағын таңдаңыз.
1. Ашылған терезеде ресурс манифестіне өзгерістер енгізіп, оларды сақтаңыз.

## {heading(Ресурсты жою)[id=mk8s-manage-resources-delete-resources]}
...
1. Қажетті ресурс үшін ![](../../../../assets/more-icon.svg "inline") белгішесін басып, **Удалить** тармағын таңдаңыз.
1. Жоюды растаңыз.
