...
1. Аддонды орнатыңыз:
   ...
   {tab(Жеке кабинет)}
    ...
    1. `istio` аддонының карточкасындағы **Орнату** батырмасын, содан кейін **Аддонды орнату** батырмасын басыңыз.
    1. Қажет болса, {linkto(#mk8s-install-advanced-istio-mk8s-edit)[text=аддонды баптау кодын]} өңдеңіз (мысалы, аддонның жұмыс режимін өзгерту үшін).
