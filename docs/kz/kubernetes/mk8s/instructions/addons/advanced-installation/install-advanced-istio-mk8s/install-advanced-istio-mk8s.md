# {heading(Istio)[id=mk8s-install-advanced-istio-mk8s]}

{include(/kz/_includes/_translated_by_ai.md)}

## {heading(Дайындық қадамдар)[id=mk8s-install-advanced-istio-mk8s-prepare]}

{include(/kz/_includes/_addon-prep.md)}

## {heading(Аддонды орнату)[id=mk8s-install-advanced-istio-mk8s-install]}

{linkto(/kz/kubernetes/mk8s/concepts/addons-and-settings/addons#mk8s-addons-istio)[text=Istio]} аддоны үшін {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-install-features)[text=бірнеше орнату нұсқасы]} қолжетімді.
...
1. Аддонды орнатыңыз:
   ...
   {tab(Жеке кабинет)}
    ...
    1. Қажет болса, {linkto(#mk8s-install-advanced-istio-mk8s-edit)[test=аддонды баптау кодын]} өңдеңіз (мысалы, аддонның жұмыс режимін өзгерту үшін).
...
1. Егер бұл әлі жасалмаған болса, аддонды орнату үшін worker-түйіндердің бөлінген тобын дайындаңыз:
   ...
   {tab(Жеке кабинет)}
    ...
    1. Егер бұл әлі жасалмаған болса, осы түйіндер тобы үшін {linkto(../../../manage-node-group#mk8s-manage-node-group-labels-taints)[text=келесілерді көрсетіңіз]}:
...
1. Аддонды орнатыңыз:
   ...
   {tab(Жеке кабинет)}
    ...
    1. `istio` аддон картасында **Орнату** батырмасын басыңыз.
    1. **Аддонды орнату** батырмасын басыңыз.
    1. Қажет болса, {linkto(#mk8s-install-advanced-istio-mk8s-edit)[аддонды баптау кодын]} өңдеңіз (мысалы, аддонның жұмыс режимін өзгерту үшін).
...
## {heading(Орнату кезінде аддонды баптау кодын өңдеу)[id=mk8s-install-advanced-istio-mk8s-edit]}
