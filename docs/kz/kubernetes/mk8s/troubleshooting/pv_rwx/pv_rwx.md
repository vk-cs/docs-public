# {heading(RWX режимі жұмыс істемейді)[id=mk8s-pv-rwx]}

{include(/kz/_includes/_translated_by_ai.md)}

ReadWriteMany (RWX) томына қол жеткізу режимі жұмыс істемейді: кластер тораптарының дискіге қолжетімділігі жоқ.

Бұл Managed Containers ішінде RWX режиміндегі PVC-ге қолжетімділік іске асырылмағанына байланысты болуы мүмкін.

### {heading(Шешім)[id=mk8s-pv-rwx-solution]}
