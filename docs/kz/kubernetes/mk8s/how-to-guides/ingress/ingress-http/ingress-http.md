# {heading(Ingress-контроллерін HTTP-балансировщикпен жайып орналастыру)[id=mk8s-ingress-http]}
...
Ingress-контроллерін VK Cloud платформасының {linkto(../../../concepts/network#mk8s-network)[text=HTTP жүктеме балансировщигімен бірге]} жайып орналастыруға болады. Төменде мысал ретінде контроллердің жұмысқа қабілеттілігін тексеру үшін қарапайым демо-қосымшалар мен Ingress ресурсы жасалады.
...
## {heading(1. Дайындық қадамдары)[id=mk8s-ingress-http-prepare]}
...
## {heading(2. Демо-қосымшаларды жайып орналастырыңыз)[id=mk8s-ingress-http-deploy-demo]}
...
## {heading(3. Ingress-контроллерін орнатыңыз)[id=mk8s-ingress-http-install-ingress]}
...
## {heading(4. HTTP жүктеме балансировщигін жасаңыз)[id=mk8s-ingress-http-create-http-balancer]}
...
## {heading(5. Ingress ресурсін жасаңыз)[id=mk8s-ingress-http-create-ingress]}
...
## {heading(6. Қосымшалардың қолжетімділігін тексеріңіз)[id=mk8s-ingress-http-check-apps]}
...
## {heading(Пайдаланылмайтын ресурстарды жойыңыз)[id=mk8s-ingress-http-delete]}
