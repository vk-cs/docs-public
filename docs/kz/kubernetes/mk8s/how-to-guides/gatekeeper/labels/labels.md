# {heading(Міндетті белгілерді баптау)[id=mk8s-labels]}
...
## {heading(Дайындық қадамдары)[id=mk8s-labels-prepare]}
...
## {heading(Белгілерді тексеретін шектеуді жасаңыз)[id=mk8s-labels-create-constraint]}
...
## {heading(Қолданылмайтын ресурстарды жойыңыз)[id=mk8s-labels-delete]}
