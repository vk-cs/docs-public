# {heading(kubectl көмегімен кластерге қосылу)[id=mk8s-kubectl]}
...
## {heading(Дайындық қадамдары)[id=mk8s-kubectl-before-work]}
...
1. {linkto(../../concepts/access-management#mk8s-access-management)[text=Single Sign-On (SSO)]} пайдаланып қосылу үшін қажет нәрсенің бәрін дайындаңыз.
...
## {heading(Кластерге қосылу)[id=mk8s-kubectl-connect]}

{include(/kz/_includes/_kubeconfig.md)}

## {heading(Кластерге қосылуды тексеру)[id=mk8s-kubectl-check-connection]}
...
1. VK Cloud жеке кабинетіне арналған пайдаланушы құпиясөзін енгізіңіз.
   ...
   Бұл кластерге қосылған кезде {linkto(../../concepts/access-management#mk8s-access-management)[text=аутентификация]} үшін қажет.
