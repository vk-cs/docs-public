# {heading(Gatekeeper)[id=mk8s-gatekeeper]}
...
## {heading(Gatekeeper жұмыс істеу қағидаты)[id=mk8s-gatekeeper-about]}
...
## {heading(Gatekeeper үшін ресурстардың құрылымы)[id=mk8s-gatekeeper-resources]}

### {heading(Шектеу құрылымы)[id=mk8s-gatekeeper-constraints]}
...
### {heading(Шектеу үлгісінің құрылымы)[id=mk8s-gatekeeper-template]}
...
## {heading(Gatekeeper-ді қалай пайдалану керек)[id=mk8s-gatekeeper-how-to-use]}
...
Gatekeeper шектеулерін пайдалану мысалдары {linkto(../../how-to-guides/gatekeeper#mk8s-gatekeeper)[text=пайдалану сценарийлерінде]} келтірілген.
