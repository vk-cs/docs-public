...
## {heading(Аудит саясатының құрылымы)[id=mk8s-cluster-audit-policy-structure]}

Төменде Kubernetes кластерлерінің аудит саясатының баптаулары бар толық файл берілген.
...
## {heading(Қандай оқиғалар аудит журналына түседі)[id=mk8s-cluster-audit-policy-events]}
...
## {heading(Қандай оқиғалар аудит журналынан шығарылады)[id=mk8s-cluster-audit-policy-excluded-events]}
