...
1. [Көз жеткізіңіз](../kubectl#check_connection), `kubectl` көмегімен кластерге қосыла алатыныңызға.
...
1. Secret алыңыз:
   ...
   1. Қажетті кластер үшін ![ ](/kz/assets/more-icon.svg "inline") түймесін басып, **Kubernetes Dashboard-қа кіру үшін Secret алу** тармағын таңдаңыз.
