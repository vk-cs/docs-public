...
Қосылған ресурс автоматты түрде танылады және тиісті санаттағы ресурстар тізімінде қолжетімді болады. Мысалы, егер сіз PV үшін манифест қоссаңыз, ол **Қойма** санатындағы **Persistent Volumes** блогында қолжетімді болады.
...
1. Қажетті ресурс үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Жүктеу yaml** тармағын таңдаңыз. Ресурс манифестінің YAML файлдар жүктеледі.

## {heading(Ресурс туралы ақпаратты өңдеу)[id=edit-resources]}

{note:warn}
Ресурстар туралы алқпаратты өзгерту кластер жұмысының мәселелеріне әкелуі мүмкін.
{/note}
...
1. Қажетті ресурс үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Өзгерту** тармағын таңдаңыз.
...
1. Қажетті ресурс үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Жою** тармағын таңдаңыз.
1. Жоюды растаңыз.
