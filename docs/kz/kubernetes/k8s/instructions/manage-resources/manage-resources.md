# {heading(Жеке кабинетте кластер ресурстарын басқару)[id=k8s-manage-resources]}
...
## {heading(Ресурстар туралы ақпаратты қарау)[id=k8s-manage-resources-view-resources]}
...
## {heading(Ресурсты құру)[id=k8s-manage-resources-create-resources]}
...
## {heading(Ресурс манифестін жүктеп алу)[id=k8s-manage-resources-download-yaml]}
...
## {heading(Ресурс туралы ақпаратты өңдеу)[id=k8s-manage-resources-edit-resources]}
...
## {heading(Ресурсты жою)[id=k8s-manage-resources-delete-resources]}
