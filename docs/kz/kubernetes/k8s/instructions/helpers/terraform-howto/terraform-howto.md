...
1. [Бір немесе бірнеше worker-түйіндер тобы бар жаңа кластер құрыңыз](../../create-cluster/create-terraform).
...
- Кластермен кейбір операциялар тек [жеке кабинетте](../../../../../tools-for-using-services/account) орындалады. Әр операция үшін [қадамдық нұсқаулықтарда](../../../instructions) оны Terraform көмегімен де орындауға болатыны көрсетілген.
