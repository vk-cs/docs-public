...
1. Қажетті түйіндер тобы үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Labels и Taints** тармағын таңдаңыз.
...
1. **Контейнеры** → **Кластеры Kubernetes** бөліміне өтіңіз.
1. Қажетті кластерді және оның ішіндегі түйіндер тобын табыңыз.
1. Қажетті түйіндер тобы үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Настройки обновления нод** тармағын таңдаңыз.
...
1. **Контейнеры** → **Кластеры Kubernetes** бөліміне өтіңіз.
1. Қажетті кластерді және оның ішіндегі түйіндер тобын табыңыз.
1. Қажетті түйіндер тобы үшін ![ ](/kz/assets/more-icon.svg "inline") белгішесін басып, **Удалить** тармағын таңдаңыз.
