...
Жылдамдықты арттыру үшін Managed Containers сервисі топтағы бірден бірнеше worker-түйінді жаңартады. Қолданбаларыңыз бен сервистеріңіздің жаңарту кезінде барынша қолжетімділігін сақтау үшін {linkto(../update#k8s-update)[text=кластерді жаңарту]} алдында түйіндер тобы үшін қолжетімсіз түйіндердің ең жоғары пайызын көрсетіңіз.
