...
Бұл операция кластерде [kube-prometheus-stack](#addondy_ornatu) мониторинг аддоны `kube-prometheus-stack` болса қолжетімді.
...
1. Қажетті кластердің атауын басыңыз.
1. **Аддондар** қойындысына өтіңіз.
1. ![kube-prometheus-stack](/kz/assets/more-icon.svg "inline") аддоны үшін `kube-prometheus-stack` батырмасын басып, **Prometheus дискісінің өлшемін өзгерту** тармағын таңдаңыз.
