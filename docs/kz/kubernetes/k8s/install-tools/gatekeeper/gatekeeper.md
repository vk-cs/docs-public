...
Gatekeeper — жасалатын, өзгертілетін және жойылатын Kubernetes ресурстарының саясаттарғал сәйкестігін тексеру үшін Kubernetes API мен Open Policy Agent (OPA) саясаттар қозғалтқышының арасына ендірілетін контроллер. Gatekeeper туралы толығырақ алқпарат [Kubernetes анықтамалығында](../../reference/gatekeeper) және [Gatekeeper ресми құжаттамасында](https://open-policy-agent.github.io/gatekeeper/website/docs/) берілген.

## Орнату

1. Егер утилита әлі орнатылмаған болса, [Helm орнатыңыз](../helm).
...
## (Опционалды) Шектеулер мен үлгілерді баптау

Cloud Containers сервисіндегі Kubernetes кластерлерінде [әдепкі қауіпсіздік саясаттары](../../concepts/addons-and-settings/settings#preconfigured_templates_and_limitations) әрекет етеді, олар кластерді бірнеше кең таралған осалдықтан базалық деңгейде қорғайды. 1.20 немесе одан төмен нұсқадағы кластерлерді қорғау үшін осы саясаттарғал сәйкес келетін Gatekeeper шектеулері мен шектеу үлгілерін өзіңіз жасаңыз.

{tabs}

{tab(host-namespaces шектеуі)}

Бұл саясат `hostIPC: true` және `hostPID: true` параметрлері арқылы Kubernetes кластері түйінінің процесстеріне және процесаралық байланыс (IPC) құралдарына қол жеткізуге тыйым салады. Толығырақ [саясат сипаттамасынан](../../concepts/security-policies#host-namespaces) оқыңыз.
...
1. (Опционалды) Шектеудің жұмысын тексеріңіз:
   ...
   1. Саясатқал сәйкес келмейтін под манифестін жасаңыз:
...
[hostPath](https://kubernetes.io/docs/concepts/storage/volumes/#hostpath) көмегімен Kubernetes кластері түйінінің файлдық жүйесі директорияларын контейнерге монтирлеуге тыйым салады. Толығырақ [тиісті қауіпсіздік саясатының сипаттамасынан](../../concepts/security-policies#host-filesystem) оқыңыз.
...
1. Gatekeeper үшін жасалған CRD-объектілерін жою үшін команданы орындаңыз:
   ...
   Бұл операция шектеулер мен олардың үлгілерін жоюғал әкеледі.
