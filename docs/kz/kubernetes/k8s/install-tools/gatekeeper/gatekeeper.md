...
Cloud Containers сервисіндегі Kubernetes кластерлерінде [әдепкі қауіпсіздік саясаттары](../../concepts/addons-and-settings/settings#preconfigured_templates_and_limitations) әрекет етеді, олар кластерді бірнеше кең таралған осалдықтан базалық деңгейде қорғайды. 1.20 немесе одан төмен нұсқадағы кластерлерді қорғау үшін осы саясаттарға сәйкес келетін Gatekeeper шектеулері мен шектеу үлгілерін өзіңіз жасаңыз.
