...
Limit Range — под жасалған кезде қолданылатын саясат. Оны өшіру мүмкін емес, бірақ сіз [контейнерлердің](/kz/kubernetes/k8s/concepts/addons-and-settings/settings#requests_and_limits) конфигурация файлдарында `requests` және `limits` мәндерін өзіңіз орната аласыз.
{/cut}
