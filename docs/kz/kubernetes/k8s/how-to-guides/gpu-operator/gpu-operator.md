...
- GPU ресурстары бірнеше pod арасында {linkto(/kz/kubernetes/k8s/concepts/flavors#k8s-flavors-gpu-sharing)[text=MPS]} стратегиясы бойынша бөлінеді. Әрбір процесс GPU ресурстарының бөлінген жиынтығын алады және олар бір-бірімен процестер арасындағы өзара әрекеттесу (IPC) арқылы әрекеттеседі.
- GPU ресурстары бірнеше pod арасында {linkto(/kz/kubernetes/k8s/concepts/flavors#k8s-flavors-gpu-sharing)[text=MIG]} стратегиясы бойынша бөлінеді. Бұл ретте әрбір бөлік өз ресурстарына (жадына, есептеу блоктарына) ие болады және басқаларынан оқшау жұмыс істей алады.
...
1. {linkto(/kz/kubernetes/k8s/instructions/create-cluster/create-webui#k8s-create-webui)[text=GPU бар кластер жасаңыз]}, егер ол әлі жасалмаған болса. Келесі параметрлерді көрсетіңіз:
...
1. {linkto(/kz/kubernetes/k8s/connect/kubectl#k8s-kubectl)[text=Кластерге kubectl арқылы қосылыңыз]}.

## {heading(1. GPU-operator аддонын орнатыңыз)[id=k8s-gpu-operator-install]}

{linkto(/kz/kubernetes/k8s/instructions/addons/advanced-installation/install-advanced-gpu-operator#k8s-install-advanced-gpu-operator)[text=Орнату жөніндегі нұсқаулықты]} пайдаланыңыз.
...
1. [NVIDIA device plugin](https://github.com/NVIDIA/k8s-device-plugin/tree/v0.17.0?tab=readme-ov-file#with-cuda-mps) конфигурациясын GPU Operator аддонының кодының ішіне {linkto(/kz/kubernetes/k8s/instructions/addons/manage-addons#k8s-manage-addons-edit-code)[text=қосыңыз]}:
...
1. Аддон конфигурациясына қосылған `mps-on` режимін қосатын GPU бар түйін үшін метканы (label) қосыңыз:
   ...
   Топтағы барлық түйіндер үшін метканы жеке кабинет арқылы {linkto(/kz/kubernetes/k8s/instructions/manage-node-group#k8s-manage-node-group-labels-taints)[text=қоса аласыз]}.
