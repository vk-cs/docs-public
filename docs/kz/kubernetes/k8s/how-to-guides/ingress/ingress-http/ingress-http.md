...
Ingress-контроллерін VK Cloud платформасының [HTTP жүктеме балансировщигімен бірге](../../../concepts/network) жайып орналастыруғал болады. Төменде мысал ретінде контроллердің жұмысқал қабілеттілігін тексеру үшін қарапайым демо-қосымшалар мен Ingress ресурстар жасалады.
...
1. Балансировщикті жасаңыз:
   ...
   1. Ашылған терезеде:
      1. **Баланстаушы атауын** орнатыңыз (кез келген).
      ...
      1. Әрбір трафик түрі үшін өңдеу параметрлерін орнатыңыз:
         ...
         1. **Келесі инстанстарғал қолдану** блогында кластердің master-түйіндері мен worker-түйіндеріне сәйкес келетін барлық Cloud Servers сервисі инстанстарын қосыңыз.
         ...
         1. **Сертификат** блогында:
            ...
            1. **Жаңал сертификатты жүктеу** тармағын таңдаңыз.
            ...
            NGINX өздігінен қол қойылған сертификаты `cafe.example.com` доменінде жарияланған қосымшаларғал қол жеткізу үшін пайдаланылады.
   ...
   Балансировщикті жасау операциясы басталады, ол бірет уақыт алады.

1. Баланстаушы жасалғаннан кейін оның жария IP-мекенжайын көшіріп алыңыз, ол Ingress арқылы жарияланған ресурстарғал қол жеткізу үшін қажет болады.

## 5. Ingress ресурсін жасаңыз

Ingress ресурстар `coffee-svc` және `tea-svc` сервистерін `cafe.example.com` доменінде Ingress-контроллері арқылы жариялап, осылайша қосымшаларғал қолжетімділік ұсынады.
...
1. Манифест файлдарында сипатталған ресурстарды, `example-nginx-ingress-http` қосымшасын, сондай-алқ `example-nginx-ingress-http` аттар кеңістігін және онымен байланысты ресурстарды жойыңыз:
