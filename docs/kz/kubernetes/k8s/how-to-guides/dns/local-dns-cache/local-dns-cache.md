...
- Сервер тыңдайтын IP мекенжайлар:
  ...
  Мұндай конфигурация Cloud Containers кластерлерінде `kube-proxy` {linkto(../../../concepts/addons-and-settings/settings#k8s-settings-kube-proxy-mode)[text=жұмыс істейтін]} `iptables` режиміне байланысты пайдаланылады.
