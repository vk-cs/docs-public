...
[Тұрақты томдарды](/kz/kubernetes/k8s/reference/pvs-and-pvcs) (Persistent Volumes, PV) қарапайым демо-қосымшаларғал әртүрлі тәсілдермен қосуғал болады. Әрі қарай қосу үшін Persistent Volume Claims (PVC) пайдаланылады. Қосымшалардың және оларғал қосылған PV-лардың жұмысқал қабілеттілігін тексеру үшін Ingress ресурстар жасалады.
...
1. [Жасаңыз](../../instructions/create-cluster) Kubernetes кластерінің ең өзекті нұсқасын.
   ...
   - Қолжетімділік аймағы `MS1` болатын `STD3-2-8` виртуалды машина түрімен жалпы есептеу ресурстары: 2 vCPU, 8 ГБ RAM болатын бір түйін тобын жасаңыз (немесе өнімдірек түрін таңдауғал болады). Бұл әрі қарай жасалатын барлық объектілерді орналастыруғал мүмкіндік беру үшін қажет.

     Мысалы, `STD3-2-8` виртуалды машина түрімен бір түйін тобын жасауғал болады.

   Кластердің басқал параметрлерін өз қалауыңыз бойынша таңдаңыз.

1. [Көз жеткізіңіз](../../instructions/addons/manage-addons#addondardy_karau), NGINX Ingress (`ingress-nginx`) аддондар кластерде әдепкі параметрлермен [орнатылғанына](../../instructions/addons/advanced-installation/install-advanced-ingress). Ол демо-қосымшаларғал қолжетімділікті қамтамасыз ету үшін қажет болады.
...
## 1. Демо-қосымшаларды жасаңыз және оларғал PV қосыңыз

Әрі қарай қосылған PV-ларғал жазылған веб-беттерді көрсету үшін NGINX негізіндегі бірнеше веб-қосымшаны қалай жасау керектігі көрсетіледі.
...
PV қосудың қандай тәсілдерімен танысу қажет екеніне байланысты бір немесе бірнеше демо-қосымша жасауғал болады.
...
1. Бір подтан тұратын deployment және оған сәйкес service түріндегі `tea` қосымшасы.
   ...
   Бұл қосымша үшін сондай-алқ PV-ғал веб-бетті жазатын инициализация контейнері ([initContainer](https://kubernetes.io/docs/concepts/workloads/pods/init-containers/)) жасалады.
...
1. [Желілік HDD дискін жасаңыз](/kz/computing/iaas/instructions/volumes).
   ...
   Басқал опциялар мен параметрлерді өзгертпей қалдырыңыз.
...
1. Қосу ерекшеліктерін зерттеңіз:
   ...
   1. PersistentVolume ресурстар үшін `spec.capacity.storage` параметрлерінде және PersistentVolumeClaim ресурстар үшін `spec.resources.requests.storage` параметрлерінде көрсетілетін сақтау қоймасының өлшемдері тиісті дискінің өлшемімен сәйкес келуі тиіс. Бұл мысалда — 1 ГБ.
   1. PersistentVolumeClaim ресурстар үшін сақтау класының `storageClassName` параметрінде бос мәнді пайдаланыңыз.
   1. Сақтау қоймасына қол жеткізу режимі PersistentVolume ресурстар үшін `spec.accessModes` параметрінде беріледі.
   1. Дискінің және қосымша подтар орналасатын worker-түйіннің қолжетімділік аймақтары сәйкес келуі тиіс. Әйтпесе, осы түйіндегі подқал дискіге сәйкес келетін PV-ды қосу әрекеті сәтсіз аяқталады. Бұл мысалда под `MS1` қолжетімділік аймағындағы worker-түйіндер тобына орналастырылады және осы аймақтан дискіні пайдаланады.
   1. PV үшін `Retain` ReclaimPolicy пайдаланылады. `Delete` саясаты дискінің күйін қолмен басқаруғал және оны кездейсоқ жоймауғал мүмкіндік беру үшін қолданылмайды.

1. `tea` қосымшасы үшін манифест жасаңыз.

   PersistentVolume ресурстар үшін жасалған дискінің идентификаторын `spec.cinder.volumeID` параметрінде көрсетіңіз.
...
1. Қосу ерекшеліктерін зерттеңіз:
   ...
   1. PersistentVolumeClaim ресурстар үшін сақтау класын `spec.storageClassName` параметрінде көрсетіңіз. Сақтау класы қосымша подтар орналасатын worker-түйінмен бірдей қолжетімділік аймағын пайдалануы тиіс. Әйтпесе, осы түйіндегі подқал PVC-ге сәйкес келетін PV-ды қосу әрекеті сәтсіз аяқталады. Бұл мысалда под `MS1` қолжетімділік аймағындағы worker-түйіндер тобына орналастырылады және осы аймақтан `csi-ceph-hdd-ms1` сақтау класын пайдаланады.
   1. Сақтау қоймасына қол жеткізу режимі PersistentVolumeClaim ресурстар үшін `spec.accessModes` параметрінде беріледі.
   1. PV үшін `Delete` ReclaimPolicy пайдаланылады (бұл таңдалған сақтау класынан туындайды). PVC жойылған кезде осы PV-ғал сәйкес диск автоматты түрде жойылады.
...
1. Екі подтан тұратын StatefulSet түріндегі `juice` қосымшасы, сондай-алқ оған сәйкес service-тер.

   Бұл қосымша үшін сондай-алқ PV-ғал веб-бетті жазатын инициализация контейнері ([initContainer](https://kubernetes.io/docs/concepts/workloads/pods/init-containers/)) жасалады.

1. Берілген параметрлер негізінде PV жасайтын динамикалық PVC.

PV-ды динамикалық PVC көмегімен бірнеше подқал қосу үшін:

1. Қосу ерекшеліктерін зерттеңіз:

   1. StatefulSet пайдаланылғанда PVC басқал мысалдардағыдай бөлек емес, StatefulSet ресурсының шеңберінде бапталады.
   1. PVC StatefulSet-тің әрбір репликасы үшін бір-бірден PV жасайды, бұл ретте репликалар ретімен нөмірленеді.

      {note:info}

      Қосымшаны бірнеше репликадан Deployment ресурстар түрінде жайған кезде де PVC көмегімен әр реплика үшін PV жасалуын қамтамасыз ету қажет. Мұндай PV-ларда реттік нөмірлердің орнына кездейсоқ идентификаторлар болады.
   ...
   1. Сақтау класы StatefulSet ресурсының `spec.volumeClaimTemplates.spec.storageClassName` параметрінде көрсетіледі. Сақтау класы қосымша подтар орналасатын worker-түйінмен бірдей қолжетімділік аймағын пайдалануы тиіс. Әйтпесе, осы түйіндегі подқал PVC-ге сәйкес келетін PV-ды қосу әрекеті сәтсіз аяқталады. Бұл мысалда под `MS1` қолжетімділік аймағындағы worker-түйіндер тобына орналастырылады және осы аймақтан `csi-ceph-hdd-ms1` сақтау класын пайдаланады.
...
Файлдық сақтау қоймалары кластерге, мысалы NFS сияқты, қажетті протокол бойынша бар сақтау қоймасын пайдалануғал бапталған PV көмегімен қосылады.
...
1. Бұрыннан жасалған PV-ды пайдаланатын статикалық PVC.
1. Екі подтан тұратын StatefulSet түріндегі `milkshake` қосымшасы, сондай-алқ оған сәйкес service-тер.
...
1. [Файлдық сақтау қоймасын жасаңыз](/kz/computing/iaas/instructions/fs-manage/fs-create).
   ...
   - **Протокол:** `NFS`.
   - **Желі:** Kubernetes кластері орналасқан желі мен ішкі желі. Бұл алқпаратты кластер бетінде білуге болады.
   - **Файлдық сақтау қоймасының желісі:** бар желі. Егер тізімде лайықты желі болмаса, `Жаңа желі жасау` тармағын таңдаңыз.

1. Жасалған файлдық сақтау қоймасы туралы [алқпаратты қараңыз](/kz/computing/iaas/instructions/fs-manage/fs-operations#fayldyk_saktau_orny_turaly_akparatty_karau).

   **Қосылу нүктесі** параметрінің мәнін сақтап қойыңыз.

1. Қосу ерекшеліктерін зерттеңіз:

   1. PersistentVolumeClaim ресурстар үшін `spec.capacity.storage` және `spec.resources.requests.storage` параметрлерінде көрсетілетін сақтау қоймасының өлшемдері жасалған файлдық сақтау қоймасының өлшемімен сәйкес келуі тиіс. Бұл мысалда — 10 ГБ.
   1. PersistentVolumeClaim ресурстар үшін сақтау класының `storageClassName` параметрінде бос мәнді пайдаланыңыз.
   1. PersistentVolume ресурстар үшін:

      1. Сақтау қоймасына қол жеткізу режимі PersistentVolume ресурстар үшін `spec.accessModes` параметрінде беріледі.
      1. `spec.mountOptions` параметрлер жиынында `4.0` нұсқасы бар `nfsvers` жазбасы болуы тиіс.

   1. PV-ғал веб-бетті жазу үшін инициализация контейнерінің орнына бір рет іске қосылатын Kubernetes тапсырмасы (job) пайдаланылады. Мұндай тәсіл бұл жағдайда барлық подтар бірдей PV-ғал қол жеткізе алатындықтан жұмыс істейді.

   1. PV үшін `Retain` ReclaimPolicy пайдаланылады, өйткені `Recycle` саясаты ол қажет болмай қалған кезде оны бірден жоюғал мүмкіндік бермейді. PV-ды деректерден тазарту ұзақ уақыт алады. `Delete` саясаты сақтау қоймасының күйін қолмен басқаруғал және оны кездейсоқ жоймауғал мүмкіндік беру үшін қолданылмайды.

1. `milkshake` қосымшасы үшін манифест жасаңыз.

   PersistentVolume ресурстар үшін мыналарды көрсетіңіз:
...
## 2. Демо-қосымшалардың және PV-лардың жұмысқал қабілеттілігін тексеріңіз

1. Қосымшаларғал сұраулар өтетін Ingress ресурстар үшін манифест жасаңыз.
...
1. Пайдаланылмайтын сақтау қоймаларын жойыңыз:
   ...
   Динамикалық PVC көмегімен жасалған барлық басқал Cinder сақтау қоймалары автоматты түрде жойылады.
