...
Cloud Containers кластерлерінде [бірнеше нұсқасы](../../concepts/versions/components) [Kube Prometheus Stack](../../concepts/addons-and-settings/addons#kube_prometheus_stack_822533c9) аддонының қолжетімді. Бұл аддонды VK Cloud құралдарымен жаңарту қолжетімсіз, бірақ аддонды қолмен жаңартуға болады.
...
## 1. Аддонды жаңарту үшін қажетті ақпаратты алыңыз
...
1. Аддон пайдаланатын [Persistent Volume Claims (PVCs) және тұрақты томдар (persistent volumes, PVs)](../../reference/pvs-and-pvcs) туралы ақпарат алыңыз. Олар жиналатын метрикаларды, сондай-ақ аддонның жұмысына қажет басқа деректерді сақтау үшін қолданылады.
...
1. Аддон пайдаланатын PVs тізімін аддонның аттар кеңістігіндегі PVCs арқылы алыңыз:
   ...
   PVs тізімі [бұрын алынған](#1_addondy_zhanartu_ushin_kazhetti_akparatty_alynyz) PVs тізімімен сәйкес келуі тиіс.
...
1. Аддон пайдаланған PVCs тізімін алыңыз:
   ...
   Қорытынды тізім [бұрын алынғаннан](#1_addondy_zhanartu_ushin_kazhetti_akparatty_alynyz) өзгеше болуы мүмкін: PVCs-тің бір бөлігі Helm-чарт жойылған кезде жойылды.
...
## 3. Аддонды жаңа нұсқаға жаңартыңыз

1. [VK Cloud интерфейстерін пайдаланып, аддонның ағымдағы нұсқасын жойыңыз](../../instructions/addons/manage-addons#addondy_zhoyu).
1. [Кластерге орнатыңыз](../../instructions/addons/advanced-installation/install-advanced-monitoring) `54.2.2` нұсқасындағы Kube Prometheus Stack аддонын.
   ...
   **Стандартты орнатуды** келесі түрде орындаңыз:
   ...
   1. [Бұрын алынған](#1_addondy_zhanartu_ushin_kazhetti_akparatty_alynyz) аддонның алдыңғы нұсқасының баптау кодын зерттеңіз. Аддонның келесі компоненттері үшін сақтау орнын баптауға жауап беретін код фрагменттерін табыңыз:
...
1. Аддон пайдаланатын [Persistent Volume Claims (PVCs) және тұрақты томдар (persistent volumes, PVs)](../../reference/pvs-and-pvcs) туралы ақпарат алыңыз:

   ```console
   kubectl -n $NAMESPACE get pvc
   ```

   Команда шығысы аддонның алдыңғы нұсқасы үшін [бұрын орындалған](#1_addondy_zhanartu_ushin_kazhetti_akparatty_alynyz) команданың шығысына ұқсас болуы тиіс. Мысалы, `alertmanager...` PVC-і бұрын Alert Manager пайдаланған сол PV-пен байланысқан болуы тиіс. Prometheus пен Grafana үшін де дәл солай.

## 4. Жаңартудан кейін аддонның жұмысқа қабілеттілігін тексеріңіз
