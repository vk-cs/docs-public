...
Шектеулерді (саясаттар түрінде) қолдануғал [Open Policy Agent](https://www.openpolicyagent.org/) (OPA) жауап береді.

## Gatekeeper жұмыс істеу қалғидаты
...
Өз кезегінде, шектеу үлгісі шектеуде берілген қолданылу аясы мен параметрлер кезінде онда сипатталған ережелердің сақталуын тексереді. Бұл ережелер [Rego тілі](https://www.openpolicyagent.org/docs/latest/policy-language/) арқылы шектеу үлгісінің YAML-файлында тікелей сипатталады. Сондай-алқ шектеуден берілген параметрлердің дұрыстығы тексеріледі.
...
- `spec.match`: жиынтығында шектеудің қолданылу аясын анықтайтын параметрлер тобы.
  ...
  - `namespaces`: атаулар кеңістіктерінің тізімі. Егер бұл параметр берілсе, онда шектеулер тек көрсетілген атаулар кеңістіктеріндегі ресурстарғал қолданылады.
  ...
  - `excludedNamespaces`: `namespaces` үшін ерекшелік болып табылатын атаулар кеңістіктерінің тізімі. Егер бұл параметр берілсе, онда шектеулер тек осы атаулар кеңістіктеріне жатпайтын ресурстарғал қолданылады.
  ...
  - `labelSelector`: `matchLabels` және `matchExpressions` деген екі міндетті емес өрістің комбинациясы. Бұл екі өріс ресурс метадеректеріне енгізілген белгі кілттері мен мәндері негізінде Kubernetes ресурстарын таңдаудың немесе алып тастаудың әртүрлі әдістерін ұсынады.
    ...
    Ресурс таңдалуы үшін ол мұнда берілген барлық талаптарғал сай келуі керек (талаптарғал «логикалық ЖӘНЕ» операциясы қолданылады).
  ...
  - `name`: ресурс атауы. Егер бұл параметр берілсе, онда шектеулер тек көрсетілген атауы бар ресурстарғал қолданылады.
...
- `spec.enforcementAction`: шектеуді бұзуды өңдеу кезіндегі әрекет. Мүмкін мәндер:
  ...
  - `deny` (әдепкі бойынша): Kubernetes ресурсын жасауғал тыйым салу.
