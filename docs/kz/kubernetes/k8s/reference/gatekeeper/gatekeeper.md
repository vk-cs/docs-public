...
## {heading(Gatekeeper жұмыс істеу қағидаты)[id=k8s-gatekeeper-about]}
...
## {heading(Gatekeeper үшін ресурстардың құрылымы)[id=k8s-gatekeeper-resources]}

### {heading(Шектеу құрылымы)[id=k8s-gatekeeper-constraints]}
...
### {heading(Шектеу үлгісінің құрылымы)[id=k8s-gatekeeper-template]}
...
## {heading(Gatekeeper-ді қалай пайдалану керек)[id=k8s-gatekeeper-how-to-use]}
...
Gatekeeper шектеулерін пайдалану мысалдары {linkto(../../how-to-guides/gatekeeper#k8s-gatekeeper)[text=пайдалану сценарийлерінде]} келтірілген.
