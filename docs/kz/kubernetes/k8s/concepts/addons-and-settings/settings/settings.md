...
Managed Containers сервисінде Kubernetes кластерлерінде бірнеше кең таралған осалдықтан кластерлерді негізгі қорғауды қамтамасыз ететін {linkto(../../security-policies#k8s-security-policies-default)[text=әдепкі қауіпсіздік саясаттары]} қолданылады. Әдепкі саясаттарды жою немесе өзгерту мүмкін емес.
