...
Managed Containers ішіндегі Kubernetes кластерінің нұсқасына қарай компоненттердің және {linkto(../../addons-and-settings/addons#k8s-addons)[text=аддондардың]} қолдау көрсетілетін нұсқалары тәуелді болады.
...
|{linkto(../../../instructions/addons/advanced-installation/install-advanced-logaas-integration-magnum#k8s-install-advanced-logaas-integration)[text=Cloud Logging үшін Fluent Bit (logaas-integration)]}
|0.34.2
|0.34.2
|0.34.2
| ![](../../../../../assets/no.svg "inline")
