# {heading(Kubernetes нұсқаларын қолдау саясаты)[id=k8s-version-support]}

{include(/kz/_includes/_translated_by_ai.md)}

VK Cloud жүйесіндегі Kubernetes aaS сервисінде жаңа нұсқалар әдетте ресми релизден кейін 1 айдан соң қосылады.
...
{linkto(../../../instructions/create-cluster/create-webui-gen-2#k8s-create-webui-gen-2)[text=Жаңа кластерді құру]} кезінде Kubernetes-тің соңғы қолжетімді нұсқасын таңдаңыз. Мүмкіндік болса, {linkto(../../../instructions/update#k8s-update)[text=қолданыстағы кластерлерді]} соңғы қолжетімді нұсқаға дейін жаңартыңыз.
...
## {heading(Kubernetes нұсқаларын қолдау)[id=k8s-version-support-list]}
...
Нұсқалар өзгерістерінің тарихын {linkto(#k8s-version-support-version-history)[text=Kubernetes нұсқаларының тарихы]} бөлімінен көруге болады.

## {heading(Kubernetes нұсқаларында сервис функцияларын қолдау)[id=k8s-version-support-features-list]}
...
## {heading(Kubernetes нұсқаларының тарихы)[id=k8s-version-support-version-history]}
...
|Кластердің master-тораптарын {linkto(../../scale#k8s-scale-autoscaling)[text=автоматты масштабтау]} іске асырылды
...
|{linkto(../../access-management#k8s-access-management)[text=VK Cloud бұлтының IAM-пен интеграциясы]} қосылды
