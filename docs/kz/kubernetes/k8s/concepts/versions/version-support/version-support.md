...
VK Cloud жүйесіндегі Kubernetes aaS сервисінде жаңал нұсқалар әдетте ресми релизден кейін 1 айдан соң қосылады.
...
[Жаңал кластерді](../../../instructions/create-cluster) жасау кезінде Kubernetes-тің қолжетімді соңғы нұсқасын таңдаңыз. Мүмкіндік болса, [қолданыстағы кластерлерді](../../../instructions/update) қолжетімді соңғы нұсқалғал дейін жаңартыңыз.
...
## {heading(Kubernetes нұсқаларын қолдау)[id=k8s-versions-list]}
...
Kubernetes нұсқасын қолдау тоқтатылғанғал дейін 30 күн бұрын пайдаланушылар бұл туралы электрондық пошта арқылы және жеке кабинеттегі хабарландырулар орталығында хабарлама алады.
...
Нұсқалар өзгерістерінің тарихын [Kubernetes нұсқаларының тарихы](#k8s_versions_history) бөлімінен көруге болады.

## {heading(Kubernetes нұсқаларында сервис функцияларын қолдау)[id=k8s-features-list]}

Жаңал функциялар функция мен нұсқаның үйлесімсіздігі жағдайларын қоспағанда, Kubernetes-тің барлық нұсқаларына қосылады.
...
## {heading(Kubernetes нұсқаларының тарихы)[id=k8s_versions_history]}
...
|Kubernetes кластерлерінде [GPU пайдалануғал және оны басқаруғал](../../../how-to-guides/gpu-operator) мүмкіндік қосылды
...
|Кластердің master-тораптарын [автоматты масштабтау](/kz/kubernetes/k8s/concepts/scale#autoscaling) іске асырылды
...
|[Kubernetes 1.24: Stargazer](/kz/kubernetes/k8s/concepts/access-management)
...
Логтарды сақтау пішімі[ өзгертілді](/kz/cases/cases-logs/case-fluent-bit)
