...
- Жеке кабинеттегі пайдаланушы рөлдері мыналарға әсер етеді:
  ...
  - [Жеке кабинетте кластерлермен орындалатын қолжетімді операцияларға](/kz/tools-for-using-services/account/concepts/rolesandpermissions#cloud_containers_servisi_rolderine_arnalgan_kukyktar).
...
Осындай мүмкіндіктерді ескі кластерлер үшін де алу үшін, оларды 1.23 немесе одан жоғары нұсқаға дейін [жаңартыңыз](../../instructions/update).
