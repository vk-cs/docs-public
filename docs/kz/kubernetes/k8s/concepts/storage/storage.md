...
- Контейнер деректері басқа контейнерлерге қолжетімсіз, тіпті барлық контейнерлер бір [подта](../../reference/pods) болса да.
...
- _Тұрақты томдардың_ (persistent volume, PV) подтың өмірлік цикліне тәуелді емес өз [өмірлік циклі](../../reference/pvs-and-pvcs) бар. Өмірлік циклдердің бөлінуінің арқасында мұндай томдарды кейін басқа подтармен қайта пайдалануға болады. Тұрақты томдармен жұмыс істеу үшін подтар мен басқа да жүктемелер Persistent Volume Claim (PVC) пайдаланады.
...
Әртүрлі түйіндердегі бірнеше подтан деректерге ортақ қолжеткізуді ұйымдастыру үшін, [бөлек виртуалды машинада NFS серверін өрістетіңіз](/kz/computing/iaas/instructions/fs-manage). NFS сервері деректерге желі арқылы ортақ қолжеткізуді қамтамасыз етіп, бірнеше подқа ортақ томдағы деректерді бір уақытта оқуға және жазуға мүмкіндік береді.
...
Cloud Containers сервисінде Kubernetes [екінші буын](/kz/kubernetes/k8s/instructions/manage-pvs) кластерлері үшін жасалған PV-лерді [басқаруға](/kz/kubernetes/k8s/concepts/cluster-generations) болады. Мұндай PV-лер VK Cloud платформасы басқаратын [сервистік жобада](/kz/kubernetes/k8s/concepts/cluster-generations#service-projects) орналасады. Кластерді жою немесе көшіру кезінде мұндай PV-лердегі деректерге қолжетімділікті жоғалтпау үшін, оларды сервистік жобадан өз жобаңызға көшіруге болады.
...
- Блоктық сақтау қоймалары негізінде PV-лерді статикалық (static provisioning) және динамикалық (dynamic provisioning) түрде [дайындауға](../../reference/pvs-and-pvcs#1_dayyndau_3e0a36f).
...
PV үшін осы томмен байланысты PVC жойылған кезде іске қосылатын [босату саясатын](../../reference/pvs-and-pvcs#4_bosatu_eca22259) (reclaim policy) орнатуға болады:
