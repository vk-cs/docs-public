...
[Кластерді жасау](/kz/kubernetes/k8s/instructions/create-cluster/create-webui-gen-2) кезінде контейнер бейнелерін цифрлық сертификаттың түпнұсқалығын тексермей жүктеп алуға және іске қосуға болатын сенімді Docker тізілімдерінің мекенжайларын қоса аласыз.
