...
[жасаңыз](/kz/networks/dns/instructions/publicdns/dns-zone#add) тестік орта үшін ішкі аймақты, келесі параметрлерді көрсете отырып:
...
- **Жазба түрі**: `NS`.
- **Атауы**: `test`.
- **Мәні**: `example.com` аймағына арналған NS-серверлердің мекенжайлары, оларды ресурстық жазбалар тізімінен [көруге](/kz/networks/dns/instructions/publicdns/records#resurstyk_zhazbalar_tizimin_karau) болады.
...
1. [Жойыңыз](/kz/networks/dns/instructions/publicdns/dns-zone#delete) `test.example.com` ішкі аймағын.
