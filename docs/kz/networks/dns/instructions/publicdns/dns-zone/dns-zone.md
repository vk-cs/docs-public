...
1. Жобаны таңдаңыз.
1. Бөлімге өтіңіз **DNS** → **DNS-аймақтар**.
1. Қажетті аймақ үшін ![ ](/kz/assets/more-icon.svg "inline") батырмасын басып **Редактировать**.
...
VK Cloud жобасында ішкі аймақ құру үшін ішкі аймақ атауымен ішкі аймақты VK Cloud DNS-серверлеріне қайта делегирлейтін екі NS ресурстық жазбасын, [құрыңыз](#add) две ресурсные NS-записи с именем подзоны, повторно делегирующие подзону на DNS-сервера VK Cloud.
...
1. Жобаны таңдаңыз.
1. Бөлімге өтіңіз **DNS** → **DNS-аймақтар**.
1. Қажетті аймақ үшін ![ ](/kz/assets/more-icon.svg "inline") батырмасын басып **Удалить**.
1. Әрекетті растаңыз.
