...
1. **Аймақ қосу** батырмасын басыңыз.
1. Аймақты басқаруды {var(cloud)} DNS-серверлеріне делегирлеу үшін [көрсетілген](https://kz.cloud.vk.kz/app/services/dns/list) доменнің иесіне жүгініңіз.
...
{note:info}
Көптеген провайдерлерде аймақты басқаруды өз бетінше делегирлеуге болады. Мұны қалай жасау керегі туралы сұрақтарыңыз болса, [көрсетілген](https://kz.cloud.vk.kz/app/services/dns/list) доменнің иесінен көмек сұраңыз.
{/note}
