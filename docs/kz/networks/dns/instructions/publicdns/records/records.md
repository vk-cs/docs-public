...
Қоғамдық DNS-пен жұмыс істеу үшін {var(cloud)} [жеке кабинетінің](https://kz.cloud.vk.com/app/) пайдаланушыларына арналған {linkto(../../../../../access/iam/concepts/rolesandpermissions#iam-concepts-rolesandpermissions)[text=рөлдерді]} баптаңыз:
