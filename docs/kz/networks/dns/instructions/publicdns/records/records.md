...
Қоғамдық DNS-пен жұмыс істеу үшін {var(cloud)} [жеке кабинетінің](https://kz.cloud.vk.com/app/) пайдаланушыларына арналған {linkto(../../../../../tools-for-using-services/account/concepts/rolesandpermissions#tools-account-concepts-rolesandpermissions)[text=рөлдерді]} баптаңыз:
...
1. **Аймақ қосу** батырмасын басыңыз.
1. Аймақты {var(cloud)} DNS-серверлеріне делегациялау үшін [көрсетілген](https://kz.cloud.vk.com/app/services/dns/list) домен иесіне хабарласыңыз.
