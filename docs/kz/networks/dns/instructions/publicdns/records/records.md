...
VK Cloud жобасында ішкіаймақ құру үшін VK Cloud DNS-серверлеріне ішкіаймақты қайта делегациялайтын ішкіаймақ атауымен екі ресурстық NS-жазбаны [құрыңыз](#resurstyk_zhazbalardy_kosu).
...
1. Қажетті жазба үшін ![ ](/kz/assets/more-icon.svg "inline") батырмасын басып **Өңдеу**.
...
1. Қажетті жазба үшін ![ ](/kz/assets/more-icon.svg "inline") батырмасын басып **Өңдеу**.
1. Өзгерістерді енгізіп **Өзгерістерді сақтау**.
...
1. Қажетті жазба үшін ![ ](/kz/assets/more-icon.svg "inline") батырмасын басып **Жою**.
1. Әрекетті растаңыз.
