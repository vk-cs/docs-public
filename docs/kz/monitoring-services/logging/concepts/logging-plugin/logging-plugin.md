...
`mcs1234567890` түріндегі Project Name-пен шатастырмаңыз
...
## {heading(Плагин конфигурациясының параметрлері)[id=logging-conf-parameters]}
...
Авторизация және конфигурация параметрлері арқылы плагинді баптау мысалдары {linkto(../../instructions/connect-plugin#logging-connect-plugin)[text=%text]} және {linkto(../../instructions/manage-vkcloudlogs-plugin#logging-manage-plugin)[text=%text]} бөлімдерінде келтірілген.
