# {heading(Cinder компонентінің оқиғалары)[id=event-log-cinder]}

{include(/kz/_includes/_translated_by_ai.md)}

Cloud Audit-ке {ifndef(private-pdf,private-pg-pdf)}[дискілерді және олардың снапшоттарын басқару сервисі](/kz/computing/iaas/instructions/volumes){/ifndef}{ifdef(private-pdf,private-pg-pdf)}{linkto(../../../../../computing/iaas/instructions/volumes#iaas-volumes)[text=дискілерді және олардың снапшоттарын басқару сервисі]}{/ifdef} жіберетін оқиғалар.

## {heading(Cinder компонентінің v2 оқиғалары)[id=event-log-cinder-v2]}
...
## {heading(Cinder компонентінің v3 оқиғалары)[id=event-log-cinder-v3]}
