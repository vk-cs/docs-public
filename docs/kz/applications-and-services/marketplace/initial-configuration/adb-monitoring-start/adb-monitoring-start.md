...
1. Егер ол бұрын жасалмаған болса, интернетке қолжетімділігі бар [желі жасаңыз](/kz/networks/vnet/instructions/net#vnet-net-add).
1. Arenadata DB үшін мониторинг сервисінің ВМ-і орналастырылатын [ішкі желі баптауларында](/kz/networks/vnet/instructions/net#vnet-net-subnet-edit) **Приватный DNS** опциясын өшіріңіз.
...
1. **Параметры сервера** бетінде деректерді енгізіңіз.
    ...
    1. Сервис инстансы орналастырылатын виртуалды машинаның параметрлерін көрсетіңіз:
        ...
        - **Қолжетімділік аймағы**: ВМ іске қосылатын [деректер орталығын](/kz/start/concepts/architecture#architecture-az) таңдаңыз.
        - **Виртуалды машина түрі**: алдын ала орнатылған [ВМ конфигурациясын](/kz/computing/iaas/concepts/vm/flavor) таңдаңыз.
        - **Желі**: интернетке қолжетімділігі бар және **Приватный DNS** опциясы өшірілген ішкі желісі бар желіні таңдаңыз.
...
1. `\q` командасы арқылы `psql` терминалынан шығыңыз.
