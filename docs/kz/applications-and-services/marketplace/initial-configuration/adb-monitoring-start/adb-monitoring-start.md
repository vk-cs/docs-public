...
1. Arenadata DB үшін мониторинг сервисінің ВМ-і орналастырылатын [ішкі желі баптауларында](/kz/networks/vnet/instructions/net#zhelini_redakciyalau) **Приватный DNS** опциясын өшіріңіз.
