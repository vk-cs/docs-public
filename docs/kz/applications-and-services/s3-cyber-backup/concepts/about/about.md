...
Шлюзді өрістету барысында сіздің VK Cloud жобаңызда қажетті бұлттық ресурстар құрылады, сондай-ақ есептік жазбалар, тенанттар және {linkto(../../../../tools-for-using-services/account/concepts/quotasandlimits#tools-account-concepts-quotasandlimits)[text=квоталар]} бапталады.
