# {heading(Аутентификация және авторизация)[id=mllib-lib-reference]}
...
Токеннің қажетті рөлі: `Администратор`. [Токен рөлдері туралы толығырақ](../lib-authz).

### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_flavors-arguments]}

Аргументтер жоқ.

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_flavors-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_flavors-signature]}
...
1. [Рұқсат токенін жасаңыз](../lib-authz), оған `Администратор` рөлін беріп, егер бұл әлі жасалмаса.
...
Жобада қолжетімді барлық [стандартты желілердің](/kz/networks/vnet/concepts/net-types#vnet-net-types-standard-net) тізімін алу.

Токеннің қажетті рөлі: `Администратор`. [Токен рөлдері туралы толығырақ](../lib-authz).

### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_internal_networks-arguments]}

Аргументтер жоқ.

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_internal_networks-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_internal_networks-signature]}
...
Жобада қолжетімді барлық [сыртқы желілердің](/kz/networks/vnet/concepts/net-types#vnet-net-types-external-net) тізімін алу.

Токеннің қажетті рөлі: `Администратор`. [Токен рөлдері туралы толығырақ](../lib-authz).

### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_external_networks-arguments]}

Аргументтер жоқ.

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_external_networks-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_external_networks-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-create_jupyter_hub-arguments]}
...
Конфигурация шаблондарының тізімін және олардың идентификаторларын [get_flavors](#mllib-lib-reference-get_flavors) әдісі арқылы алуға болады
...
- `volume_type`: [диск түрі](/kz/computing/iaas/concepts/data-storage/disk-types). Рұқсат етілген мәндер — `VolumeType.ceph_ssd` және `VolumeType.high_iops`.
- `availability_zone`: [қолжетімділік аймағы](/kz/start/concepts/architecture#architecture-az). Рұқсат етілген мәндер — `AvailabilityZone.GZ1` және `AvailabilityZone.MS1`.
...
- тұтастай алғанда {var(s3)} сервисі үшін бірегей болуы тиіс (тек жоба шегінде ғана емес);
- 4-тен 63-ке дейін таңбаны қамтуы тиіс;
- тек цифрларды, кіші латын әріптерін және `.`, `-` арнайы таңбаларын қамтуы мүмкін;
- тек кіші латын әріптерімен немесе цифрлармен басталып, солармен аяқталуы тиіс
|===

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-create_jupyter_hub-payloads]}

Жасалған JupyterHub инстансы туралы ақпараты бар `VmDetailInfo` класының объектісі.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-create_jupyter_hub-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-attach_s3_bucket_to_jh-arguments]}
...
Cloud ML Platform-тың барлық инстанстарының тізімін және олардың идентификаторларын [get_all_instances_info](#mllib-lib-reference-get_all_instances_info) әдісі арқылы алуға болады
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-attach_s3_bucket_to_jh-payloads]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-attach_s3_bucket_to_jh-signatures]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-create_mlflow-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-create_mlflow-payloads]}

Жасалған MLflow инстансы туралы ақпараты бар `VmDetailInfo` класының объектісі.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-create_mlflow-signature]}
...
Бар MLflow немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) инстансына қосылған MLflow Deploy инстансын жасау.
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-create_deploy-arguments]}
...
(міндетті)
|`str`
|MLflow Deploy инстансы қосылатын бар MLflow немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) инстансының идентификаторы.
...
(міндетті)
|`str`
|JupyterHub инстансы немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) әкімшісінің логині

|`password`

(міндетті)
|`str`
|JupyterHub инстансы немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) әкімшісінің құпиясөзі
...
(міндетті)
|`MLPlatformNetworkIn`
|Инстанс қосылатын желі. Ол MLflow Deploy инстансы қосылатын JupyterHub немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) инстансының желісімен сәйкес келуі тиіс.
...
MLflow Deploy инстансының жұмыс режимі ол қосылатын MLflow немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) инстансының жұмыс режимімен сәйкес келуі тиіс.

{/note}
|===

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-create_deploy-arguments-payloads]}

Жасалған MLflow Deploy инстансы туралы ақпараты бар `VmDetailInfo` класының объектісі.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-create_deploy-arguments-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_all_instances_info-arguments]}

Аргументтер жоқ.

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_all_instances_info-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_all_instances_info-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_instance_info-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_instance_info-payloads]}

Көрсетілген идентификаторы бар Cloud ML Platform инстансы туралы ақпараты бар `VmDetailInfo` класының объектісі.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_instance_info-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-delete_instance-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-delete_instance-payloads]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-delete_instance-signature]}
...
Токеннің қажетті рөлі: `Пользователь` немесе `Администратор`. [Токен рөлдері туралы толығырақ](../lib-authz).

### {heading(Әдіс аргументтері)[id=mllib-lib-reference-create_deployment-arguments]}
...
Cloud ML Platform-тың барлық инстанстарының тізімін және олардың атауларын [get_all_instances_info](#mllib-lib-reference-get_all_instances_info) әдісі арқылы алуға болады
...
(міндетті)
|`str`
|MLflow Deploy инстансы байланыстырылған JupyterHub инстансы немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) әкімшісінің логині

|`password`

(міндетті)
|`str`
|MLflow Deploy инстансы байланыстырылған JupyterHub инстансы немесе [MLflow Standalone](../../concepts/mlflow-modes#mlplatform-standalone) әкімшісінің құпиясөзі

|`model_username`

(міндетті)
|`str`
|Қашықтағы ML-модель әдістеріне, яғни [predict_model](#mllib-lib-reference-predict_model) және [ping_model](#mllib-lib-reference-ping_model) әдістеріне қол жеткізуге арналған пайдаланушы логині
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-create_deployment-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-create_deployment-signature]}
...
1. [Кітапхананы орнатыңыз](../lib-install), егер бұл әлі жасалмаса.
1. [Рұқсат токенін жасаңыз](../lib-authz), оған `Пользователь` рөлін беріп, егер бұл әлі жасалмаса.
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-list_deployments-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-list_deployments-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-list_deployments-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-get_deployment-arguments]}
...
Барлық өрістетулердің тізімін және олардың атауларын [list_deployments](#mllib-lib-reference-list_deployments) әдісі арқылы алуға болады
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-get_deployment-payloads]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-get_deployment-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-delete_deployment-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-delete_deployment-payloads]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-delete_deployment-signature]}
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-ping_model-arguments]}
...
(міндетті)
|`str`
|[create_deployment](#mllib-lib-reference-create_deployment) әдісін шақырғанда көрсетілген қашықтағы ML-модель әдістеріне қол жеткізуге арналған пайдаланушы логині

|`model_password`

(міндетті)
|`str`
|[create_deployment](#mllib-lib-reference-create_deployment) әдісін шақырғанда көрсетілген қашықтағы ML-модель әдістеріне қол жеткізуге арналған пайдаланушы құпиясөзі
|===

### {heading(Қайтарылатын мән)[id=mllib-lib-reference-ping_model-payloads]}

Егер модель жұмысқа дайын болса, жаңа жолдың `\n` символы.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-ping_model-signatures]}
...
1. ML-модельді жасап, оны оқытыңыз, егер бұл әлі жасалмаса.
1. [MLflow Deploy](../../deploymlflow/instructions/create) инстансын жасаңыз, егер бұл әлі жасалмаса.
1. [create_deployment](#mllib-lib-reference-create_deployment) әдісі арқылы MLflow Deploy инстансында ML-модельді өрістетіңіз.
1. Python скриптін орындаңыз:
...
### {heading(Әдіс аргументтері)[id=mllib-lib-reference-predict_model-arguments]}
...
### {heading(Қайтарылатын мән)[id=mllib-lib-reference-predict_model-payloads]}

Берілген кіріс деректері үшін `Dict[str, Any]` форматындағы ML-модель болжамы.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mllib-lib-reference-predict_model-signature]}
