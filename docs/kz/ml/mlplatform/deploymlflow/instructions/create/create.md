# {heading(MLflow Deploy инстансын жасау)[id=mlflowdeploy-instructions-create]}

{include(/kz/_includes/_translated_by_ai.md)}

Мақалада {var(cloud)} жеке кабинеті арқылы MLflow Deploy инстансын жасау жолы сипатталған.
...
- Cloud ML Platform кітапханасы, [create_deploy](../../../mlplatform-lib/lib-reference#mllib-lib-reference-create_deploy) әдісі;
- [MLflow Deployment Client кітапханасы](../../how-to-guides/manage-mlflow-client).

MLflow Deploy инстансы тек MLflow инстансымен бірге ғана жасалуы мүмкін. Өз кезегінде, MLflow инстансы екі режимде жұмыс істей алады: [JupyterHub-пен бірге](../../../concepts/mlflow-modes#mlplatform-with_jh) немесе бөлек, [Standalone режимінде](../../../concepts/mlflow-modes#mlplatform-standalone).
...
1. **Конфигурация** қадамында инстанс параметрлерін көрсетіңіз:
    ...
    - **Қолжетімділік аймағы**: инстанс іске қосылатын [деректер орталығын](/kz/start/concepts/architecture#architecture-az) таңдаңыз.
    - **Диск өлшемі**: ВМ дискінің өлшемін ГБ-пен көрсетіңіз.
    - **Диск түрі**: жасалатын дискінің [түрін](/kz/computing/iaas/concepts/data-storage/disk-types) көрсетіңіз.
