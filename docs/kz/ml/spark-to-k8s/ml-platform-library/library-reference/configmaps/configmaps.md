# {heading(ConfigMaps-пен жұмыс істеу)[id=mlspark-library-reference-configmaps]}

{include(/kz/_includes/_translated_by_ai.md)}

Бұл әдістер Cloud Spark кластерінің жұмысын қамтамасыз ететін Managed Containers кластерінің [ConfigMaps](https://kubernetes.io/docs/concepts/configuration/configmap/) (конфигурация карталарымен) жұмыс істеуге мүмкіндік береді. Олар конфигурациялық деректерді: орта айнымалыларын, пәрмен жолы аргументтерін немесе конфигурация файлдарын сақтау үшін пайдаланылады. ConfigMap қолдану нақты орындау ортасына тәуелді конфигурациялық деректер баптауын қолданба кодынан бөлуге мүмкіндік береді. Бұл сіздің Spark қолданбаларыңызды кодты орындау орталары арасында тасымалдауды жеңілдетеді.

{note:warn}

ConfigMap класы сақталатын деректердің құпиялылығы мен шифрлануын қамтамасыз етпейді. Құпия деректермен жұмыс істеу үшін {linkto(../secrets#mlspark-library-reference-secrets)[text=құпиялармен жұмыс істеу әдістерін]} немесе үшінші тарап құралдарын пайдаланыңыз.
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-configmaps-create_configmap_from_yaml-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-configmaps-create_configmap_from_yaml-result]}
...
### {heading(Әдіс сигнатурасы, манифест мысалдары және әдісті пайдалану мысалы)[id=mlspark-library-reference-configmaps-create_configmap_from_yaml-signature]}
...
production-ортада токендермен ашық түрде жұмыс істемеңіз. Орта айнымалыларын, құпиялар қоймаларын немесе сезімтал деректермен жұмыс істеуге арналған басқа құралдарды пайдаланыңыз. {linkto(../../authz#mlspark-library-authz)[text=Токендер туралы толығырақ]}.
...
Тізімдегі жеке ConfigMap туралы егжей-тегжейлі ақпаратты алу үшін [get_configmap_detail](#mlspark-library-reference-configmaps-get_configmap_detail) әдісін пайдаланыңыз.
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-configmaps-list_configmaps-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-configmaps-list_configmaps-result]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-configmaps-list_configmaps-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-configmaps-get_configmap_detail-arguments]}
...
Барлық ConfigMap атауларының тізімін [list_configmaps](#mlspark-library-reference-configmaps-list_configmaps) әдісі арқылы алуға болады
|`namespace`
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-configmaps-get_configmap_detail-result]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-configmaps-get_configmap_detail-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-configmaps-delete_configmap-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-configmaps-delete_configmap-result]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-configmaps-delete_configmap-signature]}
...
1. Python скриптін орындаңыз:
   ...
   Көрсетілген атауы бар ConfigMap Cloud Spark кластерінен жойылады. Мұны [list_configmaps](#mlspark-library-reference-configmaps-list_configmaps) әдісі арқылы тексеруге болады.
