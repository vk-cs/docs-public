# {heading(Spark тапсырмаларымен жұмыс істеу)[id=mlspark-library-reference-spark-jobs]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-get_default_manifest-arguments]}
...
```python
client_manifest.job_name = '<тапсырманың жаңа атауы>'
```

Мұнда `client_manifest` — `get_default_manifest` әдісі немесе [get_manifest_from_yaml_file](#mlspark-library-reference-spark-jobs-get_manifest_from_yaml_file) арқылы алынған SparkApplication түріндегі манифест.

{/cut}

{/note}

### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-get_default_manifest-result]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-get_default_manifest-signature]}
...
Production-ортада токендерді ашық түрде қолданбаңыз. Қоршаған орта айнымалыларын, құпиялар қоймаларын немесе сезімтал деректермен жұмыс істеуге арналған басқа құралдарды пайдаланыңыз. {linkto(../../authz#mlspark-library-authz)[text=Токендер туралы толығырақ]}.

{/note}

1. {linkto(../../install#mlspark-library-install)[text=Кітапхананы орнатыңыз]}, егер бұл әлі жасалмаса.
1. {linkto(../../authz#mlspark-library-authz)[text=Қатынау токенін жасаңыз]} `Администратор` немесе `Пользователь` рөлімен, егер бұл әлі жасалмаса.
1. Python скриптін орындаңыз:

   ```python
   from mlplatform_client import MLPlatform

   REFRESH_TOKEN = '<қатынау токенінің мәні>'
...
### {heading(Манифесті баптау мысалдары)[id=mlspark-library-reference-spark-jobs-get_default_manifest-examples]}
...
- `on_failure_retries_interval`: тапсырманы орындау қатесі болған кезде қайта іске қосу әрекеттері арасындағы секундтармен интервал.
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-get_manifest_from_yaml_file-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-get_manifest_from_yaml_file-result]}

`Manifest` класының нысаны.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-get_manifest_from_yaml_file-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-save_yaml-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-save_yaml-result]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-save_yaml-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_submit_job-arguments]}
...
Нысанды [get_default_manifest](#mlspark-library-reference-spark-jobs-get_default_manifest) немесе [get_manifest_from_yaml_file](#mlspark-library-reference-spark-jobs-get_manifest_from_yaml_file) әдісі арқылы алуға болады.
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_submit_job-result]}

Spark тапсырмасы туралы ақпараты бар `K8sSparkJobInfo` класының нысаны.

{include(/kz/_includes/_spark_job_info.md)}

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_submit_job-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_jobs_list-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_jobs_list-result]}

Cloud Spark кластері тапсырмалары туралы ақпараты бар `K8sSparkJobInfo` класы нысандарының тізімі.

{include(/kz/_includes/_spark_job_info.md)}

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_jobs_list-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_job_info-arguments]}
...
Spark тапсырмаларының атауларын [spark_jobs_list](#mlspark-library-reference-spark-jobs-spark_jobs_list) әдісі арқылы алуға болады.
|===

### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_job_info-result]}

Spark тапсырмасы туралы толық ақпараты бар `K8sSparkJobInfoDetail` класының нысаны.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_job_info-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_job_logs-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_job_logs-result]}

Spark тапсырмасының логтары бар `K8sSparkJobLogs` класының нысаны.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_job_logs-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-describe_spark_job-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-describe_spark_job-result]}
...
### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-describe_spark_job-signature]}
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_delete_job-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_delete_job-result]}

Қайтарылатын мән жоқ.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_delete_job-signature]}
...
1. Python скриптін орындаңыз:
   ...
   `pi-spark-job-5` атауы бар Spark тапсырмасы жойылады. Мұны [spark_jobs_list](#mlspark-library-reference-spark-jobs-spark_jobs_list) әдісі арқылы тексеруге болады.
...
### {heading(Әдіс аргументтері)[id=mlspark-library-reference-spark-jobs-spark_events-arguments]}
...
### {heading(Қайтарылатын мән)[id=mlspark-library-reference-spark-jobs-spark_events-result]}

Cloud Spark кластері оқиғаларының тізімі бар `K8sSparkEventsList` класының нысаны.

### {heading(Әдіс сигнатурасы және пайдалану мысалы)[id=mlspark-library-reference-spark-jobs-spark_events-signature]}
