# {heading(Құпиясөздермен жұмыс істеу)[id=mlspark-library-reference-secrets]}
...
(міндетті)
|`str`
|Құпиясөз жасау қажет болатын Cloud Spark кластерінің идентификаторы. Cloud Spark кластерлерінің тізімін және олардың идентификаторларын [get_clusters](../clusters#mlspark-library-reference-clusters-get_clusters) әдісі арқылы алуға болады
...
Тізімдегі жеке құпиясөз туралы толық ақпаратты алу үшін [get_secret_detail](#mlspark-library-reference-secrets-get_secret_detail) әдісін пайдаланыңыз.
...
Құпиясөз атауларының тізімін [list_secrets](#mlspark-library-reference-secrets-list_secrets) әдісі арқылы алуға болады
...
1. Python скриптін орындаңыз:
   ...
   Құпиясөз Cloud Spark кластерінен жойылады. Мұны [list_secrets](#mlspark-library-reference-secrets-list_secrets) әдісі арқылы тексеруге болады.
