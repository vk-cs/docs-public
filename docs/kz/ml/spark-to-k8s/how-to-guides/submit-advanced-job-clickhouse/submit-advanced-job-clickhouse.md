...
1. [Қолжетімділік токенін жасаңыз](../../ml-platform-library/authz) `Администратор` рөлімен, егер бұл әлі жасалмаған болса. Бұл токен кітапханамен жұмыс істеу үшін қажет.
