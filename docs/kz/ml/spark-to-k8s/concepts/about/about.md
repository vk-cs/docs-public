...
{include(/kz/_includes/_spark.md)[tags=intro]}
...
- Алдын ала орнатылған Spark бейнесі бар VK Cloud [Docker Registry](/kz/kubernetes/k8s/instructions/addons/advanced-installation/install-advanced-registry) пайдалану.
...
- Spark History Server көмегімен Spark тапсырмаларының орындалу тарихын бақылау.
...
- S3 қолдауы бар [VK Object Storage](/kz/storage/s3) қоймасында объектілерді сақтау.
- [Cloud ML Platform Python-кітапханасы](/ru/ml/spark-to-k8s/ml-platform-library) арқылы кластерді басқару, қолданбаларды іске қосу және жөндеу.
