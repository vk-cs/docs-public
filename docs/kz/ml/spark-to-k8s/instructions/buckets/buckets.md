...
1. Егер бұл әлі жасалмаса, `Әкімші` рөлімен қолжетімділік токенін [жасаңыз](/kz/ml/spark-to-k8s/ml-platform-library/authz).
...
1. Python скриптін орындаңыз:
     ...
     - `REFRESH_TOKEN`: бұрын жасалған `Әкімші` рөлі бар қолжетімділік токені.
