...
1. Түйіндер тобы үшін [баптауларды](/kz/kubernetes/mk8s/instructions/manage-node-group) орнатыңыз.
...
worker-түйіндер тобының өлшемін қолмен өзгертуге немесе автоматты масштабтауды баптауға болады. Бұл операциялар [Кластер түйіндерін масштабтау](/kz/kubernetes/mk8s/concepts/scale) бөлімінде толық сипатталған.
