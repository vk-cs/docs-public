# {heading(Объектілерді тану)[id=vision-instructions-vision-api-obj]}
...
## {heading(Сұрау)[id=vision-instructions-vision-api-obj-request]}
...
## {heading(Сұрау үлгісі)[id=vision-instructions-vision-api-obj-request-example]}
...
## {heading(Жауап)[id=vision-instructions-vision-api-obj-request-answer]}
...
## {heading(Жауап үлгісі)[id=vision-instructions-vision-api-obj-request-answer-example]}
...
## {heading(Қосымша мысалдар)[id=vision-instructions-vision-api-obj-request-extra-examples]}

### {heading(Өсімдіктері бар кескіннен объектілерді іздеу)[id=vision-instructions-vision-api-obj-request-extra-examples-search-plants]}
...
### {heading(Жарамсыз JSON немесе кескін (рұқсат етілген mode жоқ))[id=vision-instructions-vision-api-obj-request-extra-examples-invalid-json]}
