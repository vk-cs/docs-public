...
**Применимые правила** — настоящее Соглашение, доступное в сети Интернет по адресу: [https://cloud.vk.com/docs/start/legal/vk/policy-1cgrm](/kz/start/legal/vk/policy-1cgrm), содержащее в себе условия доступа и использования Сервиса а также следующие документы, в объеме, необходимом для использования Сервиса:

1. Условия использования Платформы «VK Cloud» ([https://cloud.vk.com/docs/start/legal/vk/legal-terms](/kz/start/legal/vk/legal-terms));
2. Политика конфиденциальности Компании ([https://cloud.vk.com/docs/start/legal/vk/policy-privacy](/kz/start/legal/vk/policy-privacy)).
...
5.1. Размер ответственности Компанию ограничен исключительно соответствующими Применимыми правилами, размещенным на Сайте в разделе [https://cloud.vk.com/docs/kz/start/legal/vk](/kz/start/legal/vk).
