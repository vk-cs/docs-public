...
Журналдар тек 2020 жылғы 1 желтоқсаннан кейін жасалған ДҚ инстанстары үшін қолжетімді.
...
1. {linkto(../../../../computing/iaas/instructions/vm/vm-connect/vm-connect-nix#iaas-vm-connect-nix)[text=SSH арқылы ВМ-ге қосылыңыз]} `admin` тіркелгісінің атынан.
   ...
   Кластерлік конфигурацияда `Master` түріндегі ВМ-ге қосылыңыз.

   {/note}

1. ДҚБЖ түріне байланысты журналдарды көрсету пәрменін орындаңыз:
