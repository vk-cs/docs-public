...
## {heading(Сипаттамасы)[id=dbaas-node-exporter-desc]}
...
## {heading(Серверлік метрикаларға арналған Prometheus (node_exporter))[id=dbaas-node-exporter-prometheus]}
...
## {heading(Кеңейтімді орнату)[id=dbaas-node-exporter-install-ext]}
