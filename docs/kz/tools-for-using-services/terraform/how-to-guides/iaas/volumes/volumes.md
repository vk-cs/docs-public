...
Том жасау үшін жасалатын том конфигурациясы сипатталатын `volume.tf` файлын жасаңыз. Төмендегі мысалдан мәтінді қосып, томыңыз үшін баптау мәндерін түзетіңіз. Бұл мысалда `ceph-ssd` қолжетімділік аймағында `GZ1` түріндегі, өлшемі 1 ГБ диск томын жасау сипатталады.
