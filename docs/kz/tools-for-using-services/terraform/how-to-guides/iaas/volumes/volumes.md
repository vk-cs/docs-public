...
Том жасау үшін жасалатын том конфигурациясы сипатталатын `volume.tf` файлын жасаңыз. Төмендегі мысалдан мәтінді қосып, томыңыз үшін баптау мәндерін түзетіңіз. Бұл мысалда `ME1` қолжетімділік аймағында `ceph-ssd` түріндегі, өлшемі 1 ГБ диск томын жасау сипатталады.
