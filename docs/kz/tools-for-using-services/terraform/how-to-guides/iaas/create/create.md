...
1. Айнымалылармен бірге Terraform конфигурациясының `variables.tf` файлын жасаңыз:
   ...
   [Қолжетімділік аймақтары](/kz/start/concepts/architecture#architecture-az) туралы мақалада.
...
ВМ-ге SSH арқылы қосылу үшін оған `ssh` [алдын ала бапталған қауіпсіздік тобын](/kz/networks/vnet/concepts/traffic-limiting#vnet-traffic-limiting-secgroups) тағайындаңыз. Бұл топ жобаға бұрын SSH арқылы қолжетімді Linux ОЖ-лі ВМ жасалған болса, жобада бар болады.
...
1. `main.tf` файлындағы `vkcs_compute_instance` ресурсының сипаттамасына `cloud_monitoring` блогын қосыңыз. Мысал:
