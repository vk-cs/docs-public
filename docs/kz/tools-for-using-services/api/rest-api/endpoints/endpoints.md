...
| Keystone          | https://infra.mail.ru:5000/v3/                | Жоба пайдаланушыларын басқару, [токендер](../case-keystone-token) негізінде пайдаланушыларды авторизациялау |
...
## {heading(Project ID алу)[id=rest-api-endpoints-get-project-id]}
