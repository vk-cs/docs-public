...
Жеке кабинетте Service Users эндпоинті (https://kz.cloud.vk.com/service-users/) көрсетілмеген — ол [сервистік есептік жазбаларды](/kz/access/iam/concepts/kz/access/iam/concepts/service-accounts) басқаруға мүмкіндік береді.
