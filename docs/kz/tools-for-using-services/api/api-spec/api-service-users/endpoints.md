...
VK Cloud-пен API арқылы жұмыс істеу үшін [API арқылы қолжетімділікті белсендіріңіз](../../rest-api/enable-api). Сервистермен жұмыс туралы толығырақ [API спецификациясы](/kz/tools-for-using-services/api) бөлімінен оқыңыз.

## Эндпоинттер тізімін көру

Тізім барлық пайдаланушыларға, олардың [рөліне](/kz/access/iam/concepts/rolesandpermissions) қарамастан қолжетімді.
...
| Эндпоинт                            | Мекенжай                   | Мақсаты |
|-------------------------------------|-------------------------|-----------------|
| Magnum            | https://infra.mail.ru:9511/v1                       | [Managed Containers](/kz/kubernetes/mk8s) контейнерлерін басқару |
| Magnum-addons     | https://mcs.mail.ru/infra/container/addons          | Managed Containers сервисінің [аддондарын](/kz/kubernetes/mk8s/instructions/addons) басқару |
...
| Keystone          | https://infra.mail.ru:5000/v3/                | Жоба пайдаланушыларын басқару, [токендер](../../rest-api/case-keystone-token) негізінде пайдаланушыларды авторизациялау |
...
Project ID жеке кабинеттегі [жоба идентификаторымен](/kz/tools-for-using-services/account/instructions/project-settings/manage#project-pid-view) сәйкес келмейді. Бұл конфигурациялық файлдарда пайдаланылатын басқа идентификатор:
