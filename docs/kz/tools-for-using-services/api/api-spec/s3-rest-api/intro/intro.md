# {heading(Жұмысты бастау)[id=api-spec-s3-intro]}
...
{var(s3)} сервисіне жіберілетін сұраулардың көпшілігі аутентификацияны талап етеді.
...
- `<ключ-доступа>` — {var(s3)} сервисіне қол жеткізу [кілтінің идентификаторы](../../../../../storage/s3/instructions/access-management).
