...
1. **AI API** блогынан эндпоинтті табыңыз.
1. [Алыңыз](/kz/ml/vision/quick-start/auth-vision) қолжетімділік токенін.

{/cut}

{note:info}

JSON форматындағы бастапқы спецификацияны [сілтеме](assets/visionapi-swagger.json "download") арқылы жүктеп ала аласыз.
