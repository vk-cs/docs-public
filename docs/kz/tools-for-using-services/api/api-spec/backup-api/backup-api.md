...
1. **OpenStack сервисі** блогынан **Karboii** endpoint-ін табыңыз.
...
JSON форматындағы бастапқы спецификацияны [сілтеме](assets/karboiiapi-swagger.json "download") арқылы жүктеп ала аласыз.
