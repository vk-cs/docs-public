# {heading(Файлдық қоймаларды басқару)[id=api-spec-manila]}
...
1. **OpenStack Service** блогынан **Manila** эндпоинтін табыңыз.
...
JSON форматындағы бастапқы спецификация [сілтеме](./assets/manila-api.json "download") бойынша қолжетімді.

{/note}

![{swagger}](assets/manila-api.json)
