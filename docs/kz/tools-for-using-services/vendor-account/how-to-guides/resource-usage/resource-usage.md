...
Сіз Marketplace арқылы сатып алынған image-based қолданбаларыңызбен пайдаланушылар жұмыс істеген кезде VK Cloud жүйесіне ресурс тұтыну метрикаларын жібере аласыз. Бұл VK Cloud жүйесіне пайдаланушылардан тұтынған ресурстары үшін өздері таңдаған тарифке сәйкес автоматты түрде ақы алуға мүмкіндік береді.

Төменде мысал ретінде VK Cloud жүйесіне метрикаларды қорғалған түрде жіберуді келесі қауіпсіздік механизмдерін пайдалана отырып қалай ұйымдастыруға болатыны көрсетілген:
...
1. image-based қолданбаңыздың сервистік пакетін дайындау кезінде [Terraform манифесіне](../../manage-apps/ibservice_add/tf_manifest/tf_manifest_steps) мысалда көрсетілгендей қосымша ресурстарды қосыңыз:
    ...
    - `token_rotate` — токеннің автоматты ротациясын орындау белгісі:
        - `true` — токен мезгіл-мезгіл жаңартылып отырады. Қолданбаңызды пайдаланушылардың ресурс тұтыну метрикалары сияқты сезімтал ақпаратты VK Cloud жүйесіне жіберген кезде токен ротациясын қосу ұсынылады.
...
VK Cloud жүйесіне метрикаларды беру процесін жөндеу үшін Marketplace API-ге сұрау орындаңыз:
...
## 5. Метрикаларды VK Cloud жүйесіне жіберіңіз
