...
* Бұлтты платформа DNS-ін пайдалану (толығырақ — [VK CS Infra (iVK CS) провайдері бойынша анықтамалық](../../../ivkcs) бөлімінде).
  ...
  {/note}
* VK Object Storage бакеттерін жасау (толығырақ — [VK CS Infra (iVK CS) провайдері бойынша анықтамалық](../../../ivkcs) бөлімінде). Жасалған бакеттер бұлтты платформа ЛК-да көрсетіледі.
