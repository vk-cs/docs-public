...
* Qemu-guest-agent — бұлтты платформаның ЖК арқылы ВМ үшін пароль орнатуға мүмкіндік береді (толығырақ — [ВМ басқару](/kz/computing/iaas/instructions/vm/vm-manage#password) бөлімінде).
