...
1. Бұлттық платформаның ЖК-да екі факторлы аутентификацияны (2FA) және API арқылы қол жеткізуді қосыңыз (толығырақ — [2FA басқару](/kz/access/iam/instructions/manage-2fa) бөлімінде).
