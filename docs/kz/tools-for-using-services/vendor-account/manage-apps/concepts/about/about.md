...
Сервистер орналастырылатын жүйенің толық атауы: {var(cloud)} (XaaS).

Жүйенің қысқаша атаулары: Marketplace, қолданбалар дүкені, дүкен.

Marketplace {var(cloud)} бұлттық платформасымен интеграцияланған. Marketplace бұлттық платформа пайдаланушыларына онда орналастырылған сервистерге қолжетімділікті қамтамасыз етеді.
...
* Image-based қолданба — пайдаланушының бұлттық жобасындағы виртуалды машиналар образдарының негізінде жайылатын өнім. Сервистің жұмысы үшін бұлттық платформаның қосымша инфрақұрылымы пайдаланылуы мүмкін: виртуалды желілер, жүктеме теңгергіштері, DBaaS кластерлері, {var(s3)}, резервтік көшіру. Сервистің жұмыс істеуіне арналған инфрақұрылымды бұлттық платформа ұсынады. Сервис инстанстары пайдаланушының жобасында жайылады.
