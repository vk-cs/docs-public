...
Сервисті дүкенге жүктейтін пайдаланушының бұлттық платформада тіркелгісі (жеке кабинеті) болуы тиіс. Тіркелу нұсқаулығы [Регистрация в {var(cloud)}](/kz/intro/onboarding/account) бөлімінде берілген.
...
{caption(Рисунок {counter(pic)[id=numb_pic_saas_upload]} — SaaS-қолданбаны жүктеу)[align=center;position=under;id=pic_saas_upload;number={const(numb_pic_saas_upload)} ]}
