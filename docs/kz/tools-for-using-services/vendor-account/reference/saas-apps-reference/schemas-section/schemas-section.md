...
* `service_instance` секциясы жоспардың тарифтік опцияларын сипаттайды және ақылы опциялар үшін ақшалай қаражатты есептен шығару тәсілін анықтайды.
  ...
  * `service_instance.resource_usages` секциясы кейін төленетін тарифтік опцияларды сипаттайды. Осы секциядағы барлық опциялар [брокерде сипатталуы](../../../manage-saas-apps/saas-add#saas_broker) керек.
