...
Егер метрикалар [pull-моделі](../../../manage-apps/concepts/about#billing_pull) бойынша жиналса, құн Marketplace-ке есепті жіберу үшін [брокер әдісінде](../../../manage-saas-apps/saas-add#saas_broker) көрсетілген `price` мәніне сәйкес болуы керек.
...
Төменде осы мысалдағы тарифтік жоспар құны мен опцияның тарифтік жоспарды конфигурациялау шеберінде қалай көрсетілетіні берілген. Шеберде көрсетілетін опция атауы `<ИМЯ_ОПЦИИ>.description` секциясындағы `schemas` параметрімен беріледі. Бұл мысалда `quantity.description` мәні `Объем загружаемых сборок` болып табылады.
...
Төменде осы мысалдағы тарифтік жоспар құны мен опцияның тарифтік жоспарды конфигурациялау шеберінде қалай көрсетілетіні берілген. Шеберде көрсетілетін опция атауы `<ИМЯ_ОПЦИИ>.description` секциясындағы `schemas` параметрімен беріледі. Бұл мысалда `notifications.description` мәні `Уведомления о новых отчетах` болып табылады.
...
Тарифтік жоспарды конфигурациялау шеберінің көрінісі суретте келтірілген. Шеберде көрсетілетін опция атауы `<ИМЯ_ОПЦИИ>.description` секциясындағы `schemas` параметрімен беріледі. Бұл мысалда `storage.description` мәні `Хранение в ДЦ Киберпротект для продуктов Кибер Бэкап Облачный` болып табылады.
