...
VK Cloud жүйесіне өзіңіздің куәландыру жеткізушіңізді (Identity Provider) қосуға болады. Бұл қызметкерлеріңізге куәландыру жеткізушісінің корпоративтік аутентификация деректерін пайдаланып, логин мен құпиясөзді енгізбей-ақ VK Cloud жүйесіне кіруге мүмкіндік береді. Мұндай режим куәліктер федерациясы деп аталады.

Федерация режимінде жұмыс істеу үшін куәландыру жеткізушісі SAML 2.0 стандартын қолдауы тиіс.

Әрі қарай VK Cloud жүйесіне кіру үшін куәліктер федерациясын [Active Directory федерация қызметі](https://learn.microsoft.com/ru-ru/windows-server/identity/ad-fs/ad-fs-overview) (AD FS) мысалында баптау көрсетіледі.

{note:info}
VK Cloud техникалық қолдау порталына куәліктер федерациясы арқылы кіруді баптау үшін [нұсқаулықпен](/kz/tools-for-using-services/vk-cloud-account/instructions/support-fim) танысыңыз.
{/note}
...
## 3. VK Cloud жүйесінде топтар мен рөлдер арасындағы байланысты баптаңыз

VK Cloud жүйесінде AD FS топтары мен рөлдері арасындағы байланысты баптау операциялары жеке кабинеттің келесі [рөлдеріне](/kz/tools-for-using-services/account/concepts/rolesandpermissions) ғана қолжетімді: иесіне, суперадминистраторға және пайдаланушылар әкімшісіне (IAM). Байланыстарды қарау жоба әкімшісі мен бақылаушыға да қолжетімді.
...
1. Өз корпоративтік аутентификация деректеріңізді енгізіңіз. Сәтті авторизациядан кейін VK Cloud жеке кабинетінің басты бетіне қайта бағытталасыз.
1. VK Cloud пайдаланушысына автоматты түрде тағайындалған рөл [топты қосу](#3_vk_cloud_zhuyesinde_toptar_men_rolder_arasyndagy_baylanysty_baptanyz) кезінде таңдалған рөлге сәйкес келетінін тексеріңіз.

{note:warn}

Active Directory VK Cloud жүйесімен автоматты түрде синхрондалмайды. Пайдаланушы Active Directory-де бұғатталғаннан кейін оны VK Cloud жеке кабинетінде жобалардан [жойыңыз](/kz/tools-for-using-services/account/instructions/project-settings/access-manage#katysushyny_zhoyu).
