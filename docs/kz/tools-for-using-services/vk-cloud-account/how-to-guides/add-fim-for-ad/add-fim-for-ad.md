...
## {heading(3. {var(cloud)} жүйесінде топтар мен рөлдер арасындағы байланысты баптаңыз)[id=vk-cloud-account-ad-fim-connect]}

{var(cloud)} жүйесінде AD FS топтары мен рөлдері арасындағы байланысты баптау операциялары жеке кабинеттің келесі [рөлдеріне](/kz/tools-for-using-services/account/concepts/rolesandpermissions) ғана қолжетімді: иесіне, суперадминистраторға және пайдаланушылар әкімшісіне (IAM). Байланыстарды қарау жоба әкімшісі мен бақылаушыға да қолжетімді.
...
1. Active Directory-де пайдаланатын топтарды қосыңыз:
    ...
    1. Топты баптаңыз:
        ...
        - **Топ рөлдері**: жасалатын топқа арналған қол жеткізу матрицаңызға сәйкес келетін [рөлдерді {var(cloud)}](/kz/tools-for-using-services/account/concepts/rolesandpermissions) таңдаңыз.
...
1. {var(cloud)} пайдаланушысына автоматты түрде тағайындалған рөл {linkto(#vk-cloud-account-ad-fim-connect)[text=топты қосу]} кезінде таңдалған рөлге сәйкес келетінін тексеріңіз.

{note:warn}

Active Directory {var(cloud)} жүйесімен автоматты түрде синхрондалмайды. Пайдаланушы Active Directory-де бұғатталғаннан кейін оны {var(cloud)} жеке кабинетінде жобалардан [жойыңыз](/kz/tools-for-using-services/account/instructions/project-settings/access-manage#project-access-delete-user).
