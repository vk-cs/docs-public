...
VK Cloud жүйесінде топтар мен рөлдер арасындағы байланысты баптау операциялары жеке кабинеттің келесі [рөлдеріне](../../../account/concepts/rolesandpermissions) ғана қолжетімді: иесіне, суперадминистраторға және пайдаланушылар әкімшісіне (IAM).
...
1. Keycloak-та пайдаланатын топтарды қосыңыз:
    ...
    1. Топты баптаңыз:
        ...
        * **Топ рөлдері**: жасалатын топқа арналған қол жеткізу матрицаңызға сәйкес келетін [рөлдерді VK Cloud](../../../account/concepts/rolesandpermissions) таңдаңыз.
