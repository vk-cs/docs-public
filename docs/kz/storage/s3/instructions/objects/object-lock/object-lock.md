...
1. Қорғау режимін таңдаңыз:

    - `Governance` — {linkto(../../../concepts/objects-lock#s3-concepts-object-lock-governance)[text=басқарылатын режим]} бұғаттауды айналып өту мүмкіндігімен;
    - `Compliance` — {linkto(../../../concepts/objects-lock#s3-concepts-object-lock-compliance)[text=қатаң режим]} белгіленген мерзім аяқталғанға дейін бұғаттауды алып тастау мүмкіндігінсіз.

1. Сақтау мерзімін күндермен таңдаңыз.
...
1. **Мерзімсіз бұғаттау** опциясын қосыңыз немесе өшіріңіз.
...
1. Егер бұл бұрын жасалмаған болса, объектілерді бұғаттауды қосыңыз.
1. ![ ](../../../assets/settings-sliders.svg "inline") белгішесін басыңыз.
1. **Уақытша бұғаттау** опциясын қосыңыз немесе өшіріңіз.
1. Егер **Уақытша бұғаттау** опциясын қоссаңыз, қорғау режимін таңдаңыз:

    - `Governance` — {linkto(../../../concepts/objects-lock#s3-concepts-object-lock-governance)[text=басқарылатын режим]} бұғаттауды айналып өту мүмкіндігімен;
    - `Compliance` — {linkto(../../../concepts/objects-lock#s3-concepts-object-lock-compliance)[text=қатаң режим]} белгіленген мерзім аяқталғанға дейін бұғаттауды алып тастау мүмкіндігінсіз.

1. Егер **Уақытша бұғаттау** опциясын қоссаңыз, бұғаттаудың аяқталу күні мен уақытын көрсетіңіз. Ең төменгі мән — бұғаттау орнатылған сәттен бастап 24 сағат.
1. **Қолдану** түймесін басыңыз.
...
{note:warn}
Уақытша бұғаттауды тек AWS CLI немесе {linkto(../../../api#s3-api)[text=API]} көмегімен және тек {linkto(../../../concepts/objects-lock#s3-concepts-object-lock-governance)[text=басқарылатын режимде]} (`GOVERNANCE`) бұғаттауы бар объектілер үшін ғана айналып өтуге болады.

{linkto(../../../concepts/objects-lock#s3-concepts-object-lock-compliance)[text=қатаң режимі]} (`COMPLIANCE`) бар бұғаттауды айналып өту мүмкін емес.
{/note}
