...
1. {var(cloud)} сервистерінің құнын зерттеңіз:
   ...
   1. [Прейскурантпен](https://cloud.vk.kz/pricelist/) танысыңыз.
   ...
   1. Қажетті конфигурацияның құнын есептеу үшін [калькуляторды](https://cloud.vk.kz/pricing) пайдаланыңыз.
