...
Docker Registry және Ingress NGINX аддондарын орнату кезінде олар үшін [стандартты жүктеме теңгергіштері](/kz/networks/balancing/concepts/load-balancer#zhukteme_tengergishterinin_turleri) жасалады.
...
- [kauthproxy](https://github.com/int128/kauthproxy/releases) утилитасы. Толығырақ [Kubernetes Dashboard көмегімен кластерге қосылу](/kz/kubernetes/k8s/connect/k8s-dashboard) бөлімінде.
...
1. Осы пайдаланушы үшін [API арқылы қолжетімділікті белсендіріңіз](/kz/tools-for-using-services/api/rest-api/enable-api#api_arkyly_kolzhetimdilikti_belsendiru).
...
Кластерде Prometheus және Grafana негізіндегі [мониторинг құралдары](/kz/kubernetes/k8s/monitoring) бар аддон орнатылды. Сондай-ақ барлық Cloud Containers кластерлері үшін [Kubernetes Dashboard](/kz/kubernetes/k8s/connect/k8s-dashboard) қолжетімді, ол кластерді басқаруға ғана емес, оны мониторингтеуге де мүмкіндік береді.
...
1. Терминалдың бөлек сессиясында команданы орындаңыз:
   ...
   Бұл сессияны жаппаңыз, әйтпесе Kubernetes Dashboard веб-интерфейсіне қол жеткізу жоғалады.

   {/note}

1. Егер құпиясөз сұралса, VK Cloud жеке кабинетінің пайдаланушы құпиясөзін енгізіңіз.

Браузер ашылады, және сіз Kubernetes Dashboard веб-интерфейсіне бағытталасыз. Одан әрі кластер ресурстары туралы ақпарат алу үшін көру үшін қолжетімді кез келген санатты таңдаңыз.
...
1. Жайылдырудың дұрыстығын тексеріңіз:
   ...
   Тәсілдердің бірін пайдаланыңыз:
    ...
    - Kubernetes Dashboard: **Cluster → Persistent Volumes** дашбордын ашыңыз.
   ...
   Тәсілдердің бірін пайдаланыңыз:
    ...
    - Kubernetes Dashboard: **Workloads → Deployments** дашбордын ашыңыз.
   ...
   Тәсілдердің бірін пайдаланыңыз:
    ...
    - Kubernetes Dashboard: **Service → Services** дашбордын ашыңыз.
...
- Кейінірек пайдалану үшін кластерді [тоқтатыңыз](/kz/kubernetes/k8s/instructions/manage-cluster#klasterdi_iske_kosu_nemese_toktatu) немесе оны біржола [жойыңыз](/kz/kubernetes/k8s/instructions/manage-cluster#delete_cluster).
- Жүктеме теңгергіштерін [жойыңыз](/kz/networks/balancing/instructions/manage-lb#zhukteme_tengergishin_zhoyu).
