...
ClickHouse — столбцовая аналитическая СУБД с открытым исходным кодом, разрабатываемая компанией ClickHouse Inc.
...
Cloud ClickHouse — готовое решение для хранения и аналитики исторических данных на основе столбцовой аналитической СУБД ClickHouse, разрабатанной компанией ClickHouse Inc.
