...
Резервтік көшірмеден қалпына келтіргеннен кейін ВМ операциялық жүйесіндегі интерфейс баптауларын [тексеріп, қажет болса түзетіңіз](/kz/computing/iaas/troubleshooting/linux-vm-network#1_proverte_nastroyki_setevogo_interfeysa). ВМ-нің ішкі және сыртқы мекенжайларының баптаулары [жеке кабинеттегі](https://kz.cloud.vk.kz/app/) баптауларға сәйкес келуі керек.
