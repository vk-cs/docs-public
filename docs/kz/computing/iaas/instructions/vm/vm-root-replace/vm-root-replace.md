...
1. Қажетті дисктер тізімі бар бетті ашыңыз.
    ...
    - Барлық дисктер: **Бұлтты есептеулер → Дискілер** бөліміне өтіңіз.
...
1. Дискіні ауыстыру терезесін ашу үшін тәсілдердің бірін қолданыңыз.
    ...
    - Дискінің контекстік мәзірі арқылы:
        ...
        1. **Root-дискіні ауыстыру** тармағын таңдаңыз.

    - Диск бетінде:

        1. Ауыстыру қажет диск атауын басыңыз.
        1. Диск бетінде **Жалпы ақпарат** қойындысына өтіңіз.
        1. Дисктер тізімінің үстіндегі **Тағы** батырмасын басып, **Root-дискіні ауыстыру** таңдаңыз.

1. Ашылған терезеде **Жаңа root-диск** таңдаңыз және **Ауыстыру** батырмасын басыңыз.
