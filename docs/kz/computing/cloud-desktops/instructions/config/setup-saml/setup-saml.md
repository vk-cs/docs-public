# {heading(Екі факторлы аутентификацияны баптау)[id=desktops-setup-saml]}
...
- [SAML](https://en.wikipedia.org/wiki/Security_Assertion_Markup_Language) сервисінің көмегімен екі факторлы аутентификация (тек Windows ОС басқаруындағы жұмыс үстелі пулдары үшін қолжетімді).
...
1. Cloud Desktop сервисімен интеграциялау үшін SAML идентификация провайдерін дайындаңыз. Баптау тәртібі таңдалған SAML-провайдерге байланысты.
   ...
   {note:info}
   SAML идентификация провайдерін баптау мысалы <!---{linkto(../../../../../computing/cloud-desktops/how-to-guides/keycloak)[text=Keycloak-пен интеграция]}--> бөлімінде келтірілген.
   {/note}
