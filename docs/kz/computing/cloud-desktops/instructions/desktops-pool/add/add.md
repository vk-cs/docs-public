...
1. Пулдың жұмыс үстелдері жасалатын виртуалды машиналардың баптауларын орнатыңыз:
   ...
   - **Образ**: қолжетімді образдар тізімінен ВМ жасауға арналған образды таңдаңыз.
     ...
     Қажет болса, **Жеке образыңызды жүктеу** батырмасын басып, бұрын дайындалған образды {linkto(../../../../../computing/iaas/instructions/images/images-manage#import_obraza)[text=импорттау жөніндегі нұсқаулыққа]} сәйкес жүктеңіз.
