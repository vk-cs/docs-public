...
Бағалар [прайс-парақта](https://cloud.vk.kz/pricelist) келтірілген. Платформа сервистерінің төлемі туралы толығырақ {linkto(../../../intro/billing#billing)[text=Биллинг]} бөлімінде оқыңыз.
