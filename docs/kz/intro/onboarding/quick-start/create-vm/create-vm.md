...
Дайын образдардың толық тізімі жеке кабинеттегі [жаңа виртуалды машинаны жасау терезесінде](https://kz.cloud.vk.kz/app/services/infra/servers/add) қолжетімді.
...
Образды файлдан жеке кабинеттегі [жаңа образды жасау терезесі](https://kz.cloud.vk.kz/app/services/infra/images) арқылы немесе CLI көмегімен {linkto(../../../../computing/iaas/instructions/images/images-manage#iaas-images-manage-import)[text=импорттай]} аласыз.
...
Егер ұсынылатын тәсілдер жұмыс істемесе немесе ВМ-нің сыртқы IP-мекенжайы болмаса, {linkto(../../../../computing/iaas/instructions/vm/vm-console#vm-console-vnc)[text=VNC консолін]} пайдаланыңыз.
