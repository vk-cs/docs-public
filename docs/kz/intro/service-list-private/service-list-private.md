...
- **Platform as a Service (PaaS)**. Kubernetes кластерлерін, масштабталатын СУБД және виртуалды жұмыс орындарын басқаруға арналған шешімдерді қамтиды.
  ...
  {cut(PaaS-сервистерінің тізімі)}
    ...
    - {linkto(../../kubernetes/mk8s#mk8s-k8s)[text=Managed Containers]} — Kubernetes кластерлерін жасауға және басқаруға мүмкіндік береді, олардың ішінде сервистер мен қолданбаларды іске қосуға болады.
