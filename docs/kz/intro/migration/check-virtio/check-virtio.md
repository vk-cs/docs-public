# {heading(VirtIO драйверлерін тексеру және орнату)[id=migration-check-virtio]}

{include(/kz/_includes/_translated_by_ai.md)}

Виртуалды машинаны {var(cloud)} ішіне көшіру үшін оның ОЖ-сында VirtIO драйверлері орнатылған болуы керек. Linux-тектес ОЖ-лардың заманауи дистрибутивтерінің көпшілігінде VirtIO драйверлері әдепкі бойынша бар. Олар бөлек модульдер (`.ko` кеңейтімімен) түрінде құрастырылуы немесе ОЖ ядросының құрамына кіруі мүмкін.
