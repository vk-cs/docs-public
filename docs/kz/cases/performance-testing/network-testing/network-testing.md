...
Желілік интерфейстердің өнімділік көрсеткіштері өзара әрекеттесетін ВМ орналасқан [аймаққа](/kz/start/concepts/architecture#architecture-az) байланысты. Сондықтан желілік өзара әрекеттесу параметрлерін алдымен бір аймақтың ішіндегі ВМ арасында, содан кейін әртүрлі аймақтардағы ВМ арасында салыстыру қажет.
...
1. Бір аймақтың ішінде өзара әрекеттесуді тестілеңіз. Ол үшін тестілік ВМ-де `iperf3_single` скриптін іске қосып,
    ...
    * `<ИМЯ_ФАЙЛА_С_РЕЗУЛЬТАТОМ>` — тестілеу нәтижесін сақтауға арналған файл атауы, мысалы,
    ...
    * `<IP_ТЕСТОВОЙ_ВМ>` — скрипт іске қосылатын тестілік ВМ-нің IP-мекенжайы.
    * `<IP_СЕРВЕРНОЙ_ВМ>` — сервер рөлін атқаратын қосымша ВМ-нің (сол аймақтағы) IP-мекенжайы.
...
3. Әртүрлі аймақтар арасындағы өзара әрекеттесуді тестілеңіз. Ол үшін тестілік ВМ-де `iperf3_single` скриптін іске қосып,
    ...
    * `<ИМЯ_ФАЙЛА_С_РЕЗУЛЬТАТОМ>` — тестілеу нәтижесін сақтауға арналған файл атауы, мысалы,
      ...
      скрипт іске қосылған директорияда сақталады.
    * `<IP_СЕРВЕРНОЙ_ВМ>` — сервер рөлін атқаратын қосымша ВМ-нің (басқа аймақтағы) IP-мекенжайы.
...
1. [Жойыңыз](/kz/computing/iaas/instructions/vm/vm-manage#iaas-vm-manage-delete) тестілік және қосымша ВМ-дерді.
1. ВМ орналастырылған [ішкі желілерді](/kz/networks/vnet/instructions/net#vnet-net-subnet-delete)
   және [желілерді](/kz/networks/vnet/instructions/net#vnet-net-delete) жойыңыз.
