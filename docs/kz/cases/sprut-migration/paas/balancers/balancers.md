...
1. [Жаңа теңгергіш жасаңыз](/kz/networks/balancing/instructions/manage-lb#zhukteme_tengergishin_kosu) және параметрлерді көрсетіңіз:
...
1. [Теңгерімдеу ережелерін жасаңыз](/kz/networks/balancing/instructions/manage-rules#add_balancer_rule) және олардың параметрлерін SDN Neutron-тағы бастапқы теңгергіштен көшіріңіз.
1. [Бастапқы жүктеме теңгергішін жойыңыз](/kz/networks/balancing/instructions/manage-lb#zhukteme_tengergishin_zhoyu), егер ол енді қажет болмаса.

Сондай-ақ теңгергіштерді келесі тәсілдермен көшіруге болады:

* Манифест сипаттамасында SDN Sprut-ты көрсетіп, Terraform көмегімен теңгергішті [қайта жасаңыз](/kz/tools-for-using-services/terraform/how-to-guides/vnet/lb#zhukteme_tengergishin_zhasau), ал виртуалды машиналарды олардың көші-қонынан кейін қосыңыз.
