...
Active Directory VK Cloud жүйесімен автоматты түрде синхрондалмайды. Пайдаланушы Active Directory-де бұғатталғаннан кейін оны VK Cloud жеке кабинетінде жобалардан [жойыңыз](/kz/tools-for-using-services/account/instructions/project-settings/access-manage).
