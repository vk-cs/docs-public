...
Әрі қарай VK Cloud жүйесіне кіру үшін куәліктер федерациясын [Keycloak](https://www.keycloak.org) куәландыру жеткізушісі ретінде пайдаланып баптау көрсетіледі.
...
1. Пайдаланушының аутентификация деректерін енгізіңіз. Сәтті авторизациядан кейін VK Cloud жеке кабинетінің басты бетіне қайта бағытталасыз.
