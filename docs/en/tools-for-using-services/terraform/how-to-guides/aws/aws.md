...
The example below will add an [automatic deletion rule](/ru/storage/s3/instructions/buckets/manage-lifecycle "change-lang") (lifecycle) for objects with the `tmp` prefix from the bucket after one day.
