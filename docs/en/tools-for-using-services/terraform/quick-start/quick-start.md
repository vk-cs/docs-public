...
1. Enable [two-factor authentication](/en/access/iam/instructions/manage-2fa#enabling_2fa) and [API access](/en/tools-for-using-services/api/rest-api/enable-api#activate_api_access), if not enabled yet.
