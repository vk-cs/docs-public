...
| Endpoint                  | Address                               | Purpose                                  |
|---------------------------|---------------------------------------|------------------------------------------|
| S3 domain                 | https://hb.ru-msk.vkcloud-storage.ru/ | Managing [VK Object Storage](/en/storage/s3) |
...
The Project ID does not match the [project ID](/en/tools-for-using-services/account/instructions/project-settings/manage#getting_project_id) in the VK Cloud management console. This is another identifier that is used in configuration files:
