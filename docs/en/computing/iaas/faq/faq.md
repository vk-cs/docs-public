...
[Disconnect the disk](../instructions/volumes#disconnecting_disk_from_vm) from the VM, and the button will become available in the disk's context menu and the disk page.
