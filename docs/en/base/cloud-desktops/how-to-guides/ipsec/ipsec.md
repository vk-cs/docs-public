...
1. In [your personal account](https://mcs.mail.ru/app/) go to the **Cloud computing** section → **Virtual machines**.
...
1. In [your personal account](https://mcs.mail.ru/app/) go to the **Virtual networks** section → **Routers**.
