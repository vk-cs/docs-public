...
9.3. This Agreement is made in Russian and English languages. The Russian version is available at: [https://mcs.mail.ru/docs/intro/start/legal/contributor](/ru/intro/start/legal/contributor "change-lang"). The English version is available at: [https://mcs.mail.ru/docs/en/intro/start/legal/contributor](/en/intro/start/legal/contributor). In the event of any discrepancy between the provisions of the Russian and English versions hereof, the Russian version shall prevail.
