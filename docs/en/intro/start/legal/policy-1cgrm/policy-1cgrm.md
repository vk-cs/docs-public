...
**Applicable rules** — this Agreement, available on the Internet at: [https://mcs.mail.ru/help/legal/1cgrm-termofuse](/en/intro/start/legal/policy-1cgrm), containing the conditions for access and use of the Service, as well as the following documents, to the extent necessary for use Service:

1. Terms of use of the VK Cloud Platform ([https://help.mail.ru/mcs/legal/termofuse](/en/intro/start/legal/legal-terms));
2. Contractor's privacy policy ([https://help.mail.ru/mcs/legal/privacy/](/en/intro/start/legal/policy-privacy)).
