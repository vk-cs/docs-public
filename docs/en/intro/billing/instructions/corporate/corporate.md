...
## {heading(Conclusion of an individual contract)[id=individual_contract]}
...
If you conclude an individual contract, your company details provided during the contract registration will be displayed in your VK Cloud management console. These details are entered by a VK Cloud manager and cannot be [modified](#edit_company) via management console.

## {heading(Additional registration of legal entities and sole proprietors)[id=additional_registration_of_legal_entities]}

After [registration](/en/intro/start/account-registration) in VK Cloud, you can go to the project settings and complete the additional registration of the legal entity or the sole proprietor, specifying your details. If you have completed the additional registration for one of your projects, the other projects linked to your account will inherit the registration.
...
If the organization works with VK Cloud on [prepayment](../../concepts/physical-corporate#predoplata), after additional registration, you will be able to [generate and download](../bill-generation) advance invoices from your management console.
...
1. Go to project settings in one of the ways:
    ...
    - Click the user name in the header of the management console page and select **Project settings**.
      - Go to [making a payment](/en/intro/billing/instructions/payment#making_a_payment) and click the **Add information** button.
1. Click the **Add** button.
1. In the window that opens, enter the TIN of the organization in the field of the same name.
...
## {heading(Edit company details)[id=edit_company]}
...
1. Go to project settings in one of the ways:
    ...
    - Click the **Fill in** button in the **Fill in the company details** card on the main page.
    - Click the user name in the header of the management console page and select **Project settings**.
    - Go to [making a payment](/en/intro/billing/instructions/payment#making_a_payment) and click the !["pencil-icon"](/en/assets/pencil-icon.svg "inline") icon.
1. Click the **Edit** button.
1. Edit general information, then click **Next step**.

    {note:info}
    When editing your TIN, enter new data in the field without deleting the old one.
    {/note}

1. Edit legal address.
1. Click the **Save** button.
