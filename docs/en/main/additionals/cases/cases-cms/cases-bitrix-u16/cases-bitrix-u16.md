...
- You can install the LAMP stack yourself. To learn how to install a LAMP stack on Ubuntu 16.04, see the article [Installing a LAMP stack on an Ubuntu operating system](/en/additionals/cases/cases-lamp/lamp-deb9).
