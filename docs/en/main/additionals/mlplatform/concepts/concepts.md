The MLOps Platform from VK Cloud is a set of services and tools designed to solve typical tasks of Data Science and ML teams.
...
To solve MLOps tasks, VK Cloud provides the following services:
