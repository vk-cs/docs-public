...
**Applicable rules** — the rules for using the Contractor's Service, available on the Internet at: [https://mcs.mail.ru/docs/en/additionals/start/legal/cloud-servers](/en/additionals/start/legal/cloud-servers), containing the conditions for access and use of the Service and set out in the following documents:
