...
1. Select the `Moscow` [region](/en/base/account/concepts/regions).
1. Go to **Databases → Database instances**.
1. If there are no instances in the selected region, click the **Create database** button.
...
1. Go to [VK Cloud personal account](https://mcs.mail.ru/app/en/).
1. Select the project and region where the DB instance is located.
1. Go to **Databases → Database instances**.
