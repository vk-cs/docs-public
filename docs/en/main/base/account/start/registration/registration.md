...
After registration, new customers receive welcome bonuses to their bonus account so that you can test the service for 60 days. Read more about bonus points [here](/docs/ru/additionals/billing/concepts/bonus). After testing, you need to replenish the balance of the main account.
