...
You can learn more about working with Terraform in the VK Cloud infrastructure [on the Terraform documentation portal](https://mcs.mail.ru/docs/ru/manage/terraform).
