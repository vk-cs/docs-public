...
1. [Create a Hotbox bucket](../../../s3/manage-s3/bucket#bucket-creation) to store backups in the [Object Storage](../../../s3) service.
1. [Create an account](../../../s3/s3-start/s3-account#create-an-account) in the [Object Storage](../../../s3) service.
