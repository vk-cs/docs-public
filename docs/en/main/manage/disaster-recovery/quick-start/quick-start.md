...
1. Deploy the Cloud Disaster Recovery service:

   1. Go to **App store**.
   1. On the **Cloud Disaster Recovery** card, click **Details**.
   1. Check out the supported platforms. Make sure that there are enough quotas in the project.
   1. Click the **Install**.
   ...
   Service management (status, tariff setting, access update) is available in the section **App store** → **My SaaS applications**.
