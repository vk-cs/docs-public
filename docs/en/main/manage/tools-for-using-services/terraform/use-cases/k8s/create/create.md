...
The `labels = { docker_registry_enabled }` setting of the `vkcs_kubernetes_cluster` resource is used to install the [service](/en/base/k8s/concepts/preconfigured-features/addons).
