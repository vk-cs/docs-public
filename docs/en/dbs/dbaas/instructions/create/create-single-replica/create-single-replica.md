...
1. On the **Configuration** step:
   ...
   1. Select the configuration **Single** or **Master-Replica**. The configuration is available for some [DBMS types](../../../concepts/work-configs#available-configs).
...
1. On the **Create instance** step:
   ...
   1. Set general instance parameters:
      ...
      - **Availability zone**: [availability zone](/en/intro/start/concepts/architecture#architecture-az) for the DB instance.
