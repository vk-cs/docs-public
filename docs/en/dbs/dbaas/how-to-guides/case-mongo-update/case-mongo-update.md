...
7. Sign in to the `mongo2` server, import the MongoDB repository key, add the MongoDB repository and install MongoDB (how to do this, see the article [Installing and configuring MongoDB on Ubuntu](/en/dbs/dbaas/instructions/create/create-single-replica)).
