...
1. If necessary, [delete floating IP address](/en/networks/vnet/instructions/ip/floating-ip#removing_floating_ip_address_from_the_project), that was assigned to the DB instance. Floating IP addresses, that exist in the project, [are charged](/en/networks/vnet/tariffication).
