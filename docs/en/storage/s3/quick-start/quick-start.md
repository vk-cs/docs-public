...
1. Предоставьте доступ к загруженному объекту по временной [подписанной ссылке](../instructions/objects/signed-url):
...
1. Если бакет вам больше не нужен, [удалите его](../instructions/buckets/bucket#removing_a_bucket).
