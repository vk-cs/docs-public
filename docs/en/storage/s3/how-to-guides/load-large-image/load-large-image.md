...
1. Create an [account](/en/storage/s3/instructions/account-management) and a [bucket](/en/storage/s3/instructions/buckets/create-bucket) with the `uc_bucket` name.
