Composite or multipart loading allows you to save objects in Object Storage in parts. This can be useful when loading or copying large objects. We recommend using multiple uploads for objects from 100 MB.
