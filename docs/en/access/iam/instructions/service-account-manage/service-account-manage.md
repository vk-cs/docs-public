...
1. Make sure your [project role](/en/access/iam/concepts/rolesandpermissions) has the [permissions to manage service accounts](/en/access/iam/concepts//service-accounts). Creating service accounts is available for the following roles:
...
1. [Go to](https://msk.cloud.vk.com/app/en) your VK Cloud management console.
1. Make sure your [project role](/en/access/iam/concepts/rolesandpermissions#general_project_management_roles) has the [permissions to manage service accounts](/en/access/iam/concepts//service-accounts).
1. Go to **Manage access**, then go to the **Service users** tab.
...
1. [Go to](https://msk.cloud.vk.com/app/en) your VK Cloud management console.
1. Make sure your [project role](/en/access/iam/concepts/rolesandpermissions#general_project_management_roles) has the [permissions to manage service accounts](/en/access/iam/concepts//service-accounts). Deleteng service users is available for the following roles:
