...
- [create](/en/access/iam/instructions/service-account-manage#create) a service account
- [view](/en/access/iam/instructions/service-account-manage#view_list) the list of the project service accounts
- [view](/en/access/iam/instructions/service-account-manage#view_card) a service account details
- [download](/en/access/iam/instructions/service-account-manage#download_rc_file) an OpenStack RC file to their device, which is required to use the API
- [configure](/en/access/iam/instructions/service-account-manage#authorize) the environment for accessing the API on behalf of a service account
- [delete](/en/access/iam/instructions/service-account-manage#delete) a service account
