...
1. Make sure that:
   ...
   1. You can [authorize](/en/tools-for-using-services/cli/openstack-cli#openstack-authorize) in the OpenStack CLI.
...
## {heading(Removing the Router)[id=vnet-router-delete]}
