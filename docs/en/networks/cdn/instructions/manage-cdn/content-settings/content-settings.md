...
Use the `POST /projects/{project_id}/resources/{resources_id}/purge` [method](/en/tools-for-using-services/api/api-spec/api-cdn).
...
Use the `POST /projects/{project_id}/resources/{resources_id}/prefetch` [method](/en/tools-for-using-services/api/api-spec/api-cdn).
