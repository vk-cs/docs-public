...
1. After the configured grace period has expired, it marks this node with a [taint](/en/kubernetes/mk8s/reference/labels-and-taints) that prohibits placing new pods and workloads on it and triggers its removal.
