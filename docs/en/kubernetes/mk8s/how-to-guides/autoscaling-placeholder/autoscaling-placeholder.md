...
1. [Install and configure](/en/kubernetes/mk8s/connect/kubectl) `kubectl`, if you have not done it already.
1. [Connect](/en/kubernetes/mk8s/connect/kubectl#check_connection) to the cluster using `kubectl`.
