...
1. [Stop](/en/kubernetes/mk8s/instructions/manage-cluster#stop) your cluster and wait for all nodes to completely shut down.

1. [Start](/en/kubernetes/mk8s/instructions/manage-cluster) the cluster again and wait for all nodes to initialize.
