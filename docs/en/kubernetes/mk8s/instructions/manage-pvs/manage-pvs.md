In the Managed Containers service, you can move [persistent volumes (PVs)](/en/kubernetes/mk8s/reference/pvs-and-pvcs) created for Kubernetes clusters between projects or delete them.
...
{note:warn}
Once you move a PV to your project, you cannot move it back to the [service](/en/kubernetes/mk8s/concepts/cluster-generations#service-projects) one.
{/note}
