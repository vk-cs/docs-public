...
1. Install the add-on:
   ...
   {tab(Management console)}
    ...
    1. Click the **Install** button on the `argocd` add-on card, then click **Install addon**.
    1. (Optional) Edit:
...
You can find the full add-on settings code along with the description of the fields on [GitHub](https://github.com/argoproj/argo-helm/blob/main/charts/argo-cd/values.yaml).
