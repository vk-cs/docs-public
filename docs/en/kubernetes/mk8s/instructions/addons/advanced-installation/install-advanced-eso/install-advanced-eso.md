...
[Several installation options](/en/kubernetes/mk8s/concepts/addons-and-settings/addons#features_of_installing_addons) are available for the [External Secrets Operator](/en/kubernetes/mk8s/concepts/addons-and-settings/addons#eso) add-on.
...
1. Install the add-on:
   ...
   {tab(Management console)}
    ...
    1. Click the **Install** button on the `external-secrets-operator` add-on card, then click **Install addon**.
    1. (Optional) Edit:
...
1. (Optional) Review the [Using External Secrets Operator](/en/kubernetes/mk8s/how-to-guides/external-secrets-operator) section for the details on working with the add-on.
...
You can find the full add-on settings code along with the description of the fields on [GitHub](https://github.com/external-secrets/external-secrets/blob/v2.5.0/deploy/charts/external-secrets/values.yaml).
