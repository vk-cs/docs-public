...
1. [Create](/en/kubernetes/k8s/instructions/create-cluster) a Kubernetes cluster to connect to, or select the cluster from the list in your [management console](https://msk.cloud.vk.com/app/) in the **Kubernetes Clusters → Kubernetes Clusters** section.
...
1. Install the `client-keystone-auth` plugin to connect to the cluster using [Single Sign-On (SSO)](/en/kubernetes/k8s/concepts/access-management):
