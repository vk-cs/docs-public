...
1. [Install](/en/kubernetes/k8s/instructions/addons/advanced-installation/install-advanced-monitoring) the `kube-prometheus-stack` add-on.

## {heading(Installing add-on)[id=installing_addon]}

[Several installation options](/en/kubernetes/k8s/concepts/addons-and-settings/addons#features_of_installing_addons) are available for [Istio](/en/kubernetes/k8s/concepts/addons-and-settings/addons#istio).
...
1. If necessary, [install](/en/kubernetes/k8s/instructions/addons/advanced-installation/install-advanced-kiali) the `kiali` add-on in addition.
