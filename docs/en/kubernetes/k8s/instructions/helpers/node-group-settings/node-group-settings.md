These settings are set when [creating a cluster](../../create-cluster/create-webui-gen-2) or when [adding a worker node group](../../manage-node-group#add_group) to an existing cluster:
