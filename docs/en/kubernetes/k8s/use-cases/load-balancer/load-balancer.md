...
1. [Create Linux virtual machine](/en/base/iaas/instructions/vm/vm-create/) in the same subnet where the balancer IP address resides.

1. [Connect to this virtual machine](/en/base/iaas/instructions/vm/vm-connect/vm-connect-nix/) via SSH.
