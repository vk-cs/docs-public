When the cluster runs out of resources, the [autoscaler](/en/kubernetes/mk8s/concepts/cluster-autoscaler) creates a new node and adds it to the cluster. This takes 4–7 minutes, during which time your application may be overloaded with traffic.
