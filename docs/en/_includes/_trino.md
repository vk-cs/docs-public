...
1. Select the source:
   ...
   - `Apache Iceberg with S3 VK Cloud` — connection to VK Object Storage in the same project.
...
1. Configure the connection parameters to the source:
   ...
   - **Name**: name of the connection.
   - **S3_bucket**: name of the VK Object Storage buckets to which Trino will connect.
   - **S3_folder**: the name of the directory in the VK Object Storage buckets to which Trino will connect.
