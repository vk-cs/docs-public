...
By using the Hystax Acura Disaster Recovery service, you agree to the license agreements of [Marketplace](/ru/start/legal/offer/private-special-conditions/policy-marketplace "change-lang") and [Hystax Acura Disaster Recovery](https://хст.рф/terms-of-use).
...
- [Delete](/en/networks/vnet/instructions/ip/floating-ip#vnet-floating-ip-delete) floating IP address if it was created during recovery.
