...
By using Alfresco, you agree to the [Marketplace](/ru/start/legal/offer/private-special-conditions/policy-marketplace "change-lang") and [Alfresco](https://github.com/Alfresco/acs-deployment/blob/master/LICENSE) license agreements.
