...
1. At the “Parameters” step:
   ...
   1. Set the node parameters for the broker:
      ...
      - **Type of virtual machine:** [flavor](/en/base/iaas/concepts/vm-concept#flavors) for the node.
      - **Disk Type:** [disk type](/en/base/iaas/concepts/vm-concept#disks_types_b7c586e) for the node.
...
1. At the “Parameters” step:
   ...
   1. Configure the cluster node settings by selecting one of the options:
      ...
      Select one of the ready-made cluster templates. [Flavor](/en/base/iaas/concepts/vm-concept#flavors) and [disk type](/en/base/iaas/concepts/vm-concept#disks_types_b7c586e) the cluster nodes have already been selected.
