...
Источниками логов выступают [службы kubelet](https://kubernetes.io/docs/concepts/overview/components/#kubelet) и {linkto(../../../reference/pods#k8s-pods)[text=поды]} (pods), расположенные на узлах кластера. Подробнее о том, как работает аддон, читайте в разделах про его {linkto(../../../instructions/addons/advanced-installation/install-advanced-logaas-integration#k8s-install-advanced-logaas-integration)[text=установку для кластеров первого]} и {linkto(../../../instructions/addons/advanced-installation/install-gen-2-advanced-logaas-integration#k8s-install-gen-2-advanced-logaas-integration)[text=кластеров второго]} поколений.
