...
Вы можете использовать шаблон конфигурации с GPU только для worker-узлов кластера. Шаблон конфигурации с GPU должен находиться в той же [зоне доступности](/ru/start/concepts/architecture#az), что и узел, который его использует.
