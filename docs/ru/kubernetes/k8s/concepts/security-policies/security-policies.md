...
Чтобы снизить эти риски, в сервисе Managed Containers кроме поддержки {linkto(../access-management#k8s-access-management)[text=разграничения прав доступа]} к кластеру реализованы политики безопасности.
