...
Не все аддоны можно обновить с помощью интерфейсов VK Cloud. Аддон [Kube Prometheus Stack](../../../concepts/addons-and-settings/addons) можно [обновить](../../../use-cases/update-monitoring-addon) только вручную.
