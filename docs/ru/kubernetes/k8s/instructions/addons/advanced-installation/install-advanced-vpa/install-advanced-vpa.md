...
## {heading(Установка аддона)[id=k8s-install-advanced-vpa-install]}
...
1. Установите аддон:
   ...
   {tab(Личный кабинет)}
    ...
    1. Нажмите кнопку **Установить** на карточке аддона `vpa` и нажмите кнопку **Установить аддон**.
    1. (Опционально) Отредактируйте:

        - выбранную версию;
        - название приложения;
        - название пространства имен, куда будет установлен аддон;
        - {linkto(#k8s-install-advanced-vpa-edit-code)[text=код настройки аддона]}.
...
## {heading(Редактирование кода настройки аддона при установке)[id=k8s-install-advanced-vpa-edit-code]}
...
После редактирования кода {linkto(#k8s-install-advanced-vpa-install)[text=продолжите установку аддона]}.