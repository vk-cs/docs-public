Далее описывается создание кластера Kubernetes [второго поколения](/ru/kubernetes/k8s/concepts/cluster-generations) из личного кабинета. Для кластеров второго поколения включена интеграция с сервисом [мониторинга VK Cloud](/ru/monitoring-services/monitoring), отключить ее нельзя.
...
1. Нажмите кнопку **Настроить** в блоке **Сеть и настройки** и задайте настройки сети:
   ...
   - **CNI**: выберите [сетевую подсистему](/ru/kubernetes/k8s/concepts/network#supported-cni) (CNI). 
