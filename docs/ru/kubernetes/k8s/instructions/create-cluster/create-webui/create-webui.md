Далее описывается создание кластера Kubernetes [первого поколения](/ru/kubernetes/k8s/concepts/cluster-generations) из личного кабинета. Рекомендуется [создавать](/ru/kubernetes/k8s/instructions/create-cluster/create-webui-gen-2) кластеры второго поколения: они отличаются улучшенной производительностью и стабильностью.
