Если кластер использует не самую актуальную версию Kubernetes из [поддерживаемых](../../concepts/versions/version-support), то его можно обновить. При этом будет также [обновлена](../../concepts/update) часть его компонентов.
...
1. Выполните резервное копирование кластера, который планируете обновить, например, [с помощью Velero](../../how-to-guides/velero/velero-backup).
