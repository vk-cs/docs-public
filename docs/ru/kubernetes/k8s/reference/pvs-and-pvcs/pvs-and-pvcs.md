...
В Cloud Containers доступ к PVC в режиме RWX не реализован. Чтобы организовать общий доступ к данным из нескольких подов на разных узлах, разверните [NFS-сервер](/ru/computing/iaas/service-management/fs-manage) на отдельной виртуальной машине.
