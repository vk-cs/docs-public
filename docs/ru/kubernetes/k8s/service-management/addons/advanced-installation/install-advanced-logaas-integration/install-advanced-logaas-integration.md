...
1. (Опционально) [Просмотрите логи](/ru/monitoring-services/logging/service-management/view-logs) в сервисе Cloud Logging, чтобы убедиться в работоспособности аддона.
