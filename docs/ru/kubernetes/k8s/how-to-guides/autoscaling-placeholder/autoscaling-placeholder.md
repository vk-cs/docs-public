# {heading(Резервирование узлов в группе)[id=k8s-autoscaling-placeholder]}
...
## {heading(1. Настройте добавление пустого пода в кластер)[id=k8s-autoscaling-placeholder-set]}
...
## {heading(2. Проверьте применение настроек)[id=k8s-autoscaling-placeholder-check]}
...
## {heading(Удалите неиспользуемые ресурсы)[id=k8s-autoscaling-placeholder-delete]}
