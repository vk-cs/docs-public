# {heading(Управление ресурсами кластера в личном кабинете)[id=mk8s-manage-resources]}

Вы можете управлять ресурсами кластера Kubernetes в сервисе Managed Containers через веб-интерфейс личного кабинета {var(cloud)}. Эта функциональность выступает альтернативой для выполнения тех же действий через `kubectl`.
 Примеры команд для создания, изменения и удаления ресурса через `kubectl` доступны в личном кабинете.

<!-- добавить что альтернатива для Headlamp тоже, если это так--> 

## {heading(Просмотр информации о ресурсах)[id=mk8s-manage-resources-view-resources]}
...
## {heading(Создание ресурса)[id=mk8s-manage-resources-create-resources]}
...
## {heading(Скачивание манифеста ресурса)[id=mk8s-manage-resources-download-yaml]}
...
## {heading(Редактирование информации о ресурсе)[id=mk8s-manage-resources-edit-resources]}
...
## {heading(Удаление ресурса)[id=mk8s-manage-resources-delete-resources]}
