...
Вы можете управлять ресурсами кластера Kubernetes в сервисе Managed Containers через веб-интерфейс личного кабинета {var(cloud)}. Эта функциональность выступает альтернативой для выполнения тех же действий через {linkto(../../connect/kubectl#mk8s-kubectl)[text=kubectl]} и {linkto(../../connect/headlamp#mk8s-headlamp)[text=Headlamp]}. 
