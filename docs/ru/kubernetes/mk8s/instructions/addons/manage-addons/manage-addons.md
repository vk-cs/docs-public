...
{linkto(../../../concepts/addons-and-settings/addons#mk8s-addons)[text=Аддоны]} для кластеров Kubernetes сервиса Cloud Containers можно установить и при {linkto(../../create-cluster/create-terraform#mk8s-create-terraform)[text=создании кластера с помощью Terraform]}, и в уже существующий кластер. Установленные аддоны можно просматривать и удалять.
