# {heading(Velero)[id=mk8s-install-advanced-velero]}

## {heading(Подготовительные шаги)[id=mk8s-install-advanced-velero-prep]}
...
## {heading(Установка аддона)[id=mk8s-install-advanced-velero-install]}

Для аддона {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-velero)[text=Velero]} доступно {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-install-features)[text=несколько вариантов установки]}.
...
1. Установите аддон:
   ...
   {tab(Личный кабинет)}
    ...
    1. Нажмите кнопку **Установить** на карточке аддона `velero` и нажмите кнопку **Установить аддон**.
...
## {heading(Редактирование кода настройки аддона при установке)[id=mk8s-install-advanced-velero-edit-code]}
