...
## {heading(Подготовительные шаги)[id=mk8s-install-advanced-istio-mk8s-prepare]}

{include(/ru/_includes/_addon-prep.md)}

## {heading(Установка аддона)[id=mk8s-install-advanced-istio-mk8s-install]}

Для аддона {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-istio)[text=Istio]} доступно {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-install-features)[text=несколько вариантов установки]}.
...
1. Установите аддон:
   ...
   1. Нажмите кнопку **Установить** на карточке аддона `istio` и нажмите кнопку **Установить аддон**.
   1. При необходимости отредактируйте {linkto(#mk8s-install-advanced-istio-mk8s-edit)[text=код настройки аддона]} (например, для изменения режима работы аддона).
...
## {heading(Редактирование кода настройки аддона при установке)[id=mk8s-install-advanced-istio-mk8s-edit]}
