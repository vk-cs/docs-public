...
## {heading(Подготовительные шаги)[id=mk8s-install-advanced-cert-manager-prep]}

{include(/ru/_includes/_addon-prep.md)}

## {heading(Установка аддона)[id=mk8s-install-advanced-cert-manager-install]}

Для аддона {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-cert-manager)[text=Cert-manager]} доступно {linkto(../../../../concepts/addons-and-settings/addons#mk8s-addons-install-features)[text=несколько вариантов установки]}.
...
1. Установите аддон:
   ...
   1. (Опционально) Отредактируйте:
      ...
      - {linkto(#mk8s-install-advanced-cert-manager-edit-code)[text=код настройки аддона]}.
...
## {heading(Редактирование кода настройки аддона при установке)[id=mk8s-install-advanced-cert-manager-edit-code]}
...
После редактирования кода {linkto(#mk8s-install-advanced-cert-manager-install)[text=продолжите установку аддона]}.