# {heading(Развертывание Ingress-контроллера с TCP-балансировщиком)[id=mk8s-ingress-tcp]}
...
## {heading(2. Разверните демоприложения)[id=mk8s-ingress-tcp-deploy-demo]}
...
## {heading(3. Установите Ingress-контроллер)[id=mk8s-ingress-tcp-install-ingress]}
...
## {heading(4. Создайте ресурс Ingress)[id=mk8s-ingress-tcp-create-ingress]}
...
## {heading(5. Проверьте доступность приложений)[id=mk8s-ingress-tcp-check]}
...
## {heading(Удалите неиспользуемые ресурсы)[id=mk8s-ingress-tcp-delete]}
