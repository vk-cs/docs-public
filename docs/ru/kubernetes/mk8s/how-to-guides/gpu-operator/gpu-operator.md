...
Cloud Containers позволяет создавать {linkto(../../concepts/flavors#mk8s-flavors-gpu)[text=кластеры с GPU (графическими процессорами)]} для выполнения машинного обучения или обработки больших данных.
