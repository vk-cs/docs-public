# {heading(Настройка приоритетов масштабирования групп узлов)[id=mk8s-hpa]}
...
1. Просмотрите {linkto(../../reference/labels-and-taints#mk8s-labels-and-taints)[text=метки]} узлов и найдите метку, в которой VK Cloud хранит имя группы:
...
4. {linkto(../autoscaler-logs#mk8s-autoscaler-logs)[text=Проверьте логи Cluster Autoscaler]} и изменение размера групп в личном кабинете VK Cloud.
