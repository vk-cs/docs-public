# {heading(Резервирование узлов в группе)[id=mk8s-autoscaling-placeholder]}
...
## {heading(Подготовительные шаги)[id=mk8s-autoscaling-placeholder-prepare]}
...
## {heading(1. Настройте добавление пустого пода в кластер)[id=mk8s-autoscaling-placeholder-set]}
...
## {heading(2. Проверьте применение настроек)[id=mk8s-autoscaling-placeholder-check]}
...
## {heading(Удалите неиспользуемые ресурсы)[id=mk8s-autoscaling-placeholder-delete]}
