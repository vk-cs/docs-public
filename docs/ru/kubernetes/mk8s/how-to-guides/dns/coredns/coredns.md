# {heading(Добавление статических DNS-записей)[id=mk8s-coredns]}
...
## {heading(Подготовительные шаги)[id=mk8s-coredns-prepare]}
...
## {heading(1. Добавьте адрес хоста в ConfigMap ресурса CoreDNS)[id=mk8s-coredns-add-address]}
...
## {heading(2. Проверьте применение конфигурации)[id=mk8s-coredns-config-check]}
...
## {heading(Удалите неиспользуемые ресурсы)[id=mk8s-coredns-delete]}
