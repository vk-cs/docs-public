## {counter(vm_win)}. Проверьте возможность подключения по RDP
...
1. Если пароль был утрачен, [сбросьте](../../vm-manage#ustanovka_i_izmenenie_parolya) или [восстановите](../../vm-manage#vosstanovlenie_parolya) его.
