...
Чтобы усилить безопасность [аккаунта](/ru/tools-for-using-services/vk-cloud-account), включите двухфакторную аутентификацию (2FA). После этого при каждом входе в аккаунт VK Cloud нужно будет вводить одноразовый шестизначный код из приложения для генерации одноразовых кодов.
{/includetag}
...
1. В блоке **Двухфакторная аутентификация** нажмите на значок ![pencil-icon](../../../../assets/pencil-icon.svg "inline"). Откроется страница с QR-кодом.
