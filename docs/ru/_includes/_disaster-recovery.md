...
1. На шаге **Select target environment** выберите опцию **New OpenStack** и укажите параметры:
   ...
   - **Cloud name**: `VK Cloud`.
   - **Keystone API endpoint**: значение Keystone из [списка эндпоинтов](https://msk.cloud.vk.ru/app/mcs3723876490/project/endpoints), для VK Cloud — `https://infra.mail.ru:5000/v3/`.
   - **User domain**: значение **User Domain Name** [настроек проекта](https://msk.cloud.vk.ru/app/project/keys).
