...
1. Задайте параметры ВМ в блоке **Конфигурация**:
   ...
   - **Категория виртуальной машины**: выберите {linkto(../../concepts/vm/flavor#iaas-flavor-vm-categories)[text=категорию]} предустановленных конфигураций ВМ.
     {/includetag}
     {includetag(create,create-from-disk)}
...
1. Заполните блок **Общая информация**:
   ...
   - **Теги**: при необходимости {linkto(../../../../../computing/iaas/instructions/vm/vm-manage#iaas-vm-manage-tags)[text=укажите тег]} для ВМ или создайте новый.
     {/includetag}
     {includetag(create-from-disk)}
   - **Теги**: при необходимости {linkto(../../instructions/vm/vm-manage#iaas-vm-manage-tags)[text=укажите тег]} для ВМ или создайте новый.
     {/includetag}
     {includetag(create,create-from-disk)}
