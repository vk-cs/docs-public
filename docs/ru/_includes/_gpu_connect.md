...
1. [Перейдите](https://cloud.vk.ru/cloud-gpu) на сайт VK Cloud.
...
1. Заполните поля в форме заявки:
    ...
    - Прочитайте и примите условия [пользовательского соглашения](/ru/start/legal/archive/digital-cloud/potential-partners).
