...
Для пользователей, работающих по {ifdef(public)}{linkto(/ru/intro/billing/concepts/physical-corporate#billing-physical-corporate-prepay)[text=предоплате]}{/ifdef}{ifndef(public)}предоплате{/ifndef}, состояние лицевого счета и баланс всех бонусных счетов {ifdef(public)}{linkto(../../../../intro/billing/instructions/payment#billing-payment)[text=доступны]} в шапке [личного кабинета](https://msk.cloud.vk.ru/app/){/ifdef}{ifndef(public)}доступны в шапке личного кабинета{/ifndef}. Сумму средств на лицевом счете отражает **Лицевой баланс**, сумму бонусов по всем бонусным счетам отражает **Бонусный баланс**.
