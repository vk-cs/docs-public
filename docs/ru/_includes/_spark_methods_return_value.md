...
(необязательное)
|`str`
|Идентификатор кластера Kubernetes, привязанного к кластеру Cloud Spark. Можно найти в личном кабинете в разделе  **Кластеры Kubernetes → Кластеры Kubernetes**.
...
(необязательное)
|`str`
|Имя [бакета](/ru/storage/s3/concepts/about#s3-concepts-about-bucket), привязанного к кластеру Cloud Spark. Можно найти в личном кабинете в разделе  **Объектное хранилище → Бакеты**.
