...
1. Отключите мигрируемый PVC от пода перед тем, как подключать созданный, так как в Managed Containers запрещено подключение нескольких PVC к одному поду.  
