...
1. [Удалите](/ru/computing/iaas/instructions/vm/vm-manage#iaas-vm-manage-delete) тестовую ВМ.
1. Удалите [подсеть](/ru/networks/vnet/instructions/net#vnet-net-subnet-delete) и [сеть](/ru/networks/vnet/instructions/net#vnet-net-delete), в которой была размещена ВМ.
