...
- [Удалите](/ru/computing/iaas/instructions/vm/vm-manage#iaas-vm-manage-delete) ВМ `Ubuntu_22_04_OpenCart`.
- [Удалите](/ru/dbs/dbaas/instructions/manage-instance/mysql#dbaas-mysql-delete-instance) инстанс БД `MySQL-9341`.
- При необходимости [удалите](/ru/networks/vnet/instructions/ip/floating-ip#vnet-floating-ip-delete) Floating IP-адрес `87.239.106.48`.
- [Удалите](/ru/networks/dns/instructions/publicdns/records#dns-records-delete) созданную DNS-запись `site-opencart.example.vk.cloud`.
