При миграции сетевой инфраструктуры меняются Floating IP-адрес и IP-адрес балансировщика, поэтому после миграции балансировщика необходимо обновить A-записи публичного DNS:
