...
- Полностью мигрируйте проект на SDN Sprut, затем отключите в проекте SDN Neutron через обращение в {linkto(../../../intro/onboarding/contact_support#onboarding-contact-support)[text=техническую поддержку]}.
