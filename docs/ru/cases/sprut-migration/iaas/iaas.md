...
## 5. Скопируйте группы безопасности в SDN Sprut
...
## 6. Выполните проверку групп безопасности
...
## 7. (Опционально) Создайте плавающий IP-адрес в SDN Sprut
...
## 8. Переключите сетевые интерфейсы ВМ в SDN Sprut
...
## 9. Проверьте созданную конфигурацию
