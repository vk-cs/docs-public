...
1. [Подключитесь](/ru/base/iaas/service-management/vm/vm-connect/vm-connect-nix) к ВМ `Ubuntu_22_04_LAMP`.
...
- [Удалите](/ru/base/iaas/service-management/vm/vm-manage#udalenie_vm) ВМ `Ubuntu_22_04_LAMP`.
