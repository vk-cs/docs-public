# {heading(О сервисе)[id=adb-about]}

## {heading(Описание)[id=adb-about-description]}
...
## {heading(Ключевые преимущества Arenadata DB)[id=adb-about-advantages]}
