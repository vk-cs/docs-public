...
1. Выполните [резервное копирование](/ru/storage/backups/service-management/db-backup/manage-db-backups#sozdanie_rezervnoy_kopii) инстанса БД, который планируете обновить.
