...
1. На шаге **Параметры**:
   ...
   1. Задайте общие параметры кластера:
      ...
      - **Ключ для доступа по SSH:** выберите существующий ключ или создайте новый.
        ...
        Ключ используется для [подключения к хостам кластера по SSH](/ru/computing/iaas/service-management/vm/vm-connect/vm-connect-nix).
...
1. На шаге **Создание инстанса**:
   ...
   1. Задайте общие параметры кластера:
      ...
      - **Настройки Firewall:** список групп безопасности для кластера.
        ...
        Добавьте в список группу безопасности `ssh`, чтобы получить возможность [подключаться к хостам кластера по SSH](/ru/computing/iaas/service-management/vm/vm-connect/vm-connect-nix).
