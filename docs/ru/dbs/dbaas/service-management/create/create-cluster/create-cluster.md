...
1. На шаге «Параметры»:
   ...
   1. Настройте резервное копирование. При необходимости параметры резервного копирования можно [задать или изменить](/ru/storage/backups/db-backup) после создания кластера.
      ...
      - При необходимости включите резервное копирование по [стратегии GFS](/ru/storage/backups/retention-policy/gfs-backup) и настройте параметры хранения.
...
1. На шаге «Ноды»:
   ...
   1. В блоке **Dashboards** выберите опцию **Включить Dashboards**, если необходим доступ к веб-интерфейсу [OpenSearch Dashboards](https://opensearch.org/docs/latest/dashboards/quickstart-dashboards/).
      ...
      - **Тип виртуальной машины:** [шаблон конфигурации](/ru/base/iaas/concepts/about#shablony_konfiguraciy) для кластера.
      ...
      - **Тип диска:** [тип диска](/ru/base/iaas/concepts/about#diski) для кластера.
...
1. На шаге «Шарды» задайте настройки шардов.
   ...
   1. Для каждого шарда задайте:
      ...
      - **Тип виртуальной машины:** [шаблон конфигурации](/ru/base/iaas/concepts/about#shablony_konfiguraciy) для хостов шарда.
      ...
      - **Тип диска:** [тип диска](/ru/base/iaas/concepts/about#diski) для хостов шарда.
