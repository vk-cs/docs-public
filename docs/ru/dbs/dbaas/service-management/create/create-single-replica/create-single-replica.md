...
1. На шаге «Создание инстанса»:
   ...
   1. Настройте резервное копирование. При необходимости параметры резервного копирования можно [задать или изменить](/ru/storage/backups/db-backup) после создания инстанса БД.
