...
{note:warn}
Инстанс БД тарифицируется и потребляет вычислительные ресурсы. После прохождения быстрого старта [удалите инстанс и назначенный ему Floating IP-адрес](#dbaas-quick-start-delete), если они вам больше не нужны.
{/note}
