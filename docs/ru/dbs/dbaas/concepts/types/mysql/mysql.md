...
Список версий MySQL, которые поддерживаются в {var(cloud)}, доступен при {linkto(../../../instructions/create#dbaas-create)[text=создании]} инстанса этой базы данных.

## {heading(Что дальше?)[id=dbaas-concepts-mysql-whats-next]}
...
- {linkto(../../../instructions/manage-instance/mysql#dbaas-mysql)[text=Познакомьтесь]} с основными операциями, которые доступны для инстансов этой СУБД в {var(cloud)}.