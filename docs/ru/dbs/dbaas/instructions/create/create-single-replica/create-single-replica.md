...
1. На шаге **Конфигурация**:
   ...
   1. Выберите конфигурацию **Single** или **Master-Replica**. Конфигурация **Master-Replica** доступна не для всех [типов СУБД](../../../concepts/work-configs#available-configs).
...
1. На шаге **Создание инстанса**:
   ...
   1. Задайте общие параметры инстанса:
      ...
      - **Зона доступности**: [зона доступности](/ru/start/concepts/architecture#az) для инстанса БД.
