# {heading(Обновление сертификата федерации удостоверений)[id=iam-update-fim-cert]}

Срок действия сертификатов ADFS ограничен, после его истечения пользователи не смогут войти в систему. Для корректной работы аутентификации обновите сертификат федерации. Вы можете сделать это [вручную](#iam-update-fim-cert-manual) или настроить [автоматическое](#iam-update-fim-cert-auto) обновление.
...
## {heading(Автоматическое обновление сертификата)[id=iam-update-fim-cert-auto]}
