...
Увеличение квот выполняется через специальную форму от имени пользователя с [ролью](/ru/tools-for-using-services/account/concepts/rolesandpermissions) владельца проекта:
...
1. Если для проекта разрешено автоматическое увеличение квот, будет доступен выбор типа запроса. Выберите один из них:
    ...
    - **Автоматическое увеличение квот** — квоты будут расширены автоматически, без запроса в техподдержку. Максимально доступное значение для каждой квоты ограничено.
