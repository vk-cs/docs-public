...
1. Если для проекта разрешено быстрое или автоматическое увеличение квот, будет доступен выбор типа запроса. Выберите один из них:
   ...
   - **Быстрое увеличение квот** — увеличение квот в один клик, без согласования с менеджером. Подробнее об условиях быстрого увеличения квот в статье {linkto(../../../concepts/quotasandlimits#quotasandlimits-tech-limits)[text=%text]}.

   - **Автоматическое увеличение квот** — квоты будут расширены автоматически, без согласования с менеджером. Значение каждой квоты можно увеличить не более, чем на 30% от текущего значения. Подробнее об условиях автоматического увеличения квот в статье {linkto(../../../concepts/quotasandlimits#quotasandlimits-tech-limits)[text=%text]}.
