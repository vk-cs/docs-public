# {heading(Проблема с отображением ресурсов в ЛК)[id=tools-account-troubleshooting-get-har-logs]}

В редких случаях инфраструктура в личном кабинете {var(cloud)} может отображаться некорректно.
...
1. Если ошибка сохраняется, запишите логи сетевых запросов браузера (файл в формате HAR):
    ...
    1. Перейдите на страницу личного кабинета {var(cloud)}, на которой возникает проблема.
