Информация о возникших при работе сервиса событиях и ошибках сохраняется в логах VK Cloud. Эти данные используются технической поддержкой при разборе возникающих инцидентов.
