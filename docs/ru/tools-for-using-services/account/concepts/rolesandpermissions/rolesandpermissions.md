...
- [привязать](/ru/additionals/billing/instructions/add-card) к проекту карту оплаты, если она еще не привязана;
- [пополнить](/ru/additionals/billing/instructions/payment) баланс проекта или настроить автопополнение.
