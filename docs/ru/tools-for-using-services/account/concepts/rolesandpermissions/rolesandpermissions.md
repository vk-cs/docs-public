...
| Пользователь с этой ролью может выполнять те же операции, что и администратор виртуальных машин, за исключением создания, редактирования и удаления групп правил в настройках групп безопасности.
