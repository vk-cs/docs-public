...
Квоты можно {linkto(../../instructions/project-settings/manage#project-increase-quota)[text=увеличить]} в пределах технических лимитов. По умолчанию увеличение квот требует согласования с менеджером по электронной почте [sales-team@mcs.mail.ru](mailto:sales-team@mcs.mail.ru), но вы можете повысить лимит базового уровня нового проекта или автоматически добавить до 30% от текущего значения квот при выполнении следующих обязательных условий:
