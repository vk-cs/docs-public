...
| Параметр                  | Лимит | Жесткий |
|---------------------------|---------|---|
| Количество дисков у одного инстанса  | 25 шт.| ![](/ru/assets/check.svg "inline") |
| Размер одного диска HDD              | 50 ТБ | ![](/ru/assets/check.svg "inline") |
| Размер одного диска SSD              | 10 ТБ | ![](/ru/assets/check.svg "inline") |
| Размер одного диска High-IOPS SSD    | 2 TБ через личный кабинет, 5 ТБ при помощи OpenStack CLI | ![](/ru/assets/no.svg "inline") |
| Размер одного образа                 | 500 ГБ | ![](/ru/assets/no.svg "inline") |
| Общий объем образов                  | 2 ТБ | ![](/ru/assets/no.svg "inline") |
| Общее количество снимков дисков      | 200 шт. | ![](/ru/assets/no.svg "inline") |
