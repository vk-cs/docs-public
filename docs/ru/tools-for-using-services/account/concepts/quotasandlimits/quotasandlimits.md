...
| Параметр                                         | Лимит              | Жесткий |
|--------------------------------------------------|--------------------|---------|
| Количество [узлов](/ru/kubernetes/k8s/concepts/architecture#topologii_klastera) в группе узлов          | 100 шт.            | &#10003; |
...
| Параметр                  | Лимит | Жесткий |
|---------------------------|---------|---|
| Количество дисков у одного инстанса  | 25 шт.| &#10003; |
...
|-----------------------------------------------|---------------------------------|--------------------|--|--|
| Количество резервных копий                    | `backups` | — | не ограничено | — |
