...
| Общий объем дисков High-IOPS SSD в [зоне доступности](/ru/additionals/start/architecture#az) GZ1 | [квота](../../service-management/project-settings/manage#prosmotr_kvot_proekta) **Размер High-IOPS SSD в зоне - (DP1)** в личном кабинете, `gigabytes_dp1-high-iops` в расширенном списке | 200 ГБ | не ограничено |
...
| Количество дисков High-IOPS SSD в [зоне доступности](/ru/additionals/start/architecture#az) GZ1 | [квота](../../service-management/project-settings/manage#prosmotr_kvot_proekta) **Диски High-IOPS SSD в зоне - (DP1)** в личном кабинете, `volumes_dp1-high-iops` в расширенном списке | 10 шт. | не ограничено |
