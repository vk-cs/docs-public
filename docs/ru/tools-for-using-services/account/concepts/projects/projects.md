...
После [пополнения](/ru/intro/billing/service-management/payment#balance_charge) и восстановления положительного баланса лицевого счета сервисы в проекте автоматически активируются в течение 15 минут. Остановленные объекты после разморозки необходимо запустить вручную.
