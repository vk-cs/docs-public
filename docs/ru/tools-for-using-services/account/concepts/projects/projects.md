...
При регистрации нового аккаунта в VK Cloud автоматически создается проект, в котором текущий пользователь зарегистрирован в роли владельца. [Владелец проекта](/ru/access/iam/concepts/roles-reference#mcs_owner) может создавать новые проекты и [приглашать](../../instructions/project-settings/invite) во все свои проекты пользователей, назначая им [роли](/ru/access/iam/concepts/roles-reference) и [разрешения](/ru/access/iam/concepts/permissions-reference). Один и тот же пользователь может быть участником нескольких проектов и иметь в них в разные роли. Одному участнику может быть назначено несколько ролей и разрешений в одном проекте, в этом случае права ролей и разрешений суммируются.
...
{cut(Пример для сервиса VK Object Storage)}
...
Подробнее о сервисе в разделе [VK Object Storage](/ru/storage/s3).
