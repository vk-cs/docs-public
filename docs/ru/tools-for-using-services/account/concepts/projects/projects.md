...
После заморозки проекта средства продолжают списываться с баланса лицевого счета. [Законсервируйте проект](../../service-management/project-settings/manage#konservaciya_proekta), чтобы остановить списание.
...
- Если баланс проекта становится отрицательным, объекты сервиса замораживаются.
...
После [пополнения](/ru/intro/billing/service-management/payment#balance_charge) и восстановления положительного баланса лицевого счета сервисы в проекте автоматически активируются в течение 4 часов. Остановленные объекты после разморозки необходимо запустить вручную.
