...
- разграничить [доступ](/ru/access/iam/concepts/rolesandpermissions) пользователей к ресурсам и данным;
- отслеживать потребление ресурсов отдельно по каждой из задач.

{ifdef(public)}
При регистрации нового аккаунта в {var(cloud)} автоматически создается проект, в котором текущий пользователь зарегистрирован в роли владельца. Владелец проекта может создавать новые проекты и приглашать во все свои проекты пользователей, назначая им {linkto(../rolesandpermissions#tools-account-concepts-rolesandpermissions)[text=роли]}. Один и тот же пользователь может быть участником нескольких проектов и иметь в них в разные роли.
