# {heading(Получение отчета по клиентам)[id=partner-platform-client-reports]}
...
- Отчеты по клиентам в отдельных XLSX-файлах с именами вида `<ИМЯ_КЛИЕНТА+ПОЧТА_КЛИЕНТА>.xlsx`.
