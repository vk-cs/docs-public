# {heading(Управление клиентским проектом)[id=pp-manage-project]}

## {heading(Блокировка проекта)[id=pp-manage-project-block]}
...
1. Заблокируйте проект одним из способов:
   ...
   - Нажмите ![ ](../../../../../assets/more-icon.svg "inline") для нужного проекта и выберите пункт **Блокировать**.
...
## {heading(Разблокировка проекта)[id=pp-manage-project-unblock]}
...
1. Разблокируйте проект одним из способов:
   ...
   - Нажмите ![ ](../../../../../assets/more-icon.svg "inline") для нужного проекта и выберите пункт **Разблокировать**.
