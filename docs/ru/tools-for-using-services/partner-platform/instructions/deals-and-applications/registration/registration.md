# {heading(Регистрация сделки)[id=pp-deal-registration]}
...
1. Раскройте блок **Информация о Сделке** и укажите параметры сделки, которую вы хотите зарегистрировать:
   ...
   1. В поле **MCS ID** введите {linkto(../../../../vk-cloud-account/instructions/project-settings/manage#vk-cloud-account-project-pid)[text=PID]} проекта заказчика, который можно {linkto(../../client-management/client-information#pp-client-information-view-projects)[text=посмотреть]} в информации о клиентах.
   ...
   1. В поле **Описание сделки** в свободной форме опишите, чем занимается компания-заказчик, какими услугами {var(cloud)} она планирует пользоваться и что будет размещать в облаке.

1. Нажмите кнопку **Создать**.
1. В отобразившемся окне нажмите **Все заявки**, чтобы перейти в {linkto(../applications#pp-applications)[text=раздел]} **Заявки** и убедитесь, что ваша заявка успешно создана.

В дальнейшем вы можете {linkto(../applications#pp-applications)[text=отслеживать]} статус вашей заявки в списке заявок.
