...
Если вы — клиент партнера [White Label](/ru/start/partners/cooperation-models#kak_rabotaet_model_79ceacbe), вам может быть доступен ограниченный набор сервисов VK Cloud. Ограничения устанавливает партнер White Label, пригласивший вас на платформу.
...
Баланс клиента не пополняется автоматически, средства зачисляются вручную по запросу партнера. Стоимость сервисов приведена в [прайс-листе](https://cloud.vk.com/pricelist), но если вы — клиент партнера [White Label](/ru/start/partners/cooperation-models#kak_rabotaet_model_79ceacbe), ваши цены могут отличаться от указанных.
