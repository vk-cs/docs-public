...
* Использование DNS облачной платформы (подробнее — в разделе [Справочник по провайдеру VK CS Infra (iVK CS)](../../../ivkcs)).
   ...
   {/note}
* Создание бакетов VK Object Storage (подробнее — в разделе [Справочник по провайдеру VK CS Infra (iVK CS)](../../../ivkcs)). Созданные бакеты будут отображаться в ЛК облачной платформы.
