...
Агент позволяет задавать зависимость запуска скрипта относительно других ресурсов Terraform, устанавливать тайм-аут, контролировать коды выхода и останавливать развертывание приложения при ошибках.
