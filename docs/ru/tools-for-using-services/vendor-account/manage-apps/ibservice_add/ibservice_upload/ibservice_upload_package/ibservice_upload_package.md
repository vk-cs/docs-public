...
|
Сервисный пакет ({var(cloud)} product package)
|
...
1. При необходимости внесите изменения в конфигурацию сервиса (подробнее — в разделе {linkto(../../../../instructions/manage-ib-apps/update-ib-app#ibservice_update)[text=%text]}).
