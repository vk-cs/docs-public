...
У пользователя, загружающего сервисный пакет в магазин, должна быть учетная запись (личный кабинет) в облачной платформе. Инструкция по регистрации приведена в разделе [Регистрация в {var(cloud)}](/ru/intro/onboarding/account).
