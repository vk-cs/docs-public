...
Marketplace интегрирован с облачной платформой VK Cloud. Marketplace обеспечивает доступ пользователей облачной платформы к сервисам, размещенным в нем.
...
* Image-based приложение — продукт, который развертывается на основе образов виртуальных машин в облачном проекте пользователя. Для работы сервиса может использоваться дополнительная инфраструктура облачной платформы: виртуальные сети, балансировщики нагрузки, кластеры DBaaS, VK Object Storage, резервное копирование. Инфраструктура для работы сервиса предоставляется облачной платформой. Инстансы сервиса развертываются в проекте пользователя.
