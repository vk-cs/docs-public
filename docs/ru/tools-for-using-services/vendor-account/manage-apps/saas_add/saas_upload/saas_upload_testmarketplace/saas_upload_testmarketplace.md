# {heading(Тестирование сервиса в магазине)[id=saas_upload_testmarketplace]}
...
Для тестирования сервиса в магазине выдается грант. Чтобы получить грант, отправьте письмо на [marketplace@cloud.vk.com](mailto:marketplace@cloud.vk.com). Грант будет зачислен на бонусный счет проекта облачной платформы.
