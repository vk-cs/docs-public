В кабинете поставщика вы можете получить отчеты об использовании сервисов, размещенных на платформе {var(cloud)}.
...
1. Скачайте нужный отчет одним из способов:
   ...
   - Нажмите ![ ](../../../../assets/more-icon.svg "inline") для нужного отчета и выберите пункт **Скачать**.
