...
1. Отредактируйте JSON-файл `catalog_<ИМЯ_СЕРВИСА>.json` с описанием конфигурации сервиса.
   ...
   1. Убедитесь, что в новой конфигурации сервиса указана новая [ревизия сервиса](../../../reference/saas-apps-reference/saas-param). Если указанная ревизия сервиса уже загружена в Marketplace, сервис не будет обновлен.

   1. Если вы изменили параметры текущих тарифных планов, убедитесь, что в новой конфигурации сервиса указаны новые [ревизии планов](../../../reference/saas-apps-reference/saas-plan). Если указанные ревизии планов уже загружены в Marketplace, тарифные планы не будут обновлены.
