В кабинете поставщика доступны статистические данные о сервисах, которые вы разместили на платформе {var(cloud)}.
...
- **Сервисы** — количество сервисов, которые вы разместили на платформе {var(cloud)}.
- **Экземпляры** — количество экземпляров (пользовательских установок) для всех сервисов, которые вы разместили на платформе {var(cloud)}.
