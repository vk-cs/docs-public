...
- [Зона доступности](../../../../../start/concepts/architecture#architecture-az): по умолчанию (для региона Москва — `ME1`).
...
[Перейдите](https://msk.cloud.vk.ru/app/) в личный кабинет {var(cloud)}, в раздел **Базы данных** → **Инстансы баз данных**. Убедитесь, что все описанные в конфигурации объекты были успешно созданы:
