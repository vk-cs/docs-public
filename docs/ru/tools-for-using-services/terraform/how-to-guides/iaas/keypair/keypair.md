# {heading(Создание ключевых пар)[id=terraform-keypair]}
...
## {heading(Создание ключевой пары)[id=terraform-keypair-create]}
...
## {heading(Применение изменений)[id=terraform-keypair-apply]}
