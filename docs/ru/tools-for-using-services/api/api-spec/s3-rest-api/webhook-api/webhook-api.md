Webhooks для Object Storage — это возможность настраивать отправку HTTP/S запросов по событиям для бакета, используя API. Например, можно:
...
В момент выполнения этого запроса сервис Object Storage валидирует URL, выполняя на него следующий запрос (2):
