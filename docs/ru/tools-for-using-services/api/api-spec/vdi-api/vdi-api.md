API сервиса [Cloud Desktop](/ru/computing/cloud-desktops) позволяет управлять пулами рабочих столов и рабочими столами в них.
...
1. [Получите](../../rest-api/case-keystone-token) токен доступа `X-Auth-Token`.
