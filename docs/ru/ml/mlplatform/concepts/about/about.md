# {heading(О сервисе)[id=mlplatform-about]}

## {heading(Концепция MLOps)[id=mlplatform-about-mlops]}
...
- Обеспечена безопасность при работе с данными в соответствии с законодательством. Cloud ML Platform развернута в облаке {var(cloud)}, соответствующем требованиям 152-ФЗ, УЗ-1, сертификации PCI DSS.
