...
## {heading(2. Подключитесь к инстансу)[id=mlp-mlflow-quickstart-2_connect_instance]}
...
## {heading(Удалите неиспользуемые ресурсы)[id=mlp-mlflow-quickstart-delete_unused]}

Инстансы MLflow тарифицируются. Если инстанс вам больше не нужен, [удалите](../instructions/manage#mlplatform-jupyterhub-instructions-manage-delete) его.
