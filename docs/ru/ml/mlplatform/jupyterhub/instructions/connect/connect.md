# {heading(Подключение к JupyterHub)[id=mlplatform-jupyterhub-instructions-connect]}

1. [Создайте пользователя](../manage#mlplatform-jupyterhub-instructions-manage-create-users) инстанса или попросите владельца инстанса создать и передать вам учетные данные пользователя.
