# {heading(Пример интеграции на Python)[id=vision-htg-vision-py]}
...
## {heading(Добавление персоны в базу данных)[id=vision-htg-vision-py-add-persons]}
...
### {heading(Параметр create_new)[id=vision-htg-vision-py-add-persons-create_new]}
...
### {heading(Параметр space)[id=vision-htg-vision-py-add-persons-space]}
...
## {heading(Удаление персоны из базы данных)[id=vision-htg-vision-py-delete-person]}
