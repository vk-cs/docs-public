# {heading(Создание кластера Spark)[id=mlspark-instructions-create]}
...
1. На шаге **Создание кластера**:
   ...
   1. Задайте общие настройки:
      ...
      - **Зона доступности**: [зона доступности](/ru/start/concepts/architecture#architecture-az) для кластера.
