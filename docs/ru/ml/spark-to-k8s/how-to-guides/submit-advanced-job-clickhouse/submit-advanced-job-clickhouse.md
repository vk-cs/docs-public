...
1. Удалите [объекты из бакета](/ru/storage/s3/instructions/objects/manage-object#udalenie_obekta) и [сам бакет](/ru/storage/s3/instructions/buckets/manage-bucket#bucket_delete), который использовался этим кластером.
