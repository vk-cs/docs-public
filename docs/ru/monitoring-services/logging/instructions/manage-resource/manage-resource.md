# {heading(Управление ресурсами журналов событий)[id=logging-manage-resource]}

## {heading(Создание ресурса журналов событий)[id=logging-manage-resource-create]}
...
1. Укажите название ресурса и нажмите кнопку **Добавить**.

Информация о привязке объектов к ресурсам приведена в разделе {linkto(../connect-plugin#logging-connect-plugin)[text=%text]}.
...
1. Нажмите на значок **•••** справа от названия ресурса и выберите пункт **Редактировать**.
1. Измените название ресурса и нажмите кнопку **Сохранить изменения**.
...
1. Нажмите кнопку **Настройки**.
1. Перейдите на вкладку **Прочие ресурсы**.
1. Нажмите на значок **•••** справа от названия ресурса и выберите пункт **Удалить**.
