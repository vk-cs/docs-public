...
Собранная информация о событиях доступна в личном кабинете VK Cloud только для пользователей с [ролями](/ru/access/iam/concepts/rolesandpermissions):
