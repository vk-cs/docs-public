...
1. Перейдите в раздел **Мониторинг → Журнал событий**.
   ...
   Отобразится список событий, разрешенных к просмотру для вашей [роли](/ru/access/iam/concepts/rolesandpermissions) в проекте.

1. Выберите вкладку **Управляющий слой** или **Слой данных** для просмотра событий соответствующего слоя.

    {note:info}
    По умолчанию в слое данных отображаются только события из источников, интегрированных в сервис. Добавить собственные источники можно, настроив [плагин аудита](/ru/monitoring-services/event-log/concepts/audit-plugin).
    {/note}
