...
1. При [создании ВМ](/ru/computing/iaas/instructions/vm/vm-create) активируйте пункт **Включить мониторинг**.
1. Дождитесь завершения создания ВМ.
1. [Узнайте](/ru/computing/iaas/instructions/vm/vm-manage#poluchenie_id_virtualnoy_mashiny) ID созданной виртуальной машины.
