# {heading(Настройка мониторинга на новой ВМ)[id=monitoring-mon-setup-new]}

1. При {linkto(../../../../computing/iaas/instructions/vm/vm-create#iaas-vm-create)[text=создании ВМ]} активируйте пункт **Включить мониторинг**.
...
1. На шаге **Параметры** выберите:
   ...
   - **Название метрики**: выберите метрику из списка. Если список пустой, создайте новую ВМ с активированным мониторингом либо {linkto(../mon-setup-current#monitoring-mon-setup-current)[text=установите мониторинг в существующую]} ВМ.
