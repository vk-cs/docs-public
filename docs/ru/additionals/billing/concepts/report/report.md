...
Как начать получать от VK Cloud отчетные документы, читайте в статье [Донастройка проекта для ЮЛ](/ru/additionals/billing/operations/corporate#otchetnye_dokumenty). По всем вопросам, связанным с отчетными документами, обращайтесь в отдел документооборота VK Cloud:
...
Имеется в виду работа по [договорам оферты сервисов](/ru/additionals/start/legal). Эта схема по умолчанию используется во всех проектах, для физических и юридических лиц.
...
- При работе по предоплате:
  ...
  - Дополнительные документы, если требуются по договору:
    ...
    Счет на оплату не предоставляется. Организации, работающие по предоплате, [формируют](../../operations/bill-generation) его самостоятельно в личном кабинете.
...
- Отчет по биллингу за выбранный период.
    ...
    Содержит детализацию по потреблению ресурсов и используется для подтверждения сумм в отчетных документах. Вы можете [выгрузить](../../operations/detail#skachivanie_otcheta) такой отчет из личного кабинета.
...
Вы можете настроить ЭДО с VK Cloud самостоятельно или отправить заявку на настройку в отдел документооборота VK Cloud (docs_vktech@vk.company).

<info>

Работа по ЭДО доступна только для проектов в [регионе](/ru/base/account/concepts/regions) Москва и только организациям, зарегистрированным в РФ.

</info>

#### Доставка оригиналов документов

Чтобы настроить бумажный документооборот, свяжитесь с отделом документооборота VK Cloud:
...
VK Cloud может предоставлять скан-копии отчетных документов в формате PDF по электронной почте — каждый месяц или разово, по запросу. Для получения скан-копий отправьте запрос в VK Cloud:

- в [регионе](/ru/base/account/concepts/regions) Москва — на адрес docs_vktech@vk.company;
- в регионе Казахстан — на адрес accountvk@qazcloud.kz.
