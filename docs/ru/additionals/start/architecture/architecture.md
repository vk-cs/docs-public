...
Инфраструктура зон доступности всех регионов VK Cloud [защищена](/ru/additionals/start/it-security/compliance-152fz) в соответствии с ФЗ РФ «О персональных данных» №152-ФЗ.
