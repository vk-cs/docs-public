...
**Применимые правила** — правила использования Сервиса Компании, доступные в сети Интернет по адресу: [https://cloud.vk.com/docs/ru/additionals/start/legal/policy-infra](/ru/additionals/start/legal/policy-infra), содержащие в себе условия доступа и использования Сервиса и изложенные в следующих документах:

- Условия использования Платформы «VK Cloud» ([https://cloud.vk.com/docs/additionals/start/legal/legal-terms](/ru/additionals/start/legal/legal-terms));
- Политика конфиденциальности Компании ([https://cloud.vk.com/docs/additionals/start/legal/policy-privacy](/ru/additionals/start/legal/policy-privacy)).
...
5.1. Размер ответственности Компании ограничен исключительно соответствующими Применимыми правилами, размещенным на Сайте в разделе [https://cloud.vk.com/docs/additionals/start/legal](/ru/additionals/start/legal).
