...
**Применимые правила** — правила использования Сервиса Компании, доступные в сети Интернет по адресу: [https://mcs.mail.ru/docs/ru/additionals/start/legal/cloud-servers](/ru/additionals/start/legal/cloud-servers), содержащие в себе условия доступа и использования Сервиса и изложенные в следующих документах:
...
4.2. Стоимость использования Сервисов Платформы указана на интернет-странице https://mcs.mail.ru/pricelist (далее — Прайс-лист), если иные Тарифы не согласованы Компанией и Заказчиком в Договоре. Компания вправе изменять тарифы на Сервисы в одностороннем порядке путем опубликования актуального Прайс-листа на интернет-странице https://mcs.mail.ru/pricelist.
...
5.1. Размер ответственности Компании ограничен исключительно соответствующими Применимыми правилами, размещенным на Сайте в разделе [https://mcs.mail.ru/docs/ru/additionals/start/legal](/ru/additionals/start/legal).
