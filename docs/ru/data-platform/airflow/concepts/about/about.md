# {heading(О сервисе)[id=airflow_info]}

Cloud Airflow — сервис для программирования, планирования и мониторинга рабочих процессов (workflow) на основе платформы [Apache Airflow](https://airflow.apache.org/) и кластеров Kubernetes.
