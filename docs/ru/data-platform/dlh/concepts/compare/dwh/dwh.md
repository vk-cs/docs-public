...
## {heading(Модели хранения данных в DWH)[id=dlh_wdh_models]}
...
## {heading(Ограничения DWH)[id=dlh_dwh_restrictions]}
...
## {heading(Альтернативы DWH)[id=dlh_dwh_alternatives]}
...
- {linkto(../data-lake#dlh_data-lake)[text=%text]} — архитектурного компонента, позволяющего хранить слабоструктурированные данные в исходном виде, без строгой регламентации, характерной для DWH.
- {linkto(../dlh#dlh_dlh)[text=%text]} — универсального решения для работы с большими данными, сочетающего в себе преимущества архитектур Data Warehouse и Data Lake.
