...
1. Выберите тип доступа и установите параметры правила:
    ...
    - **Каталоги**: названия каталогов, на которые распространяется правило. По умолчанию правило распространяется на все каталоги. Вводятся вручную и должны совпадать с названиями каталогов, которые можно [узнать](/ru/data-platform/trino/instructions/management#view_connect) в настройках подключения или с помощью запроса:
