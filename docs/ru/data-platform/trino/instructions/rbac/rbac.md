...
1. Выберите тип доступа и установите параметры правила:
   ...
   - **Привилегии**: 
     ...
     {note:info}
     Используйте таблицу из статьи {linkto(../../concepts/rbac_info#rbac_sql_permissions)[text=Особенности работы правил доступа]}, чтобы выбрать нужную привилегию.
     {/note}

    - **Каталоги**: названия каталогов, на которые распространяется правило. По умолчанию правило распространяется на все каталоги. Вводятся вручную и должны совпадать с названиями каталогов, которые можно {linkto(../management#trino_view-connect)[text=узнать]} в настройках подключения или с помощью запроса:
...
## {heading(Просмотр правил доступа)[id=trino_view]}
...
## {heading(Изменение последовательности правил доступа)[id=trino_rearrange]}
...
## {heading(Редактирование правила доступа)[id=trino_edit]}
...
1. Перейдите на вкладку **Доступы**.
1. Нажмите **•••** справа от правила и выберите пункт **Редактировать**.
...
## {heading(Удаление правила доступа)[id=trino_delete]}
...
1. Перейдите на вкладку **Доступы**.
1. Нажмите **•••** справа от правила и выберите пункт **Удалить**.
