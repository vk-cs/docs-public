# {heading(О портале документации)[id=about-help]}

## {heading(Закладки)[id=about-help-marker]}

Для быстрого доступа к избранным статьям в документации {var(cloud)} есть специальный раздел **Закладки**.
...
## {heading(Обратная связь)[id=about-help-feedback]}

### {heading(Оценка статьи)[id=about-help-grade]}
...
### {heading(Предложения по изменению документации)[id=about-help-suggestion]}
...
## {heading(Форматирование контента)[id=about-help-formatting]}

В документации {var(cloud)} используются несколько способов выделить разные виды информации.

### {heading(Информационные вставки)[id=about-help-info]}
...
### {heading(Блоки кода)[id=about-help-codeblocks]}
...
### {heading(Скрытый текст)[id=about-help-cut]}
...
### {heading(Вкладки)[id=about-help-tabs]}
