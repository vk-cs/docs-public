...
VK Tech публикует сертификаты продуктов на [специальной странице](https://cloud.vk.ru/sertifikatsiya-tekhnologicheskoy-sovmestimosti).
...
Чтобы начать процесс сертификации ПО, заполните [форму](https://cloud.vk.ru/partner/#partners-cert).
