...
| Безопасность
| [Обеспечивается](https://cloud.vk.ru/cloud-platform/certificates/) {var(cloud)}
...
Статус зон доступности, сервисов и инфраструктуры {var(cloud)} можно проверить на странице [Статус работы сервисов](https://status.msk.cloud.vk.ru).
...
Безопасность {var(cloud)} обеспечивается постоянным мониторингом сервисов {var(cloud)}, проведением внешних аудитов. Информационная система {var(cloud)} [аттестована](https://cloud.vk.ru/cloud-platform/certificates) по требованиям 21 Приказа ФСТЭК России для работы с персональными данными.
