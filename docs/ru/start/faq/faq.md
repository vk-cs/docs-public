...
Актуальная оферта и другие юридические документы доступны на [официальном сайте {var(cloud)}](../legal/digital-cloud). Если нужно заключение двустороннего договора, свяжитесь с [отделом продаж](https://cloud.vk.ru/contacts/).
