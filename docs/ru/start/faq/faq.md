...
Для подключения новых проектов и согласования условий сотрудничества обратитесь в [отдел продаж](https://cloud.vk.ru/contacts/).
...
Чтобы получить доступ к сервисам {var(cloud)}, пополните баланс проекта на любую сумму. Рекомендуется класть на счет сумму, равную суточному списанию. Для расчета стоимости нужной вам конфигурации воспользуйтесь [калькулятором](https://cloud.vk.ru/pricing) или изучите [прайс-лист](https://cloud.vk.ru/pricelist/).

{/cut}

{cut(Как посмотреть историю платежей?)}

Чтобы посмотреть все списания и поступления по проектам, перейдите на [страницу баланса](https://msk.cloud.vk.ru/app/services/billing) в личном кабинете. Подробнее — в статье {linkto(../../intro/billing/instructions/detail#billing-detail)[text=Детализация расходов]}.
...
Обратитесь в [техническую поддержку](/ru/contacts). Специалисты убедятся, что вы являетесь владельцем учетной записи, после чего деактивируют эту опцию для вашего аккаунта. После этого подключите двухфакторную аутентификацию повторно в [личном кабинете](https://msk.cloud.vk.ru/app/account/profile).
...
Эти данные публикуются на странице [состояния системы](https://status.msk.cloud.vk.ru).

{/cut}

{cut(Где изменить данные юридического лица?)}

Для заполнения данных о юридическом лице перейдите в [личный кабинет](https://msk.cloud.vk.ru/app/), нажмите на название вашей учетной записи и в выпадающем меню выберите **Настройки проекта**. На открывшейся странице на вкладке **Общая информация** можно изменить данные юридического лица.

{/cut}

{cut(Есть ли индивидуальная поддержка сервисов в {var(cloud)}?)}

В {var(cloud)} можно подключить сервис приоритетной поддержки (Professional Services) от экспертов {var(cloud)}. Чтобы воспользоваться этим сервисом, оставьте заявку [на сайте](https://cloud.vk.ru/professional-services/).
...
Актуальная оферта и другие юридические документы доступны на [официальном сайте {var(cloud)}](../legal/archive/digital-cloud). Если нужно заключение двустороннего договора, свяжитесь с [отделом продаж](https://cloud.vk.ru/contacts/).
...
Для размещения систем, требующих защиты по ФЗ-152, мы предлагаем аттестованный сегмент платформы. Для консультации по этим решениям [обратитесь в отдел продаж](https://cloud.vk.ru/contacts/).
...
Да, {var(cloud)} предоставляет услуги аренды выделенных серверов (Bare Metal). Для консультации по этим решениям [обратитесь в отдел продаж](https://cloud.vk.ru/contacts/).
