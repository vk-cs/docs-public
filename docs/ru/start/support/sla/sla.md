...
## {heading(Классификация инцидентов)[id=support-sla-classification]}

### {heading(Таблица классификация инцидентов)[id=support-sla-classification-table]}
...
### {heading(Таблица описания запросов)[id=support-sla-request]}
...
### {heading(Время реакции)[id=support-sla-reaction-time]}
...
### {heading(Таблица статистики по решению)[id=support-sla-stats]}
