...
**Правила** — настоящий документ, являющийся публичной офертой, размещенный в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/vk/policy-vkma-program](/ru/start/legal/archive/vk/policy-vkma-program)
...
**Сайт** — интернет-сайт, расположенный по адресу https://cloud.vk.ru/, предоставляющий Пользователю доступ к Платформе VK Cloud и различным сервисам. Компания размещает на Сайте информацию, обязательную для Пользователей.
...
8.4. Новая редакция Правил вступает в силу с момента ее опубликования в сети «Интернет» по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/vk/policy-vkma-program](/ru/start/legal/archive/vk/policy-vkma-program).
