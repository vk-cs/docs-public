...
**Применимые правила** — правила использования Сервиса Компании, доступные в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/vk/policy-infra](/ru/start/legal/archive/vk/policy-infra), содержащие в себе условия доступа и использования Сервиса и изложенные в следующих документах:

- Условия использования Платформы «VK Cloud» ([https://cloud.vk.ru/docs/start/legal/archive/vk/legal-terms](/ru/start/legal/archive/vk/legal-terms));
- Политика конфиденциальности Компании ([https://cloud.vk.ru/docs/start/legal/archive/vk/policy-privacy](/ru/start/legal/archive/vk/policy-privacy)).
...
5.1. Размер ответственности Компании ограничен исключительно соответствующими Применимыми правилами, размещенным на Сайте в разделе [https://cloud.vk.ru/docs/start/legal/archive/vk](/ru/start/legal/archive/vk).
