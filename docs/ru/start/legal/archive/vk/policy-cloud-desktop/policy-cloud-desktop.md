...
Действующая редакция настоящего Соглашения доступна в сети Интернет по адресу: [https://cloud.vk.ru/docs/start/legal/archive/vk/policy-cloud-desktop](/ru/start/legal/archive/vk/policy-cloud-desktop). Редакция Соглашения вступает в силу с момента его опубликования по вышеуказанному адресу.
...
1.2. **Сайт** — интернет-сайт, расположенный по адресу: [https://cloud.vk.ru/](https://cloud.vk.ru/).
...
2.1. Доступ к ПО осуществляется в рамках платформы «VK Cloud» (далее — «Платформа»), в связи с чем условием получения лицензии является согласие Лицензиата с Условиями использования Платформы (далее — «Условия использования»), которые доступны по ссылке [https://cloud.vk.ru/docs/ru/start/legal/archive/vk/legal-terms](https://cloud.vk.ru/docs/ru/start/legal/archive/vk/legal-terms), а также Политикой Конфиденциальности Лицензиара, доступной по ссылке [https://cloud.vk.ru/docs/start/legal/archive/vk/policy-privacy](https://cloud.vk.ru/docs/start/legal/archive/vk/policy-privacy) (далее вместе именуемые «Применимые правила»). В случае противоречия между положениями Условий использования и настоящего Соглашения, приоритет имеют положения настоящего Соглашения. К отношениям Сторон, которые не урегулированы настоящим Соглашением, применяются Условия использования.
...
3.2. Лицензия действует на территории всего мира в течение оплаченного Лицензиатом периода. Стоимость использования ПО указаны на интернет-странице [https://cloud.vk.ru/pricelist](https://cloud.vk.ru/pricelist) (далее — Прайслист), если иная стоимость не согласованы Лицензиаром и Лицензиатом в отдельном договоре. Лицензиар вправе изменять стоимость на ПО в одностороннем порядке путём опубликования актуального Прайслиста на интернет-странице [https://cloud.vk.ru/pricelist](https://cloud.vk.ru/pricelist) или путем обновления информации в разделе «Cloud Desktop» в Личном кабинете Лицензиата. Новые тарифы применяются с даты, указанной при их опубликовании. Актуальная информация о тарифах доступна Лицензиату в разделе «Cloud Desktop» в Личном кабинете Лицензиата либо на интернет-странице [https://cloud.vk.ru/pricelist](https://cloud.vk.ru/pricelist) (в зависимости от того, где опубликована более актуальная (более поздняя) информация).
...
7.2.5. периодически знакомиться с содержанием настоящего Соглашения в сети Интернет по адресу: [https://cloud.vk.ru/docs/start/legal/archive/vk/policy-cloud-desktop](/ru/start/legal/archive/vk/policy-cloud-desktop) и следить за внесенными в него изменениями;
