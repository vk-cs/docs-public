Настоящий документ представляет собой Пользовательское соглашение «Магазин приложений» (далее — «Сервис»), и является неотъемлемой частью Условий использования Платформы VK Cloud (далее — «Условия использования»), размещенных в сети «Интернет» по адресу [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/legal-terms](/ru/start/legal/archive/digital-cloud/legal-terms).
...
**Пользовательское соглашение** — настоящий документ Пользовательское соглашение «Магазин приложений», размещенный в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/marketplace](/ru/start/legal/archive/digital-cloud/marketplace).
...
**Компания** — ООО «Цифровое Облако», юридическое лицо, созданное и осуществляющее свою деятельность в соответствии с законодательством Российской Федерации, зарегистрированное по адресу: Российская Федерация, 125167, г. Москва, вн.тнр.г. муниципальный округ Хорошевский, пр-кт Ленинградский, д. 39, стр. 80, помещ. 1/9.
...
2.3. В случае возникновения вопросов по работе Сервиса Пользователь должен обратиться в поддержку Сервиса. Контактные данные размещены на странице: [https://cloud.vk.ru/docs/ru/start/support/support-info](/ru/start/support/support-info).
...
6.2. Если Пользователь нарушает условия использования Сервиса и нарушает положения Пользовательского соглашению, то Компания вправе приостановить доступ Пользователя к Сервису.
...
9.1. Обработка персональных данных, полученных Компанией от Пользователя в процессе использования Сервиса, осуществляется в соответствии с Политикой конфиденциальности Платформы, опубликованной на сайте [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/policy-privacy](/ru/start/legal/archive/digital-cloud/policy-privacy).
