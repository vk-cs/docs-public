# {heading(Условия использования)[id=legal-legal-terms]}
...
- настоящем Соглашении, размещенном в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/legal-terms](/ru/start/legal/archive/digital-cloud/legal-terms);
- соглашениях об использовании отдельных Сервисов, предоставляемых Компанией или Партнерами Компании, размещенных в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud](/ru/start/legal/archive/digital-cloud);
- Политике конфиденциальности Компании, размещенной в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/policy-privacy](/ru/start/legal/archive/digital-cloud/policy-privacy).
...
1.5. В отношении одной Учетной записи Заказчика не может действовать более одного договора на использование Платформы и Сервисов. Все Проекты, созданные Заказчиком в рамках одной Учетной записи Заказчика, должны относиться к одному договору.

## 2. Термины и определения

**Сайт** — интернет-сайт, расположенный по адресу [https://cloud.vk.ru](https://cloud.vk.ru), предоставляющий Пользователю доступ к Платформе и различным сервисам. Компания размещает на Сайте информацию, обязательную для Пользователей.
...
6.1.1. нарушать права интеллектуальной собственности Компании и/или Партнеров в отношении Платформы, Сервисов или каких-либо их элементов, в частности, запрещается копировать, транслировать, рассылать, публиковать, и иным образом распространять и воспроизводить размещенные Компанией и Партнерами в рамках Платформы и Сервисов материалы (текстовые, графические, аудио-видео материалов), фрагменты и отдельные элементы (включая программы для ЭВМ, скрипты и иные элементы) Платформы и Сервисов без письменного согласия Компании и/или Партнеров;

6.1.2. осуществлять сбор учетных данных других Заказчиков и Пользователей Проектов, созданных другими Заказчиками;

6.1.3. использовать любые автоматические или автоматизированные средства для сбора информации, размещенной в рамках Платформы и Сервисов;

6.1.4. осуществлять через Платформу и Сервисы пропаганду или агитацию, возбуждающую социальную, расовую, национальную или религиозную ненависть и вражду, пропаганду войны, социального, расового, национального, религиозного или языкового превосходства, а также рассылку информации, которая пропагандирует суицид, содержит описание способов суицида и любое подстрекательство к его совершению; информацию о наркотических и психотропных веществах, в том числе, информацию о распространении наркотиков, рецепты их изготовления, советы по употреблению и иную информацию, распространение которой запрещено действующим законодательством РФ;

6.1.5. осуществлять рассылку спама — массовую рассылку коммерческой, политической, рекламной и иной информации (в том числе гиперссылок, ведущих на интернет-сайты с такой информацией и/или на интернет-сайты, содержащие вредоносное программное обеспечение) если получатели не выражали своего согласия на получение такого рода информации;

6.1.6. указывать при создании Личного кабинета и заполнении регистрационной формы или вводить впоследствии заведомо ложную или вымышленную информацию о себе;

6.1.7. передавать пароль от Личного кабинета лицам, не имеющим надлежащих полномочий на осуществление действий от имени Заказчика (или Пользователя);

6.1.8. осуществлять действия, направленные на дестабилизацию функционирования Платформы и Сервисов, осуществлять попытки несанкционированного доступа к управлению Платформой и Сервисами или их закрытым разделам (в том числе к разделам, доступ к которым разрешен только Компании), а также осуществлять любые иные аналогичные действия;

6.1.9. осуществлять действия по созданию с использованием функционала Платформы и Сервисов новых структур (в том числе блоков в блокчейне) для обеспечения функционирования криптовалютных платформ или для майнинга криптовалют любыми иными способами;

6.1.10. использовать Сервисы для организации прокси-серверов и маскирования трафика путем перебора IP-адресов сверх доступных квот в Проекте Заказчика;

6.1.11. размещать с использованием Платформы и Сервисов информационные ресурсы, посредством которых обеспечивается доступ к информации или информационным ресурсам в сети «Интернет», доступ к которым ограничен на территории Российской Федерации;

6.1.12. использовать Сервисы для обхода ограничений доступа к информации или информационным ресурсам в сети Интернет, доступ к которым подлежит ограничению в соответствии с законодательством Российской Федерации;

6.1.13. осуществлять любые иные действия, противоречащие политике и целям создания Платформы и Сервисов или нарушающие действующее законодательство Российской Федерации.

6.2. Запрет на недобросовестное использование.

6.2.1. Заказчик обязуется использовать Платформу и Сервисы добросовестно и в соответствии с их функциональным назначением. Заказчику запрещается совершать действия (либо допускать их совершение третьими лицами), направленные на получение необоснованных преимуществ, обход ограничений Сервисов, злоупотребление правом, а также иные действия, которые по разумной оценке Компании могут причинить вред Компании, Платформе, Сервисам, другим заказчикам или третьим лицам.

6.2.2. К недобросовестному использованию относятся, включая, но не ограничиваясь, следующие случаи:

- многократная регистрация/создание учетных записей (в том числе с использованием разных адресов электронной почты, номеров телефонов, платежных инструментов, виртуальных номеров, третьих лиц, временных доменов и т.п.) при отсутствии намерения использовать Сервис по функциональному назначению либо с целью получения необоснованных преимуществ (бонусов, бесплатных периодов, скидок, реферальных вознаграждений или иных преимуществ, не предусмотренных для такого способа использования);
- обход или попытка обхода лимитов, квот, технических/тарифных ограничений, процедур идентификации/верификации, ограничений по регионам, ограничения на количество учетных записей, а также иных мер защиты Платформы и Сервисов;
...
6.2.3. Компания вправе применять автоматизированные и/или ручные средства мониторинга, анализа и выявления недобросовестного использования или подозрительной активности Заказчика. 

6.2.4. Заказчик соглашается, что Компания не обязана раскрывать алгоритмы, критерии и внутренние правила выявления подозрительной активности и недобросовестного использования. 

6.3. При наличии у Компании разумных оснований полагать, что имеет место недобросовестное использование Сервиса и/или иное нарушение требований настоящего раздела Соглашения или иных условий Применимых правил, Компания вправе по своему усмотрению незамедлительно и без предварительного уведомления Заказчика применить одну или несколько мер:

- ограничить, приостановить или прекратить доступ Заказчика, Пользователей Проекта ко всем или к любому из разделов Платформы, Сервисов полностью или частично;
- аннулировать начисленные бонусы и (или) иные привилегии и преимущества, полученные в результате недобросовестных действий Заказчика;
- установить дополнительные ограничения (лимиты), потребовать прохождение дополнительной верификации/подтверждения данных, запросить документы/сведения, подтверждающие добросовестность использования;
- заблокировать возможность повторного создания учетной записи;
- предпринять иные меры, необходимые для защиты прав и законных интересов Компании и третьих лиц.
  
6.4.  Заказчик вправе предоставить Компании доказательства отсутствия нарушений путем направления соответствующего обращения Компании на электронный адрес, указанный в п. 11.7 настоящего Соглашения в срок не позднее 3 (трех) календарных дней с момента принятия Компанией мер, предусмотренных п. 6.3 Соглашения. В обращении Заказчик обязуется предоставить достаточные документы и информацию в обоснование своей позиции. В случае, если по результатам рассмотрения обращения Компания придет к выводу об отсутствии нарушения Применимых правил и (или) недобросовестного использования Платформы и Сервисов, Компания восстанавливает доступ Заказчика к Платформе и Сервисам и отзывает иные принятые меры реагирования на нарушение.

6.5. Компания не несет ответственности и не возмещает никакие убытки Заказчика, возникшие в результате приостановки, ограничения или прекращения доступа Заказчика, Пользователей Проекта Заказчика к Платформе или отдельным Сервисам, в случаях выявления нарушений при использовании Заказчиком или Пользователем Платформы и Сервисов (включая недобросовестное использование). Денежные средства, полученные Компанией в счет предварительной оплаты услуг, не подлежат возврату Заказчику и удерживаются Компанией в полном объеме в качестве штрафа за допущенное нарушение и возмещения убытков, понесенных Компанией в связи с такими нарушениями.
...
- незамедлительно без предварительного уведомления Заказчика приостанавливать, ограничивать или прекращать доступ Заказчика, Пользователей Проекта ко всем или к любому из разделов Платформы, Сервисов в случае нарушения Заказчиком или Пользователем Проекта законодательства Российской Федерации, Применимых правил или Правил для конечных пользователей, в том числе, но не ограничиваясь, на основании запросов/указаний уполномоченных государственных органов РФ;
...
## {heading(8. Оплата услуг Компании)[id=legal-terms-payment]}
...
8.2.1. Стоимость услуг по предоставлению доступа к Сервису определяется на странице в сети Интернет [https://cloud.vk.ru/pricelist](https://cloud.vk.ru/pricelist) (если иное не согласовано в соглашении об использовании соответствующего Сервиса). Компания может в одностороннем порядке изменять стоимость услуг по предоставлению доступа к Сервисам путем опубликования соответствующей информации на Сайте. Новые тарифы вступают в силу с даты, указанной при их публикации.

Стоимость использования программных продуктов, размещенных в каталоге Магазина приложений на Платформе, доступна на странице Магазина приложений или на странице конкретного Программного продукта в Магазине Приложений. Стоимость использования Программных продуктов может в одностороннем порядке изменяться Компанией или Владельцем Программного продукта путем опубликования соответствующей информации на странице Магазина приложений или на странице конкретного Программного продукта. Иные условия использования Программных продуктов, размещенных в Магазине приложений, регулируются Пользовательским соглашением «Магазина приложений», размещенным по адресу: [https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud/marketplace](/ru/start/legal/archive/digital-cloud/marketplace) или соглашением об использовании отдельного Программного продукта.

8.2.2. В случае изменения налогового законодательства РФ в части установления новых ставок налога на добавленную стоимость (НДС) Стороны соглашаются применять к отношениям Сторон такие изменения автоматически с даты их вступления в силу путем изменения действующих тарифов (стоимости услуг) на размер изменения ставок НДС. При этом Стороны признают, что изменение стоимости услуг в связи с изменением ставки НДС применяется начиная с даты вступления в силу соответствующих изменений налогового законодательства РФ без необходимости заключения Сторонами дополнительного соглашения и без предварительного уведомления Заказчика.
...
9.3.1. Компания примет решение об изменении условий настоящего Соглашения, о необходимости заключения с Заказчиками нового соглашения, прекращении настоящего Соглашения в отношении Заказчика, прекращении администрирования и обслуживания Платформы и прекращении к ней доступа или прекращения доступа к использованию Платформы в отношении Заказчика.

9.3.2. Компания вправе в любое время без уведомления Заказчика и без объяснения причин прекратить Соглашение в одностороннем внесудебном порядке с немедленным прекращением доступа и возможности использовать Платформу и без возмещения каких-либо затрат, убытков или возврата, полученного по Соглашению, в том числе, но не ограничиваясь, в случае:
...
10.1. Компания предпринимает коммерчески обоснованные усилия для обеспечения функционирования Платформы и Сервисов, предоставляемых Компанией, в круглосуточном режиме, однако не гарантирует отсутствие перерывов, связанных с техническими неисправностями, проведением профилактических работ, а также не гарантирует полную или частичную работоспособность их отдельных элементов. Соглашения об использовании отдельных сервисов могут предусматривать условия о гарантиях уровня сервиса. Компания не гарантирует, что Платформа, Сервисы или любые их элементы будут функционировать в любое конкретное время в будущем или что они не прекратят работу. Компания не несет ответственности за качество и функционирование Сервисов, предоставляемых Партнерами.

10.2. Функции Платформы, Сервисов, включая все скрипты, контент, отдельные элементы и оформление Платформы и Сервисов предоставляются «как есть». Компания не предоставляет никаких гарантий того, что Платформа, Сервисы или их элементы могут подходить для конкретных целей использования. Компания не может гарантировать и не обещает никаких специфических результатов от использования Платформы, Сервисов и их отдельных элементов. В случае если право использования Платформы и Сервисов, предоставляемых Компанией, является безвозмездным, Компания не несет какой-либо ответственности относительно каких-либо функций Платформы, Сервисов, включая все скрипты, контент, отдельные элементы и оформление Платформы и Сервисов.

10.3. Компания не несет ответственности за информационную безопасность инфраструктуры Заказчика, созданной с использованием Сервисов Компании.

10.4. Сервисы предоставляются Заказчику в соответствии с общепринятым в международной практике принципом «AS IS» («Как есть»). Это означает, что за проблемы, ошибки, сбои, возникающие в процессе использования Сервисов, в том числе за проблемы совместимости Сервисов с любыми другими программными продуктами, проблемы, возникающие из-за неоднозначного толкования документации на Сервисы, несоответствия результатов использования Сервисов ожиданиям Заказчика, и т.п., Компания ответственности не несет.

10.5. Компания не осуществляет администрирование и поддержку операционных систем и иных сервисов, созданных с использованием Сервисов Платформы, если иное прямо не согласовано Сторонами в отдельном соглашении.

10.6. Компания не несет ответственности и не возмещает никакие убытки Заказчика, возникшие в результате приостановки, ограничения или прекращения доступа Заказчика, Пользователей к Платформе или отдельным Сервисам, в случае нарушения Заказчиком или Пользователем законодательства Российской Федерации, Применимых правил или Правил для конечных пользователей, а также в случае получения соответствующих запросов/указаний уполномоченных государственных органов Российской Федерации. Денежные средства, полученные Компанией в счет предварительной оплаты услуг, не подлежат возврату Заказчику и удерживаются Компанией в полном объеме в качестве штрафа за допущенное нарушение и возмещения убытков, понесенных Компанией в связи с такими нарушениями.


## 11. Прочие условия. Заключительные положения

11.1. Заказчик настоящим предоставляет Компании согласие на использование наименования, логотипа и/или иного обозначения Заказчика (далее совместно – «Обозначение») в маркетинговых целях. Такое использование включает размещение Обозначения на Сайте Компании в разделе списка клиентов, а также использование в иных маркетинговых и информационных материалах Компании для подтверждения сотрудничества Сторон и демонстрации наличия опыта Компании в реализации проектов для Заказчика. Согласие на использование Обозначения не является предоставлением лицензии и не дает Заказчику права на получение вознаграждения или иной компенсации за такое использование. Заказчик заверяет и гарантирует, что он обладает всеми необходимыми правами на Обозначение и вправе предоставлять Компании соответствующее согласие на его использование в объеме и целях, предусмотренных настоящим пунктом.
Заказчик вправе в любой момент направить Компании письменное уведомление о своем несогласии с дальнейшим использованием Обозначения. В таком случае Компания обязуется прекратить использование Обозначения в течение 7 (семи) рабочих дней с даты получения соответствующего уведомления от Заказчика.
...
11.3. Настоящее Соглашение и взаимоотношения Сторон в связи с настоящим Соглашением и использованием Сервиса регулируются законодательством Российской Федерации.
...
Заказчик вправе отказаться от передачи прав и обязанностей по Соглашению Правопреемнику до истечения указанного в настоящем пункте Периода уведомления, путем направления Компании соответствующего уведомления на электронный адрес [docs_vktech@vk.company](mailto:docs_vktech@vk.company). Такое уведомление считается действительным в случае его отправки с адреса электронной почты Владельца Проекта. В указанном случае действие настоящего Соглашения прекращается с момента получения Компанией такого уведомления.
