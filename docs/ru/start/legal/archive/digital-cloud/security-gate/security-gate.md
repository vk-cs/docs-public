...
Действующая редакция настоящего Соглашения доступна в сети Интернет по адресу: https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloudal-cloud/security-gate. Любая измененная редакция Соглашения вступает в силу с момента его опубликования по вышеуказанному адресу.
...
1\.6. **Правообладатель** — лицо, обладающее исключительным правом на ПО.
...
6\.2.5. периодически знакомиться с содержанием настоящего Соглашения в сети Интернет по адресу: https://cloud.vk.ru/docs/ru/start/legal/archive/digital-cloud и следить за внесенными в него изменениями;
