Настоящее Соглашение об участии в исследовании (тестировании) (далее — Соглашение) размещается в сети Интернет по адресу: [https://cloud.vk.com/docs/ru/start/legal/vk/research-agreement](/ru/start/legal/vk/research-agreement) (далее — ссылка) и доступно на странице формы по ссылке [https://cloud.vk.com/uxlab/research_form/](https://cloud.vk.com/uxlab/research_form/) и заключается только с теми лицами, которым предварительно от имени ООО «ВК» была предоставлена указанная ссылка.
