...
Действующая редакция настоящего Соглашения доступна в сети Интернет по адресу: [https://cloud.vk.com/docs/start/legal/vk/policy-cloud-desktop](/ru/start/legal/vk/policy-cloud-desktop). Редакция Соглашения вступает в силу с момента его опубликования по вышеуказанному адресу.
...
7.2.5. периодически знакомиться с содержанием настоящего Соглашения в сети Интернет по адресу: [https://cloud.vk.com/docs/start/legal/vk/policy-cloud-desktop](/ru/start/legal/vk/policy-cloud-desktop) и следить за внесенными в него изменениями;
