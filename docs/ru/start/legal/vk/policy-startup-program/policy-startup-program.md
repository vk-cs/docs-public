...
Для Участников, зарегистрировавших Учетную запись на Платформе VK Cloud 01.02.2025 года и позднее, действуют Правила программы поддержки стартапов, размещенные в сети Интернет по адресу: [https://cloud.vk.ru/docs/start/legal/digital-cloud/policy-startup-program](/ru/start/legal/digital-cloud/policy-startup-program).
...
**Правила** — настоящий документ, являющийся публичной офертой, размещенный в сети Интернет по адресу: [https://cloud.vk.ru/docs/start/legal/vk/policy-startup-program](/ru/start/legal/vk/policy-startup-program).
