...
**Правила** — настоящий документ, являющийся публичной офертой, размещенный в сети Интернет по адресу: [https://cloud.vk.com/docs/ru/start/legal/vk/policy-vkma-program](/ru/start/legal/vk/policy-vkma-program)
...
8.4. Новая редакция Правил вступает в силу с момента ее опубликования в сети «Интернет» по адресу: [https://cloud.vk.com/docs/ru/start/legal/vk/policy-vkma-program](/ru/start/legal/vk/policy-vkma-program).
