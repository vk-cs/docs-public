...
Настоящий документ представляет собой соглашение (далее — «Соглашение»), регулирующее отношения между ООО «ВК» (далее — «Компания») и Вами (далее — «Заказчик») в связи с оказанием различного вида услуг, доступ к которым предоставляется через Платформу «VK Cloud» (далее — «Платформа»), на условиях, изложенных ниже:
...
- использовать Сервисы для организации прокси-серверов и маскирования трафика путем перебора IP-адресов сверх доступных квот в Проекте Заказчика;
- размещать с использованием Платформы и Сервисов информационные ресурсы, посредством которых обеспечивается доступ к информации или информационным ресурсам в сети «Интернет», доступ к которым ограничен на территории Российской Федерации;
- использовать Сервисы для обхода ограничений доступа к информации или информационным ресурсам в сети Интернет, доступ к которым подлежит ограничению в соответствии с законодательством Российской Федерации;
...
11.6. **Действие Соглашения и Применимых правил в случае приобретения услуг через реселлеров**

11.6.1. В случае, если Заказчик приобретает услуги Компании посредством заключения отдельного договора с третьим лицом (авторизованным партнером Компании (далее – «Реселлер»)), настоящее Соглашение, а также все иные Применимые правила в редакции, размещенной в сети интернет по ссылке: [https://cloud.vk.ru/docs/ru/start/legal/vk](https://cloud.vk.ru/docs/ru/start/legal/vk) действуют:

- до «30» июня 2025 года или
- до даты заключения дополнительного соглашения о внесении изменений в договор, заключенный между Заказчиком и Реселлером, в связи с обновлением редакции Применимых правил,

в зависимости от того, какая из дат наступит ранее.

11.6.2. Заказчик настоящим соглашается, что после наступления обстоятельств, указанных в пункте 11.6.1. Соглашения, в отношении Заказчика будет действовать обновленная редакция Применимых правил, размещенная в сети интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud](https://cloud.vk.ru/docs/ru/start/legal/digital-cloud). При этом вместо ООО «ВК» стороной по Соглашению будет являться ООО «Цифровое Облако».

11.7. Все споры сторон по настоящему Соглашению подлежат разрешению путем переписки и переговоров с использованием обязательного досудебного (претензионного) порядка. В случае невозможности достичь согласия между сторонами путем переговоров в течение 60 (шестидесяти) календарных дней с момента получения другой Стороной письменной претензии, рассмотрение спора должно быть передано любой заинтересованной стороной в суд по месту нахождения Компании (с исключением подсудности дела любым иным судам), если иное не предусмотрено применимым законодательством.

11.8. Если иное прямо не указано в отдельных положениях настоящего Соглашения, по вопросам, связанным с исполнением Соглашения, просьба обращаться по адресу местонахождения Компании: Российская Федерация, 125167 г. Москва, Ленинградский проспект, д. 39, стр. 79, или по электронному адресу [support@mcs.mail.ru](mailto:support@mcs.mail.ru).
