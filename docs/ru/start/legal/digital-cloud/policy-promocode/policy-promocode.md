...
1.3. **Применимые правила** — правила использования Платформы и её отдельных Сервисов, расположенные по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud](/ru/start/legal/digital-cloud) и изложенные в следующих документах:
...
Настоящие Правила размещены по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud/policy-promocode](/ru/start/legal/digital-cloud/policy-promocode) и являются неотъемлемой частью Применимых правил.
