Настоящее Соглашение об участии в исследовании (тестировании) (далее — Соглашение) размещается в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud/research-agreement](/ru/start/legal/digital-cloud/research-agreement) (далее — ссылка) и доступно на странице формы по ссылке [https://cloud.vk.ru/uxlab/research_form/](https://cloud.vk.ru/uxlab/research_form/) и заключается только с теми лицами, которым предварительно от имени ООО «Цифровое Облако» была предоставлена указанная ссылка.
...
3.1. Настоящее Соглашение заключается путем заполнения формы, размещенной по ссылке [https://cloud.vk.ru/uxlab/research_form/](https://cloud.vk.ru/uxlab/research_form/), и нажатия на кнопку «Отправить», расположенную под формой заполнения. После совершения указанных действий заполненная форма будет автоматически направлена на электронный почтовый ящик [uxlab@mcs.mail.ru](mailto:uxlab@mcs.mail.ru).
...
| |                                                                                                               |
| --- |---------------------------------------------------------------------------------------------------------------|
| Сокращенное наименование предприятия | ООО «Цифровое Облако»                                                                                         |
| ИНН                                  | 7751169490                                                                                                    |
| ОГРН                                 | 1197746546568                                                                                                 |
