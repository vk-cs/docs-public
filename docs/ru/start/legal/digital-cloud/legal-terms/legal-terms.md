...
- настоящем Соглашении, размещенном в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud/legal-terms](/ru/start/legal/digital-cloud/legal-terms);
- соглашениях об использовании отдельных Сервисов, предоставляемых Компанией или Партнерами Компании, размещенных в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud](/ru/start/legal/digital-cloud);
- Политике конфиденциальности Компании, размещенной в сети Интернет по адресу: [https://cloud.vk.ru/docs/ru/start/legal/digital-cloud/policy-privacy](/ru/start/legal/digital-cloud/policy-privacy).
