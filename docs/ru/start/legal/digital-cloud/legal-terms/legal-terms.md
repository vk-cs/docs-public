...
4.5. Компания не несет ответственности за информационную безопасность инфраструктуры Заказчика, созданной с использованием Сервисов Компании.
