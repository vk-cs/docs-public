...
- Компоненты [программного продукта Termidesk](https://termidesk.ru/), который позволяет ускорить подключение к рабочим столам пула.
    ...
    Для установки Termisdesk выполните команды в приложении Windows PowerShell:
    ...
    Для установки Termisdesk выполните команды в терминале:
...
[Узнайте](/ru/manage/cloud-desktops/use-cases/check-desktop-image), как проверить собственный образ рабочего стола на совместимость с сервисом Cloud Desktops.
