...
Полный список готовых образов доступен в личном кабинете в [окне создания новой виртуальной машины](https://msk.cloud.vk.ru/app/services/infra/servers/add).
...
Вы можете {linkto(../../../../computing/iaas/instructions/images/images-manage#iaas-images-manage-import)[text=импортировать образ]} из файла через личный кабинет в [окне создания нового образа](https://msk.cloud.vk.ru/app/services/infra/images) или с использованием CLI.
