...
Начните работу с сервисом [VK Object Storage](https://cloud.vk.ru/storage/) любым удобным способом:
...
- Пройдите [урок](https://cloud.vk.ru/cloud-native-courses/advanced/cloud-storage-s3/) бесплатного курса. В теоретической части урока рассмотрены общие характеристики, компоненты и функции {var(s3)}. В практической части вы создадите бакет и подключите его к Wordpress для хранения медиафайлов.
...
Пройдите [урок](https://cloud.vk.ru/cloud-native-courses/advanced/cloud-storage-s3/) бесплатного курса.
