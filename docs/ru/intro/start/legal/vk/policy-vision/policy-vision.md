...
3.7. Программа входит в перечень инструментов Экосистемы VK. С перечнем инструментов Экосистемы VK можно ознакомиться здесь: [https://vk.com/vk_ecosystem_tools](https://vk.com/vk_ecosystem_tools).
