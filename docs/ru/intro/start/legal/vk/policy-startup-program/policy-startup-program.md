...
**Правила** — настоящий документ, являющийся публичной офертой, размещенный в сети Интернет по адресу: [https://cloud.vk.com/docs/intro/start/legal/vk/policy-startup-program](/ru/intro/start/legal/vk/policy-startup-program).
...
4.1. Для участия в Программе необходимо подать заявку на Сайте [https://cloud.vk.com/startup](https://cloud.vk.com/startup). Подать заявку можно до 31 января 2025 года включительно.
