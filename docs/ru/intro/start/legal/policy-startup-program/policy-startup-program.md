...
**Прайс-лист** — интернет-страница https://cloud.vk.com/pricelist с указанием стоимости Сервисов Платформы VK Cloud.
...
2.1. Программа действует с 7 августа 2023 года по 31 января 2025 года включительно. В течение указанного периода времени Пользователь вправе подать заявку на участие в Программе.
...
4.1. Для участия в Программе необходимо подать заявку на Сайте https://cloud.vk.com/startup. Подать заявку можно до 31 января 2025 года включительно.
...
В течение 6 (шести) месяцев с даты одобрения Заявки на участие в Программе Участнику Программы предоставляется право использования сервисов VK WorkSpace со скидкой 50% от базовой стоимости тарифа «Выгодный» (описание тарифа доступно по ссылке https://biz.mail.ru/tariffs/). В подписку входит следующий набор инструментов VK WorkSpace: почта для бизнеса, календарь, мессенджер с видеозвонками, диск и редактор документов.
По истечении 6 (шести) месяцев с даты присвоения статуса Участника Пользователь выбирает доступный на сайте https://biz.mail.ru/tariffs/ тариф использования сервисов VK Workspace и оплачивает его в полном объеме на стандартных условиях.
