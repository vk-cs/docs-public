...
**Применимые правила** — настоящее Соглашение, доступное в сети Интернет по адресу: [https://cloud.vk.com/docs/intro/start/legal/policy-1cgrm](/ru/intro/start/legal/policy-1cgrm), содержащее в себе условия доступа и использования Сервиса а также следующие документы, в объеме, необходимом для использования Сервиса:

1. Условия использования Платформы «VK Cloud» ([https://cloud.vk.com/docs/intro/start/legal/legal-terms](/ru/intro/start/legal/legal-terms));
2. Политика конфиденциальности Компании ([https://cloud.vk.com/docs/intro/start/legal/policy-privacy](/ru/intro/start/legal/policy-privacy)).
...
5.1. Размер ответственности Компанию ограничен исключительно соответствующими Применимыми правилами, размещенным на Сайте в разделе [https://cloud.vk.com/docs/ru/intro/start/legal](/ru/intro/start/legal).
