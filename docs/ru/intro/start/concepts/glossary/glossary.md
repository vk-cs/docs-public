...
- [Cloud Servers](/ru/computing/iaas/concepts).
...
В VK Cloud количество процессоров и объем оперативной памяти ВМ задаются с помощью шаблонов конфигураций. Пользователям доступны готовые [шаблоны конфигураций](/ru/computing/iaas/concepts/vm/flavor), а также индивидуальные конфигурации (по запросу).
