# {heading(Сертификаты, лицензии и аттестаты для ООО «ВК»)[id=it-security-vk-certificates]}

Ниже приведен перечень сертификатов, лицензий и аттестатов платформы {var(cloud)} с указанием соответствия нормативным документам, выданных ООО «ВК».
...
## {heading(Аттестат соответствия требованиям по защите информации)[id=it-security-vk-certificates-certificate]}
...
## {heading(Лицензии на деятельность по защите информации, по разработке и производству средств защиты информации)[id=it-security-vk-certificates-info-protect-licenses]}
...
## {heading(Лицензии на оказание услуг связи)[id=it-security-vk-certificates-communication-services-licenses]}
...
## {heading(Заключение о соответствии требованиям Банка России)[id=it-security-vk-certificates-bank-requirements-compliance]}
...
## {heading(Сертификаты ЦОД)[id=it-security-vk-certificates-dc-certificates]}

**Сертификаты соответствия уровню TIER-III центров обработки данных {var(cloud)}**.
...
## {heading(Сертификаты безопасности)[id=it-security-vk-certificates-security-certificates]}
