...
- пользователем самостоятельно после [регистрации](/ru/intro/onboarding/account);
...
Да, применяется. Подробнее в разделе [Ролевая модель управления доступом](/ru/access/iam/concepts/rolesandpermissions).
...
Подробная информация размещена в разделе [Группы безопасности](/ru/networks/vnet/instructions/secgroups).
