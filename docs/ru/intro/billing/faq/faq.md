...
12 января 2026 года начнет действовать новый прайс-лист. Подробности об изменениях будут в рассылке и [блоге VK Cloud](https://cloud.vk.com/blog/).
...
Бонусы начисляются на бонусный счет проекта VK Cloud. Тип бонусов соответствует тем сервисам и объектам VK Cloud, на оплату которых можно потратить эти бонусы.

Подробнее — в разделе [Бонусы](../concepts/balance#bonuses).
...
Если [баланс лицевого счета](/ru/intro/billing/concepts/balance#rashod_sredstv_i_otricatelnyy_balans_licevogo_scheta) проекта отрицательный, создание новых ресурсов приостанавливается — даже при наличии бонусных средств.
...
- Ваша [роль](/ru/access/iam/concepts/rolesandpermissions) в проекте — владелец, суперадминистратор или администратор биллинга.
...
{cut(Как отключить подписки VK Cloud?)}
...
1. [Установите](/ru/intro/billing/instructions/payment#uvedomleniya_o_rashodah) уведомления о достижении лимита расходов.
1. [Анализируйте](/ru/intro/billing/instructions/detail) детализированный отчет о потреблении.
...
Да, все услуги VK Cloud, включая объектное хранилище, доступны для оплаты юридическими лицами. Вы можете [пополнять баланс](/ru/intro/billing/instructions/payment) по счету.

{/cut}

{cut(Как проанализировать затраты?)}

[Скачайте](/ru/intro/billing/instructions/detail#download-report) гранулярный отчет. Он показывает сумму расходов по каждому параметру с группировкой по дням.
