...
[Скачайте](ru/intro/billing/instructions/detail#skachivanie_otcheta) гранулярный отчет. Он показывает сумму расходов по каждому параметру с группировкой по дням.
