...
Суммы меньше копейки округляются вверх до 1 копейки, в том числе при расчете итоговой стоимости, в [детализации](../instructions/detail) и для [отчетных документов](../concepts/report).
