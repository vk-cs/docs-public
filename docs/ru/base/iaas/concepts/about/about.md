...
| ceph-hdd
| `MS1`, `GZ1`, `ME1`
| Обычный магнитный жесткий диск. Подходит для хранения больших объемов информации. Тройная репликация на разные серверы СХД.
...
| Сетевой High-IOPS SSD
| high-iops
| `MS1`, `GZ1`, `ME1`
| SSD с повышенной скоростью работы. Двойная репликация: обе копии находятся на одном сервере СХД.

| Локальный Low Latency NVME
| ef-nvme
| nova
