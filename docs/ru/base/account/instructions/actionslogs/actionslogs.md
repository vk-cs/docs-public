...
Чтобы получить последние 2 записи из журнала компонента Nova за заданный интервал времени, выполните запрос:
...
Чтобы вывести все записи журнала компонента Nova за заданный интервал времени в файлы порциями по 10 записей в файле:

1. Запросите вывод в файл `nova_part1.log` 10 последних записей журнала в нужном интервале времени:
...
4. Повторяйте предыдущий запрос, меняя в нем только имя файла (например: `nova_part3.log`, `nova_part4.log`, …), пока не получите все записи журнала за нужный интервал времени.
