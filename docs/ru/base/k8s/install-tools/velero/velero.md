...
1. Убедитесь, что:
   ...
   - либо [включено автоматическое масштабирование](../../operations/scale#nastroyka_avtomaticheskogo_masshtabirovaniya_grupp_worker_uzlov_1f8b2c54).
...
1. [Создайте hotbox-бакет](../../../s3/instructions/buckets/create-bucket/) для хранения резервных копий в сервисе [Cloud Storage](../../../s3).
1. [Создайте аккаунт](../../../s3/access-management/s3-account) в сервисе [Cloud Storage](../../../s3).
