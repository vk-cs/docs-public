...
Количество запускаемых подов на ноде влияет на производительность кластера. Максимально можно запустить 110 подов, но для лучшей производительности ноды планируйте 30-40 подов на одну ноду.
