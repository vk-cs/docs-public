...
В кластерах Kubernetes VK Cloud версий 1.23 и выше можно [создать](../../../operations/manage-security#dobavlenie_politiki_bezopasnosti) нужную [политику безопасности](../../../concepts/security-policies#razreshennye_repozitorii_bb3393ca) через личный кабинет.
...
1. Убедитесь, что [синхронизация политик безопасности](../../../concepts/security-policies#rabota_s_politikami_bezopasnosti_cherez_lichnyy_kabinet) с кластером [выключена](../../../operations/manage-security#upravlenie_sinhronizaciey_politik_bezopasnosti_s_klasterom).
