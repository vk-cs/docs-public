# {heading(Управление питанием)[id=bare-metal-power]}

## {heading(Включение)[id=bare-metal-power-turn-on]}
...
## {heading(Выключение)[id=bare-metal-power-turn-off]}
...
## {heading(Перезагрузка)[id=bare-metal-power-reboot]}
