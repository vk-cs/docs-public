...
В рамках {var(cloud)} поддерживается установка виртуальных машин с поддержкой образов от компании [РЕД ОС](https://redos.red-soft.ru).
...
## {heading(Условия использования)[id=vm-licenses-red-os-use-conditions]}
...
## {heading(Цена)[id=vm-licenses-red-os-price]}
