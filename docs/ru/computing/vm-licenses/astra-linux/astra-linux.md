# {heading(Астра Линукс)[id=vm-licenses-astra-linux]}

В рамках {var(cloud)} поддерживается установка виртуальных машин с поддержкой образов от компании [Астра Линукс](https://astralinux.ru).
...
## {heading(Условия использования)[id=vm-licenses-astra-linux-use-conditions]}
...
## {heading(Цена)[id=vm-licenses-astra-linux-price]}
