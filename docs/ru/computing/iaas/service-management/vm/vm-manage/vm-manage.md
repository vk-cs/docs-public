...
Пароль [учетной записи по умолчанию](../../../concepts/about#default_account) нужно установить самостоятельно при первой авторизации в OC. Установленный пароль можно будет изменить.
