...
8. Если необходимо, включите опцию **Использовать резервное копирование** и [задайте](/ru/storage/backups/service-management/create-backup-plan#create_vm_backup_plan) нужные настройки.
