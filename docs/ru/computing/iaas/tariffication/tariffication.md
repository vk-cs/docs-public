...
- [Образы](../concepts/image-vm) диска, которые вы создали или импортировали в VK Cloud. Цена зависит от места хранения:
  ...
  - Хранение в [VK Object Storage](/ru/storage/s3) (по умолчанию) — по [тарифу Hotbox](/ru/storage/s3/tariffication) за каждый 1 ГБ объема образа и за каждый 1 ГБ скачивания образа, например при создании ВМ.
