...
2. [Создайте](../../instructions/volumes/volumes-create) и [подключите](../../instructions/volumes/volumes-connect#mount_disk) диск к ВМ.
...
1. Сделайте диск [незагрузочным](../../instructions/volumes/volumes-manage#changing_bootable_attribute).
