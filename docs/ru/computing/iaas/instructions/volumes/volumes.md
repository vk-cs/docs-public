...
## {heading(Замена основного (root) диска)[id=mount_root_disk]}
...
Следует учитывать, что ВМ не может быть без основного (root) диска. Для удаления подобного диска сначала [замените root-диск](#mount_root_disk), [отключите старый диск](#dismount_disk) от ВМ и затем [удалите старый диск](#delete_disk).
