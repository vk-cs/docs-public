...
Следует учитывать, что ВМ не может быть без основного (root) диска. Для удаления подобного диска сначала [замените root-диск](#zamena_osnovnogo_root_diska), [отключите старый диск](#dismount_disk) от ВМ и затем [удалите старый диск](#delete_disk).
