...
Если экспортированный образ не в формате RAW и вы планируете использовать его для создания ВМ на платформе VK Cloud, [выполните конвертацию образа](../../../how-to-guides/packer#1_konvertiruyte_obraz_v_format_raw).
