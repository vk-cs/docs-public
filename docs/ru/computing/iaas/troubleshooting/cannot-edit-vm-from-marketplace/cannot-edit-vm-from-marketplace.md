...
1. [Создайте](/ru/computing/iaas/instructions/volumes/volumes-snapshots#iaas-volumes-snapshots-vm-create) новую ВМ из этого снимка, выбрав нужный [шаблон конфигурации](/ru/computing/iaas/concepts/vm/flavor) с большим объемом памяти.
