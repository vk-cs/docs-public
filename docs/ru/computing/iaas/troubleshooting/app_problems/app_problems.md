...
1. Проверьте статус ВМ в {ifdef(public)}[личном кабинете {var(cloud)}](https://msk.cloud.vk.ru/app/){/ifdef}{ifdef(private,private-pg)}{linkto(../../../../tools-for-using-services/account/instructions/lk-entry#tools-account-lk-entry)[text=личном кабинете {var(cloud)}]}{/ifdef} в разделе **Облачные вычисления** → **Виртуальные машины**. Убедитесь, что статус ВМ — `Активный`.
