...
VK Cloud обеспечивает виртуальные машины входящим и исходящим каналами связи с интернетом с пропускной способностью 1 Гбит/с без ограничений по трафику.
