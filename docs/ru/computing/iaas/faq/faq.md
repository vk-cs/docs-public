...
Да, вы можете подключить ISO-образ к ВМ, чтобы установить ОС вручную.

Подробнее про ISO-образы — в разделах [Режим аварийной загрузки ВМ](/ru/computing/iaas/troubleshooting/vm-rescue-mode) и [Создание образа ВМ с ОС Windows](/ru/computing/iaas/how-to-guides/win-image).
{/cut}
