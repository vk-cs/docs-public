...
1. [Создайте](/ru/computing/iaas/instructions/volumes#snimki_diska) снимок диска ВМ.
1. [Создайте](/ru/computing/iaas/instructions/volumes#use_snapshots) новую виртуальную машину из снимка.
...
[Отключите диск от ВМ](../instructions/volumes#dismount_disk), и кнопка станет доступна в контекстном меню диска и на странице самого диска.
