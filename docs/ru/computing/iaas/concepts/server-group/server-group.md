# {heading(Группы серверов)[id=iaas-server-group]}
...
Поддерживаются следующие политики размещения групп серверов на вычислительных узлах (compute nodes) {var(cloud)}:
