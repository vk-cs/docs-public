Файловое хранилище — это виртуальная файловая система, которую можно подключить к нескольким виртуальным машинам и использовать для совместного доступа к данным. При [создании файлового хранилища](../../../instructions/fs-manage/fs-create) указывается протокол сетевого доступа к нему (NFS или CIFS).
