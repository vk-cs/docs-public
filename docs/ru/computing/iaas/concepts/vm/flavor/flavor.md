...
| ВМ с выделенным [графическим ускорителем](../../../../gpu/concepts/about)
...
| ВМ с [графическим ускорителем](../../../../gpu/concepts/about) на базе [технологии vGPU](/ru/computing/gpu/concepts/vgpu)
| Отображаются при заказе соответствующих типов ВМ через сервис [Cloud GPU](https://cloud.vk.com/cloud-gpu/)
