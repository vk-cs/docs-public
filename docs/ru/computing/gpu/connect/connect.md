Перед началом использования необходимо оставить заявку на [сайте](https://cloud.vk.com/cloud-gpu/). Нажмите «Оформить заявку». Заполните форму и нажмите «Отправить».
