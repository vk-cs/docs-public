# {heading(Настройка двухфакторной аутентификации)[id=desktops-setup-saml]}
...
1. {linkto(../../../../../computing/cloud-desktops/instructions/config/setup-ldap#desktops-setup-ldap)[text=Настройте]} службу каталогов пользователей AD или LDAP.
...
1. Подготовьте поставщика удостоверений SAML для интеграции с сервисом Cloud Desktop. Порядок настройки зависит от выбранного SAML-провайдера.
   ...
   {note:info}
   Пример настройки поставщика удостоверений SAML приведен в разделе {linkto(../../../../../computing/cloud-desktops/how-to-guides/keycloak#desktops-keycloak)[text=Интеграция с Keycloak]}.
   {/note}
