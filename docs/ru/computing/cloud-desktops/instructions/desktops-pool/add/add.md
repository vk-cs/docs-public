...
1. Если для создания пула виртуальных машин вы хотите использовать собственный образ, убедитесь, что он соответствует [требованиям](/ru/computing/cloud-desktops/concepts/desktop-image#custom-image-requirements).

   Подготовить образ можно любым удобным способом, например, воспользовавшись одним из [практических руководств](/ru/computing/iaas/how-to-guides).
...
1. Задайте настройки виртуальных машин, на которых будут создаваться рабочие столы пула:
    ...
    - **Образ**: выберите образ для создания ВМ из списка доступных образов.
      ...
      При необходимости нажмите кнопку **Загрузить свой образ** и загрузите ранее подготовленный образ, следуя [инструкции по импорту](/ru/computing/iaas/instructions/images/images-manage#import_obraza).
