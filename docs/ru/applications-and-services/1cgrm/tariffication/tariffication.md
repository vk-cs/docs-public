...
Для всех {linkto(../../../applications-and-services/1cgrm/concepts/about#1cgrm-description)[text=программных продуктов 1С]} доступен пробный период, в рамках которого сервис предоставляется без ограничений на срок в 30 дней. Пробный период подключается автоматически при создании приложения. Во время пробного периода с [баланса](https://cloud.vk.com/docs/ru/intro/billing/concepts/balance) не списываются средства, и в [личном кабинете](https://msk.cloud.vk.com/app/services/billing) в разделе **Баланс** этот сервис не отображается.
