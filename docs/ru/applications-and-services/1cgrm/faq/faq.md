# {heading(Вопросы и ответы)[id=1cgrm-faq]}
...
{var(cloud)} не ограничивает количество создаваемых приложений 1С:ГРМ.
...
Вся инфраструктура разворачивается автоматически. {var(cloud)} предоставляет HTTP-ссылку на готовую к работе базу 1С. Вы можете войти в нее при помощи браузера или тонкого клиента 1С. Доступ на уровне инфраструктуры и операционной системы не предусмотрен.
...
Для отключения подписки на 1С:ГРМ напишите письмо на почту [support.1c.grm@mcs.mail.ru](mailto:support.1c.grm@mcs.mail.ru) или {linkto(../../../applications-and-services/1cgrm/instructions/app-manage#1cgrm-app-manage-deleting)[text=удалите]} приложение, созданное в {var(cloud)}.
