...
|
Оплата за сервис списывается раз в отчетный период в дату подключения сервиса или дату смены тарифного плана. Длительность отчетного периода и дата списания настраиваются в конфигурации сервиса (подробнее — в разделах {linkto(/ru/applications-and-services/marketplace/vendor/ibservice_add/ibservice_configure/ibplan/#ibplan)[text=%text]}, {linkto(/ru/applications-and-services/marketplace/vendor/saas_add/saas_configure/saas_plan/#saas_plan_param)[text=%text]}).
