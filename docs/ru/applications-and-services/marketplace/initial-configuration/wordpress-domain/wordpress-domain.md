# {heading(Изменение домена для сервиса WordPress)[id=marketplace-wordpress-domain]}
...
## {heading(1. Измените доменное имя на сервере)[id=marketplace-wordpress-domain-edit-name-on-server]}
...
## {heading(2. Измените доменное имя в настройках WordPress)[id=marketplace-wordpress-domain-edit-name-in-settings]}
...
## {heading(3. Проверьте корректность работы сайта)[id=marketplace-wordpress-domain-check-correct]}
...
## {heading(4. Усильте безопасность сайта)[id=marketplace-wordpress-domain-increase-security]}
...
## {heading(5. Обновите ссылки на ваш сайт)[id=marketplace-wordpress-domain-update-links]}
