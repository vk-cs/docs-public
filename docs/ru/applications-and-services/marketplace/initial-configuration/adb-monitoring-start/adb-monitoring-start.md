...
1. В [настройках подсети](/ru/networks/vnet/service-management/net#redaktirovanie_podseti), где будет размещена ВМ инстанса Arenadata DB Monitoring, отключите опцию **Приватный DNS**.
