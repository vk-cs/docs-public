# {heading(Развертывание Joomla)[id=marketplace-joomla-start]}
...
Используя Joomla, вы соглашаетесь с лицензионными соглашениями [Marketplace](../../../../start/legal/digital-cloud/marketplace) и [Joomla](https://github.com/binhnk0791/joomla/blob/master/LICENSE.txt).
...
1. Введите данные на странице **Параметры сервера**.
   ...
   1. Включите мониторинг, чтобы автоматически отправлять в сервис {linkto(../../../../monitoring-services/monitoring#monitoring)[text=Cloud Monitoring]} метрики виртуальной машины, на которой развернут сервис Joomla. Эти метрики будут доступны в разделе **Мониторинг** личного кабинета.
   ...
   1. **Включить резервное копирование на S3**: включите опцию, чтобы ежедневно создавать резервные копии данных Joomla в {linkto(../../../../storage/s3/concepts/about#s3-concepts-about)[text=объектном хранилище]} {var(cloud)}. Хранилище создается автоматически. Сохраняются последние 7 копий.
