Сервис VPN доступен в Neutron и Sprut [SDN](../../concepts/architecture#ispolzuemye_sdn). Управление VPN-туннелями в Sprut SDN доступно только через интерфейс личного кабинета.
