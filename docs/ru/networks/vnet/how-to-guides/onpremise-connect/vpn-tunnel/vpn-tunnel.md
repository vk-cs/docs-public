...
1. [Создайте](/ru/networks/vnet/instructions/secgroups#sozdanie_gruppy_bezopasnosti) группу безопасности `icmp`, разрешающую ICMP-трафик.
...
1. [Создайте](/ru/computing/iaas/instructions/vm/vm-create) две виртуальные машины:
