...
Максимальное количество не привязанных к виртуальным машинам Floating IP-адресов — 1.
...
Максимальное количество не привязанных к виртуальным машинам Anycast IP-адресов — 1.
