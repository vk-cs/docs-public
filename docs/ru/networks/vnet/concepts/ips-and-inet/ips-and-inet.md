...
Количество Floating IP-адресов на одном проекте ограничено [квотами](/ru/tools-for-using-services/account/concepts/quotasandlimits#seti_podseti_i_ip_adresa_a84cb9f0).
...
_Anycast_ — это метод маршрутизации, при котором один IP-адрес назначается нескольким серверам в разных [зонах доступности](/ru/start/concepts/architecture#az). При этом трафик через Anycast IP-адрес автоматически направляется к ближайшему или наименее загруженному узлу на основе метрик BGP.
...
Количество Anycast IP-адресов на одном проекте ограничено [квотами](/ru/tools-for-using-services/account/concepts/quotasandlimits#drugie_parametry_d0a7c3d3).
