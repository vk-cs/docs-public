...
SDN — инструмент управления overlay-сетями (виртуальная сеть поверх физической) и основа облачной инфраструктуры. SDN обеспечивает маршрутизацию, управление правилами ограничения трафика и сетевую связность между сервисами.
