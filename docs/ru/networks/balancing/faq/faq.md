...
{cut(Есть ли возможность подключить баласировщик от 10 Гбит/с?)}

Для высоконагруженных систем от 10 Гбит/с требуется использование выделенного балансировщика с индивидуальным шаблоном конфигурации (_flavor_). Подробнее в статье [Создание балансировщика нагрузки с индивидуальным шаблоном конфигурации](/ru/networks/balancing/how-to-guides/private-flavor).
