# {heading(Управление правилами балансировки)[id=balancing-manage-rules]}
...
## {heading(Добавление правила)[id=balancing-manage-rules-add]}
...
1. Задайте параметры правила:
   ...
   - **Отправлять заголовок X-Forwarded-For** (только для протоколов балансировки HTTP и TERMINATED_HTTPS): опция, позволяющая включить отправку на бэкенд соответствующего HTTP-заголовка. По умолчанию опция выключена.
   ...
   - **Сертификат** (только для протокола TERMINATED_HTTPS): сертификат, который будет использоваться балансировщиком для терминирования SSL-соединения.
...
1. Чтобы создать правило балансировки:
   ...
   1. {linkto(../../../../networks/balancing/instructions/manage-lb#balancing-manage-lb-list)[text=Получите идентификатор балансировщика нагрузки]}, для которого нужно создать правило.
   ...
   1. Определите IP-адреса виртуальных машин, которые будут участниками (members) пула. Также {linkto(../../../../networks/vnet/instructions/net#vnet-net-view)[text=определите идентификатор]} подсети, в которой находятся виртуальные машины.
...
## {heading(Редактирование правила)[id=balancing-manage-rules-edit]}
...
1. Перейдите в раздел **Виртуальные сети** → **Балансировщики нагрузки**.
1. Нажмите на имя балансировщика.
1. В секции **Правила балансировки** в строке с нужным правилом нажмите на значок карандаша.
...
1. Перейдите в раздел **Виртуальные сети** → **Балансировщики нагрузки**.
1. Нажмите на имя балансировщика.
1. В секции **Правила балансировки** в строке с нужным правилом нажмите на значок корзины и подтвердите удаление.
