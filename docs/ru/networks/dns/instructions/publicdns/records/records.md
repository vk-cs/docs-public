...
Для работы с публичным DNS настройте [роли](/ru/access/iam/concepts/rolesandpermissions) для пользователей [личного кабинета](https://msk.cloud.vk.com/app/) VK Cloud:
...
## {heading(Добавление ресурсных записей)[id=add]}
