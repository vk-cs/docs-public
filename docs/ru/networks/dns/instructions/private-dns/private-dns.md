...
В [SDN Sprut](/ru/networks/vnet/concepts/sdn#sprut) для подсетей с включенным приватным DNS есть лимит на количество DNS-запросов — не более 200 запросов в секунду (QPS). Все запросы сверх этого лимита будут отклонены.
