...
Настройка позволяет задать параметры хранения контента в кеше CDN-ресурса. Подробнее в разделе {linkto(../../../../networks/cdn/concepts/cache#cdn-cache)[text=Кеширование контента]}
