...
1. В блоке **Конфигурация источников и доменов** настройте источники, откуда будет запрашиваться контент:
    ...
    - **Изменение заголовка Host**: выберите, [изменять ли его значение](/ru/networks/cdn/instructions/manage-cdn/origin-settings#izmeneniye_zagolovka_host) при обращении к настроенным ранее источникам.
