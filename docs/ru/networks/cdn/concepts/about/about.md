{include(/ru/_includes/_cdn_seo_intro.md)}
...
Для доступа к сервису необходимо подтвердить номер телефона. Если вашей [роли](/ru/access/iam/concepts/rolesandpermissions) сервис CDN доступен, но не отображается в личном кабинете, подтвердите свой номер телефона через [техническую поддержку](/ru/contacts).
