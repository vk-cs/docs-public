...
1. Чтобы открыть список резервных копий инстанса, нажмите на его имя или на значок ![ ](/ru/assets/right-arrow-icon.svg "inline").
   ...
   * Имя.
   * У резервных копий с блокировкой от удаления — значок ![ ](/ru/assets/protected-icon.svg "inline") рядом с именем.
   * Объем.
...
Невозможно удалить план, в котором есть резервные копии с установленной блокировкой от удаления. Такой план помечается в списке планов значком ![ ](/ru/assets/protected-icon.svg "inline").
