...
1. Измените нужные параметры плана.
   ...
   {include(/ru/_includes/_backup_plan_create_change.md)[tags=vm-update]}
...
В плане могут быть резервные копии, на которых установлена [блокировка от удаления](../../concepts/blocked-backup). Такой план помечается в списке планов одним из значков: ![ ](../../../../assets/protected-icon.svg "inline"), ![ ](../../../../assets/protected-expiring-icon.svg "inline"), ![ ](../../../../assets/protected-expired-icon.svg "inline"), при наведении на который отображается информация о блокировке. В зависимости от типа блокировки:

- Если в плане есть резервные копии с временной блокировкой в режиме `Governance` или с бессрочной блокировкой (legal hold), этот план нельзя удалить до истечения срока или [снятия защиты](/ru/storage/backups/instructions/manage-backup-copy#blocked) владельцем или суперадминистратором проекта.
