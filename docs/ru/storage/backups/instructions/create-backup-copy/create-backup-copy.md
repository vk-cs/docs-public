...
1. (Опционально) Дождитесь создания копии и {linkto(../consistency-check#backup-consistency)[text=убедитесь]}, что она не повреждена и ее можно будет безопасно восстановить.
