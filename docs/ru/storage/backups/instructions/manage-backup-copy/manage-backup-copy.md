...
## {heading(Просмотр списка резервных копий инстанса)[id=view_backups_list]}
...
## {heading(Управление блокировкой резервных копий)[id=blocked]}

Для владельца и суперадминистратора проекта доступны следующие действия с защищенными копиями в зависимости от их [типа](../../concepts/blocked-backup):
...
1. Продлите или снимите блокировку.
   ...
   1. Введите пароль от аккаунта и подтвердите снятие защиты.
      ...
      После этого копию можно [удалить](#delete).
