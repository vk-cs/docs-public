...
<details>
  <summary markdown="span">И тогда запросив ACL на вашем бакете снова вы увидите</summary>
...
Право WRITE для проекта `friend_project@vkcloud-storage.ru` исчезло и теперь данный проект не может записывать, удалять, перезаписывать объекты в вашем бакете. В блоках AccessControlPolicy.AccessControlList.Grant вы увидите информацию о пользователя который установил публичный ACL и сам публичный ACL.
