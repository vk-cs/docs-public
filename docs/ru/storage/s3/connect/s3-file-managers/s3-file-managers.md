...
1. Настройте подключение к объектному хранилищу:
    ...
    1. Укажите параметры подключения:
        ...
        - **Порт**: `443`.
        - **Access Key ID**: идентификатор ключа доступа к VK Object Storage.
        - **Secret Access Key**: секретный ключ доступа к VK Object Storage. Секретный ключ должен соответствовать тому идентификатору ключа, который вы указали в **Access Key ID**.
...
1. Настройте подключение к объектному хранилищу:
    ...
    1. Укажите настройки подключения:
        ...
        - **Секретный ключ доступа**: секретный ключ доступа к VK Object Storage. Секретный ключ должен соответствовать тому идентификатору ключа, который вы указали в поле **Идентификатор ключа доступа**.
...
1. Настройте подключение к бакету объектного хранилища:
    ...
    1. Укажите настройки подключения:
        ...
        - **Secret Key**: секретный ключ доступа к VK Object Storage. Секретный ключ должен соответствовать тому идентификатору ключа, который вы указали в **Access Key**.
    1. Нажмите кнопку **Подключить**.
...
1. Настройте подключение к объектному хранилищу:
    ...
    1.  Выполните команду:
        ...
        - `<имя_бакета>` — название бакета в VK Object Storage;
