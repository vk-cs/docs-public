...
1. (Опционально) Добавьте папку для хранения объекта:
   ...
   1. Введите имя папки. Для имени нет ограничений, но рекомендуется использовать латинские буквы, цифры и спецсимволы без пробелов, так как имя папки будет преобразовано юникод и включено в имя объекта.
