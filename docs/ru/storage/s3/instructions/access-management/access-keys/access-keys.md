Для работы с VK Object Storage через AWS CLI, API и файловые менеджеры нужен ключ доступа. Чтобы получить ключ, создайте [аккаунт VK Object Storage](../../../concepts/access/account-and-keys#account_access_keys), к которому он будет привязаны.
