...
Для защиты объектов от удаления, воспользуйтесь {linkto(../concepts/versioning#s3-concepts-versioning)[text=версионированием]} и {linkto(../concepts/objects-lock#s3-concepts-object-lock)[text=блокировкой объектов]}. 
{/cut}
