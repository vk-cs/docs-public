## {heading(Общая информация)[id=api-spec-s3-pak-general]}
...
## {heading(Создание префиксных ключей)[id=api-spec-s3-pak-create]}
...
## {heading(Список префиксных пользователей)[id=api-spec-s3-pak-list]}
...
## {heading(Удаление префиксного ключа у пользователя)[id=api-spec-s3-pak-delete]}
