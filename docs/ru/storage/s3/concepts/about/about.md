...
Бакет можно использовать для хостинга статических сайтов, [привязав к нему свой домен](../../service-management/buckets/manage-bucket#bind_domain), а также в [сервисе CDN в качестве источника](../../service-management/buckets/manage-bucket#use_cdn).
...
- [синхронизация](../../service-management/buckets/manage-bucket#sync_local_directory_and_bucket) содержимого бакета и локальной директории;
-  кросс-доменные запросы ресурсов в бакете по технологии [CORS](../../service-management/access-management/cors).
...
- [уровень доступа](../../service-management/objects/manage-object#manage_access);
...
- [изменение уровня доступа](../../service-management/objects/manage-object#manage_access) для объекта;
- предоставление доступа к объекту по [подписанной ссылке](../../service-management/objects/manage-object#access_via_signed_link);
...
Вы можете установить метаданные объекта во время его загрузки. После загрузки напрямую изменить метаданные объекта нельзя. Единственный способ сделать это — [скопировать](../../service-management/objects/manage-object#copy_object) объект. При копировании нужно указать ключ объекта одновременно в качестве источника и цели и задать для копии новые метаданные. Таким способом вы можете изменить:
