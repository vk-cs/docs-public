...
<!--- добавить якорь lock_object к ссылке, когда соответствующий раздел будет написан --->
Блокировка может устанавливаться только для объектов в бакетах, созданных с [явным указанием](../../service-management/objects/manage-object) такой возможности.
