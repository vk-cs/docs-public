Для создания кластера Kafka + NiFi перейдите в раздел «Big Data». Нажмите «Добавить кластер».
...
1. Выберите версию дистрибутива ADS, который будет установлен на кластер.
...
1. Среди предлагаемых настроек кластера выберите «NiFi и Kafka». Нажмите «Следующий шаг».
    ...
    Создание NiFi и Kafka в отдельных кластерах возможно только в версиях дистрибутива ADS Enterprise. Больше информации вы можете узнать в разделе [Лицензии Arenadata Streaming](../../concepts/types/).
