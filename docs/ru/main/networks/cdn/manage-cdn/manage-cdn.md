...
В случае, если есть необходимость раздавать контент из разных источников, в интерфейсе VK CS есть такая возможность.
...
3.  Надо загрузить контент в интерфейс VK CS.
...
Вы можете загружать свои сертификаты безопасности и управлять ими в соответствующем разделе панели управления VK CS "**CDN**" - "**SSL-сертификаты**".
