...
- При работе с [сервисом контейнеров](/ru/base/k8s/), например при использовании [Ingress-контроллеров](/ru/base/k8s/use-cases/ingress) (в том числе [предустановленного](/ru/base/k8s/concepts/addons-and-settings/addons#ingress_controller_nginx_914e5637)) или сервисов типа [Load Balancer](/ru/base/k8s/use-cases/load-balancer).
