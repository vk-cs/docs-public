Балансировщики нагрузки, используемые VK Cloud -- это виртуальные машины с HAProxy (High-Availability Proxy), то есть с сервисом проксирования трафика, обеспечивающим высокую доступность.
