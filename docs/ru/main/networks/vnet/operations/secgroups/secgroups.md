...
1. Убедитесь, что OpenStack CLI [установлен](../../../../additionals/account/project/cli/setup). Также проверьте, что вы можете [авторизоваться](../../../../additionals/account/project/cli/authorization) в OpenStack CLI.
