...
[Общими сетями](../../concepts/net-types#obshchaya-set) можно управлять только из проекта-владельца.
...
[Общую сеть](../../concepts/net-types#obshchaya-set) можно удалить только по запросу в техническую поддержку.
