...
- В [общих сетях](../../concepts/net-types#obshchaya-set) из зависимого проекта портами можно управлять только через OpenStack CLI. Для проекта-владельца таких ограничений нет.
