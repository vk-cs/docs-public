...
1. Создайте VPN-сервис, который будет обслуживать VPN-туннель:
   ...
   1. Создайте VPN-сервис, использующий этот маршрутизатор:
      ...
      После создания будет выведена информация о созданном объекте, включающая его идентификатор. Запишите идентификатор VPN-сервиса, которая будет использоваться VPN-туннелем.
