...
Вы можете установить Docker CE как вручную, пользуясь этой инструкцией, так и из [магазина приложений](/ru/additionals/mp/mp-apps/mp-docker-ce) в виде преднастроенной виртуальной машины с Ubuntu 18.04.
