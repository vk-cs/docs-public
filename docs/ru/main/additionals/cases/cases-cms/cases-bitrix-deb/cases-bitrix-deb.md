...
- Вы можете установить стек LAMP самостоятельно. О том, как установить стек LAMP на Debian 9.4, читайте в статье [Установка стека LAMP на операционную систему Debian 9.4](https://mcs.mail.ru/help/lamp-on-linux/lamp-debian-9).
