...
- Вы можете установить стек LAMP самостоятельно. О том, как установить стек LAMP на Ubuntu 16.04, читайте в статье [Установка стека LAMP на операционную систему Ubuntu](/ru/additionals/cases/cases-lamp/lamp-u16).
