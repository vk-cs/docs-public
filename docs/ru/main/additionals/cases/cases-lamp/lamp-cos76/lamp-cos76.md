...
Установка стека LAMP на операционную систему CentOS 7.6 выполняется аналогично установке стека LAMP на операционную систему CentOS 7.4 ([читайте, как установить стек LAMP на CentOS 7.4](/ru/additionals/cases/cases-lamp/lamp-cos74)).
