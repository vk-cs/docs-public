...
Детализация изменения баланса содержит информацию не только по транзакциям, а также о регионах оплачиваемых ресурсов. Страница «Баланс» содержит информацию по проектам всех регионов, где были созданы ресурсы. Подробнее о регионах вы можете узнать в статье [Регионы](/additionals/start/user-account/regions).
