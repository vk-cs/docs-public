Средства со счета проекта в [личном кабинете](https://mcs.mail.ru/app/) VK Cloud можно вернуть, обратившись в [техническую поддержку](/ru/contacts). Возврат выполняется в течение 30 дней.
