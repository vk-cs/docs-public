...
В рамках платформы VK Cloud существует ограниченный набор возможностей по передаче ресурсов между проектами. Передать данные из одного проекта в другой возможно для [«Дисков»](https://mcs.mail.ru/docs/ru/base/iaas/vm-volumes).
