...
| Количество дисков | Количество жестких дисков в созданном инстансе.|
...
| Выбор доменного имени | Задает DNS имя инстанса, [подробнее](https://mcs.mail.ru/docs/ru/networks/vnet/networks/private-dns).|
