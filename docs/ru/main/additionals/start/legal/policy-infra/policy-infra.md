...
- Условия использования Платформы «VK Cloud» ([https://mcs.mail.ru/docs/additionals/start/legal/legal-terms](https://mcs.mail.ru/docs/additionals/start/legal/legal-terms));
