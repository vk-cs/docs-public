...
**Применимые правила** — правила использования Сервиса Компании, доступные в сети Интернет по адресу: [https://mcs.mail.ru/docs/ru/additionals/start/legal/policy-infra](/ru/additionals/start/legal/policy-infra), содержащие в себе условия доступа и использования Сервиса и изложенные в следующих документах:

- Условия использования Платформы «VK Cloud» ([https://mcs.mail.ru/docs/additionals/start/legal/legal-terms](/ru/additionals/start/legal/legal-terms));
- Политика конфиденциальности Компании ([https://mcs.mail.ru/docs/additionals/start/legal/policy-privacy](/ru/additionals/start/legal/policy-privacy)).
