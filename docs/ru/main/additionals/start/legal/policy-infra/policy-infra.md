...
- Условия использования Платформы «VK Cloud Solutions» ([https://mcs.mail.ru/docs/additionals/start/legal/legal-terms](https://mcs.mail.ru/docs/additionals/start/legal/legal-terms));
- Политика конфиденциальности Компании ([https://mcs.mail.ru/docs/additionals/start/legal/policy-privacy](https://mcs.mail.ru/docs/additionals/start/legal/policy-privacy)).
...
2.2. Условием использования Сервиса является полное и безоговорочное принятие Заказчиком положений настоящего Соглашения. Доступ к Сервису осуществляется в рамках Платформы, в связи с чем условием использования Сервиса является использование Платформы и принятие Условий использования Платформы, доступных по ссылке [https://mcs.mail.ru/docs/additionals/start/legal/legal-terms](https://mcs.mail.ru/docs/additionals/start/legal/legal-terms), а также Политики Конфиденциальности Компании, доступной по ссылке [https://mcs.mail.ru/docs/additionals/start/legal/policy-privacy](https://mcs.mail.ru/docs/additionals/start/legal/policy-privacy) (далее вместе именуемые «Применимые правила»). В случае противоречия между положениями Условий использования Платформы и настоящего Соглашения, приоритет имеют положения настоящего Соглашения. К отношениям Сторон, которые не урегулированы настоящим Соглашением, применяются Условия использования Платформы.
