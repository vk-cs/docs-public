Настоящий документ представляет собой Пользовательское соглашение «Магазин приложений» (далее – «Сервис»), и является неотъемлемой частью Условий использования Платформы VK Cloud (далее – «Условия использования»), размещенных в сети «Интернет» по адресу [https://mcs.mail.ru/docs/ru/additionals/start/legal/legal-terms](https://mcs.mail.ru/docs/ru/additionals/start/legal/legal-terms).

Используя Сервис, Пользователь соглашается с условиями Пользовательского соглашения и Условиями использования Платформы в полном объеме.

## Термины

**Пользовательское соглашение** — настоящий документ Пользовательское соглашение «Магазин приложений», размещенный в сети Интернет по адресу: [https://mcs.mail.ru/app/services/marketplace](https://mcs.mail.ru/app/services/marketplace).
...
2.2. В разделе «Мои Приложения SaaS» Потребитель может уточнить статус Программного продукта или прекратить использование Программного продукта в любое время без возврата денежных средств.

2.3. В случае возникновения вопросов по работе Сервиса Потребитель должен обратиться в поддержку Сервиса. Контактные данные размещены на странице: [https://mcs.mail.ru/docs/ru/additionals/start/support/support-info](https://mcs.mail.ru/docs/ru/additionals/start/support/support-info).
...
3.4. Изменения тарифного Плана Потребитель производит путем выбора нового тарифа и нажатия  «Оплатить», далее следуя подсказкам Сервиса, производит изменение настроек тарифного плана или опций, входящих в него.
...
4.4. Изменение тарифных планов (переход на другой тариф внутри одного Программного продукта) происходит с возвратом денежных средств за неиспользованный период на баланс в личном кабинете Потребителя (в виде бонусов, без возможности вывода их в денежном эквиваленте).
...
5.2. Для получения доступа к Программному продукту Пользователь обязан принимать условия Соглашения, которое предусматривает условия лицензии (удаленного доступа), предоставляемой Владельцем, и регулирует использование Программного продукта Пользователем. В случае если такое Соглашение с Пользователем или ссылка на него не размещено в соответствующем разделе Сайта, содержащего описание Программного продукта и информацию о Владельце, то каждый Пользователь, который получил Программный продукт на Сервисе, автоматически получает от Владельца Программного продукта неисключительную, непередаваемую лицензию на использование Программного продукта во всех странах мира, при том что такая лицензия является бессрочной, за исключением случая, когда Программный продукт предоставляется Пользователю с ограниченным правом доступа на условиях пробного использования, при котором такая лицензия ограничивается исключительно периодом тестирования.

5.3. В соответствии с данной лицензией Владелец Программного продукта несет исключительную ответственность за услуги по обслуживанию и поддержке, любое гарантийное требование или требование в отношении качества Программного продукта, за любое требование о нарушении прав интеллектуальной собственности третьего лица, и за соблюдение правовых норм.

5.4. Если иное прямо не предусмотрено Владельцем, в отношении Программного продукта, предоставляемого на безвозмездной основе и включающего в себя программное обеспечение с открытым или закрытым исходным кодом, не предоставляется техническая поддержка и услуги по обслуживанию. В отношении такого Программного продукта Пользователю не гарантируется безошибочная и бесперебойная работа Программного продукта, работа его отдельных компонентов или функций, соответствие Программного продукта ожиданиям Пользователя, точность, достоверность и полнота информации, предоставляемой в Программном продукте.

5.5. ВК оставляет за собой право осуществлять модерацию Программного продукта, размещенного на Сервисе, в том числе, но не ограничиваясь, удалять Программные продукты с Сервиса, с предварительным уведомлением об удалении Программного продукта, которое может быть направлено в любое время до начала отчетного периода, с которого Программный продукт становится недоступным на Сервисе.
...
7.6. ВК не осуществляет клиентскую поддержку Программного продукта, размещаемого третьими лицами на Сервисе, если иное не предусмотрено самим ВК. При возникновении вопросов или проблем Пользователю следует обращаться непосредственно к Владельцу соответствующего Программного продукта.
...
7.8. Пользователь несет ответственность за использование Программных продуктов в соответствии с условиями их использования, а также за последствия таких нарушений, в том числе за любые потери или ущерб, понесенные ВК.
...
8.2. Зарегистрированный Пользователь имеет возможность урегулировать проблему с доступом к Программному продукту, путем обращения в Службу поддержки Сервиса по контактным данным, размещенным на странице: [https://mcs.mail.ru/docs/ru/additionals/start/support/support-info](https://mcs.mail.ru/docs/ru/additionals/start/support/support-info).

## 9. Персональные данные

9.1. Обработка персональных данные, полученных ВК от Пользователя в процессе использования Сервиса, осуществляется в соответствие с Политикой конфиденциальности Платформы, опубликованной на сайте [https://mcs.mail.ru/docs/ru/additionals/start/legal/policy-privacy](https://mcs.mail.ru/docs/ru/additionals/start/legal/policy-privacy).
