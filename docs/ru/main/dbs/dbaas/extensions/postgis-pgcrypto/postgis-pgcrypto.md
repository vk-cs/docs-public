...
Установка расширений проводятся в [личном кабинете VK Cloud](https://mcs.mail.ru/app/services/databases/). Для этого перейдите в раздел «Базы данных» --> «Инстансы баз данных».
