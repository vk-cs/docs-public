...
1. На шаге «Создание инстанса»:
   ...
   1. Задайте общие параметры инстанса:
      ...
      - **Тип виртуальной машины:** [шаблон конфигурации](/ru/base/iaas/concepts/vm-concept#shablony-konfiguraciy) для инстанса БД.
      ...
      - **Зона доступности:** [зона доступности](/ru/additionals/start/it-security/platform-security#zony-dostupnosti) для инстанса БД.
      ...
      - **Сеть:** сеть, в которой будет размещаться инстанс БД. Если нужной сети нет в списке, [создайте ее](/ru/networks/vnet/operations/manage-net#sozdanie-seti).
