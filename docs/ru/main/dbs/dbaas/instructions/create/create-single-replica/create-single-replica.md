...
1. На шаге «Конфигурация»:
   ...
   1. Выберите конфигурацию **Single** или **Master-Replica**. Конфигурация **Master-Replica** доступна не для всех [типов СУБД](../../../types).
...
1. На шаге «Создание инстанса»:
   ...
   1. Задайте общие параметры инстанса:
      ...
      - **Ключ для доступа по SSH:** выберите существующий ключ или создайте новый.
        ...
        Ключ используется для [подключения к хостам инстанса по SSH](/ru/base/iaas/instructions/vm/vm-connect/vm-connect-nix).
