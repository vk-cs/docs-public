При добавлении в [проект](../projects) пользователю назначается роль, которая определяет доступные [разрешения](#matrica-razresheniy-dlya-vseh-roley) при работе с функциональностью личного кабинета и с облачными сервисами.
...
В личном кабинете доступны специализированные роли для работы с [сервисом контейнеров](../../../../base/k8s):
