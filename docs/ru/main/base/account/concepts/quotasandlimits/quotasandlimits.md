...
| Количество пар SSH-ключей | [квота](../../instructions/project-settings/manage#prosmotr-kvot-proekta) `key-pairs` в расширенном списке | 100 | не ограничено | |
...
| Параметр                            | Квота | Базовая квота | Лимит         | Жесткий |
|-------------------------------------|-------|-----------------------|---------|---|
| Количество инстансов в проекте      | [квота](../../instructions/project-settings/manage#prosmotr-kvot-proekta) **Виртуальные машины** в личном кабинете, `instances` в расширенном списке | 6 | 1000 шт. | — |
| Количество vCPU в проекте | [квота](../../instructions/project-settings/manage#prosmotr-kvot-proekta) **vCPU** в личном кабинете, `cores` в расширенном списке | 9 | не ограничено | |
...
Лимит на размер одного образа (500 ГБ) является жестким лимитом для сервиса Glance. Если вам необходимо загрузить образ большего размера, обратитесь в [техническую поддержку](/ru/contacts).
...
Лимит на общий объем образов (2 ТБ) можно превысить, обратившись в техническую поддержку.

### Файловые хранилища

| Параметр                        | Квота | Базовая квота | Лимит   | Жесткий |
|---------------------------------|-------|-----|---------|---------|
| Количество файловых хранилищ в проекте | [квота](../../instructions/project-settings/manage#prosmotr-kvot-proekta) **Файловые хранилища NFS/CIFS** в личном кабинете | 10 | не ограничено | |
...
| Параметр                          | Квота | Базовая квота | Лимит | Жесткий |
|-----------------------------------|-------|------------|---------|----|
| Количество плавающих IP-адресов | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **IP-адреса Neutron** В личном кабинете, `floating-ips` в расширенном списке | 6 шт. | 50 шт.| — |
| Количество сетей в проекте        | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Сети Neutron** В личном кабинете, `networks` в расширенном списке | 10 шт. | 20 шт.             | — |
| Количество подсетей в проекте | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Подсети Neutron** В личном кабинете, `subnets` в расширенном списке | 10 шт. | 20 шт. | — |
...
| Параметр                          | Квота | Базовая квота | Лимит | Жесткий |
|-----------------------------------|-------|------------|---------|----|
| Количество балансировщиков нагрузки | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Балансировщики Octavia** в личном кабинете, `load_balancers` в расширенном списке | 12 шт. | 20 шт. | — |
| Количество правил балансировки на один балансировщик | — | — | 10 шт. через личный кабинет, 30 шт. через OpenStack CLI   | —   |
| Количество маршрутизаторов   | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Маршрутизаторы Neutron** в личном кабинете, `routers` в расширенном списке | 12 шт. | 20 шт.             | — |
| Количество групп безопасности в проекте | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Группы безопасности Neutron** В личном кабинете, `secgroups` в расширенном списке | 12 шт. | не ограничено | |
| Количество правил безопасности в проекте | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Правила безопасности Neutron** В личном кабинете, `secgroup-rules` в расширенном списке | 200 шт. | не ограничено | |
| Количество портов в проекте | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) **Порты Neutron** В личном кабинете, `ports` в расширенном списке | 120 шт. | 500 шт. | — |
...
| Параметр                                      | Квота | Базовая квота  | Лимит | Жесткий |
|-----------------------------------------------|---------------------------------|--------------------|--|--|
| Количество резервных копий                    | [квота](../../instructions/project-settings/manage#cherez-openstack-cli) `backups` из расширенного списка | 400 шт. | не ограничено | |
| Количество снимков                            | [квота](../../instructions/project-settings/manage#cherez-openstack-cli)  `snapshots` из расширенного списка | 200 шт. | не ограничено | |
...
| Размер одного бакета     | не ограничен                                             | |  |
| Рейт-лимит: обычные запросы  | запрос/сек: 1000 | не ограничен, максимальное известное значение среди всех проектов: 9000 запросов / сек | — |
| Рейт-лимит: запросы на листинг | запрос/сек: 250 | не ограничен, максимальное известное значение среди всех проектов: 500 запросов / сек | — |
