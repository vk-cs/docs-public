...
Для управления ВМ с помощью OpenStack CLI нужно знать ID виртуальной машины.
...
Заблокируйте виртуальную машину, чтобы запретить изменение ее состояния и параметров.
...
Пароль должен быть длиной от 8 символов и содержать буквы латинского алфавита, цифры и хотя бы один символ из диапазона: `!"#$%&()*+,-.:;<=>?@[]^_\`{}~`.
