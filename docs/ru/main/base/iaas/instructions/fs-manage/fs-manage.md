...
1. Выберите проект и регион, где нужно создать файловое хранилище.
...
Подключите NFS-хранилище с помощью команды, описанной в его [свойствах](../fs-manage/#prosmotr-informacii-o-faylovom-hranilishche).
...
Для подключения файлового хранилища выполните команду, указанную в его [свойствах](../fs-manage/#prosmotr-informacii-o-faylovom-hranilishche).
...
2. Используйте команду, указанную в [свойствах](../fs-manage/#prosmotr-informacii-o-faylovom-hranilishche) созданного NFS хранилища:
...
3. Используйте команду, указанную в [свойствах](../fs-manage/#prosmotr-informacii-o-faylovom-hranilishche) хранилища:
...
1. Перейдите в [личный кабинет](https://mcs.mail.ru/app/) VK Cloud.
1. Выберите проект и регион, где находится нужное файловое хранилище.
