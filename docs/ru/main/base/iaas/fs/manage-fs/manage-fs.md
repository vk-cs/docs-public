Управление существующими файловыми хранилищами производится из личного кабинета панели VK Cloud на вкладке «Файловое хранилище» раздела «Облачные вычисления» и из Openstack CLI.
