...
1. Добавьте объект:
   ...
   1. Перейдите в [личный кабинет](https://mcs.mail.ru/app/) VK Cloud.
   1. Выберите проект и регион, где находится созданный бакет.
   1. Перейдите в раздел **Объектное хранилище → Бакеты**.
...
1. Если бакет вам больше не нужен, [удалите его](../buckets/bucket#udalenie-baketa).
