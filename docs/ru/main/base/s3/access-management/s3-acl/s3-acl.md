...
- Конкретный пользователь в VK Cloud. Для этого нужно знать его уникальный индентификатор.
