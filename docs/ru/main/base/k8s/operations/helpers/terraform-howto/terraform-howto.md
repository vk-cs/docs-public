...
1. [Установите Terraform и настройте провайдер](../../../../../additionals/terraform/quick-start/preparation).
...
- Некоторые операции с кластером выполняются только в [личном кабинете](../../../../../additionals/account). Для каждой операции в [пошаговых инструкциях](../../../operations) указано, можно ли ее выполнить также с помощью Terraform.
