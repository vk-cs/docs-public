...
1. [Создайте виртуальную машину Linux](/ru/base/iaas/instructions/vm/vm-create/) в той же подсети, где находится IP-адрес балансировщика.

1. [Подключитесь к этой виртуальной машине](/ru/base/iaas/instructions/vm/vm-connect/vm-connect-nix/) по SSH.
