...
Эти ограничения создаются на основе шаблонов ограничений (constraint templates). Кластеры Kubernetes VK Cloud уже содержат [преднастроенные шаблоны и ограничения](../addons-and-settings/settings#prednastroennye-shablony-i-ogranicheniya-gatekeeper). Можно создавать собственные шаблоны и ограничения.
