...
Кластер Kubernetes VK Cloud имеет встроенные возможности масштабирования. Можно выполнить масштабирование любого типа до пределов [действующих квот](../../../../additionals/account/concepts/quotasandlimits/).
