Kiali — веб-интерфейс для работы с Istio. Вы можете подключиться к Kiali, если в кластере установлен соответствующий [аддон](../../concepts/addons-and-settings/addons#kiali_2a69fbed).
