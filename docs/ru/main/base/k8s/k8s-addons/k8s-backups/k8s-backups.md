...
Дополнительно может понадобиться клиент Openstack с пакетом API блочного хранилища. Подробнее читайте [здесь](/docs/additionals/account/project/cli#section-3).
...
> **Важно**<br />Перед установкой Velero убедитесь, что node-узлы кластера имеют как минимум 2 CPU, либо, что включено автомасштабирование кластера. Подробнее об автомасштабировании кластера вы можете узнать в [статье](/docs/base/k8s/manage-k8s/scale-k8s#na_sozdannom_klastere).
