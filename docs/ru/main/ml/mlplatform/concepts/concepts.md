MLOps Platform от VK Cloud Solutions представляет собой набор сервисов и инструментов, предназначенных для решения типовых задач Data Science и ML команд.
